              ...
              <RawNavigationMenuContent class="left-0 top-0 w-full md:absolute md:w-auto">
                <div class="p-4 w-[200px] bg-white dark:bg-gray-800 border rounded-md shadow-lg">
                  <p class="text-sm text-gray-900 dark:text-gray-100">
                    This should be visible when clicking the trigger above!
                  </p>
                  <p class="text-xs text-gray-500 dark:text-gray-400 mt-2">
                    If you see this, raw RekaUI works
                  </p>
                </div>
      ...
      <div class="space-y-4 p-4">
        <div class="text-center">
          <h3 class="text-lg font-medium text-foreground">
            Fixed styled components (hover to test)
          </h3>
          <p class="text-sm text-muted-foreground">
            • Should now work like the raw RekaUI version
          </p>
          <p class="text-sm text-muted-foreground">
            • Viewport has frosted glass backdrop blur effect
          </p>
          <p class="text-sm text-muted-foreground">
            • Corner detection animations temporarily disabled to fix core functionality
          </p>
        </div>
