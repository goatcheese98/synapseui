    ...
    <Variant title="Enhanced Visual Effects Showcase">
      <template #default>
        <div class="p-6 bg-gray-50 rounded-lg max-w-2xl">
          <h4 class="text-sm font-semibold mb-6 text-gray-700">
            Enhanced Buttons with Clean Animations & Hover Effects
          </h4>
        ...
        <div class="flex flex-col gap-4">
          <div>
            <h4 class="text-sm font-semibold mb-2">
              Standard Button (using Primitive)
            </h4>
    ...
    <Variant title="Toolbar Example">
      <template #default>
        <div class="flex flex-col gap-4">
          ...
          <h4 class="text-sm font-semibold">
            Reka UI ToolbarButton (Original)
          </h4>
