...
<template>
  <Story title="Feedback/Basic Tooltip Test" :layout="{ type: 'single', iframe: false }">
      ...
      <TooltipProvider>
        <div class="max-w-2xl mx-auto p-8 space-y-8">
          ...
          <div class="text-center space-y-4">
            <h1 class="text-3xl font-bold">🔧 Tooltip Debugging</h1>
            <p class="text-text-secondary">Testing basic tooltip functionality</p>
          </div>
          ...
          <div class="grid grid-cols-2 gap-6">
            ...
            <div class="p-6 border rounded-lg text-center">
              <h3 class="font-medium mb-4">Basic Tooltip</h3>
              <TooltipRoot>
            ...
            <div class="p-6 border rounded-lg text-center">
              <h3 class="font-medium mb-4">Wrapper Component</h3>
              <Tooltip>
            ...
            <div class="p-6 border rounded-lg text-center">
              <h3 class="font-medium mb-4">Positioned Tooltips</h3>
            ...
            <!-- Test 4: Custom delay -->
            <div class="p-6 border rounded-lg text-center">
              <h3 class="font-medium mb-4">Custom Timing</h3>
          ...
          <div class="bg-muted p-4 rounded-lg">
            ...
            <div class="text-sm space-y-1">
              <div>Reka UI components imported: ✓</div>
              <div>TooltipProvider wrapper: ✓</div>
