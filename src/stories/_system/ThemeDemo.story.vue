...
<template>
  <Story title="Design System/Theme Demo" :layout="{ type: 'single', iframe: false }">
          ...
          <div class="p-8 rounded-lg border-2 border-dashed border-gray-300">
            <VStack spacing="lg">
              <div class="text-center">
                <h2 class="text-2xl font-bold mb-2">{{ themes.find(t => t.name === currentTheme)?.label }}</h2>
                <p class="opacity-70">{{ themes.find(t => t.name === currentTheme)?.description }}</p>
              </div>
              ...
              <div>
                ...
                <div class="max-w-md">
                  <Card>
                    ...
                    <CardFooter>
                      <Button class="w-full">Themed Action Button</Button>
                    </CardFooter>
                  </Card>
                </div>
              </div>
              ...
              <div>
                ...
                <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
                  <div class="text-center">
                    <div class="w-16 h-16 rounded-lg mx-auto mb-2" style="background: var(--primary-bg, #0ea5e9)"></div>
                    <p class="text-sm">Primary</p>
                  </div>
                  <div class="text-center">
                    <div class="w-16 h-16 rounded-lg mx-auto mb-2" style="background: var(--secondary-bg, #f1f5f9)"></div>
                    <p class="text-sm">Secondary</p>
                  </div>
                  <div class="text-center">
                    <div class="w-16 h-16 rounded-lg mx-auto mb-2" style="background: var(--success-bg, #22c55e)"></div>
                    <p class="text-sm">Success</p>
                  </div>
                  <div class="text-center">
                    <div class="w-16 h-16 rounded-lg mx-auto mb-2" style="background: var(--error-bg, #ef4444)"></div>
