  ...
  >
    ...
    >
      <div class="rounded-lg overflow-hidden">
        ...
        <div
          v-if="title"
          class="px-4 py-3 border-b bg-muted/30"
        >
        ...
        <div class="p-4 space-y-3">
          ...
          <div
            v-if="warning"
            class="flex items-start gap-2 p-2 bg-warning/10 border border-warning/20 rounded text-xs"
          >
            <Icon
              name="alert-triangle"
              class="w-3 h-3 text-warning mt-0.5 flex-shrink-0"
            />
