...
import { defineComponent as V, h as x, ref as _, onMounted as j, watch as T, onBeforeUnmount as k } from "@histoire/vendors/vue";
import * as h from "virtual:$histoire-generated-global-setup";
import * as v from "virtual:$histoire-setup";
import { reactive as q, createApp as F, h as S, Suspense as O, onMounted as B } from "vue";
    ...
    async function w() {
      ...
      a = F({
        ...
        render: () => {
          ...
          return t.push(S("div", t.at(-1))), t.push(S(O, {}, t.at(-1))), t.at(-1);
        }
