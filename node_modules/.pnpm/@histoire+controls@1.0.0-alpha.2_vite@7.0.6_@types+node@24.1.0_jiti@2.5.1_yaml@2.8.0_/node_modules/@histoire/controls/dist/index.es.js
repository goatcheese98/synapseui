import { defineComponent as et, createElementBlock as q, openBlock as P, normalizeClass as gt, renderSlot as ht, createBlock as Y, resolveDynamicComponent as $h, withCtx as K, withDirectives as Vt, createElementVNode as E, createTextVNode as le, toDisplayString as Bt, unref as Ct, computed as nt, Fragment as we, renderList as $e, watch as bs, ref as at, withKeys as Qe, withModifiers as Ye, createVNode as Fs, normalizeStyle as Rt, mergeProps as ze, vModelText as or, createCommentVNode as ne, onMounted as zh, watchEffect as _h, onUnmounted as Wh } from "@histoire/vendors/vue";
import { VTooltip as ye, Dropdown as jh } from "@histoire/vendors/floating-vue";
import { Icon as lr } from "@histoire/vendors/iconify";
import { useClipboard as qh } from "@histoire/vendors/vue-use";
const Kh = {
  name: "HstButton"
}, bl = /* @__PURE__ */ et({
  ...Kh,
...
}), Gh = { class: "htw-w-28 htw-whitespace-nowrap htw-text-ellipsis htw-overflow-hidden htw-shrink-0" }, Uh = { class: "htw-grow htw-max-w-full htw-flex htw-items-center htw-gap-1" }, Qh = { class: "htw-block htw-grow htw-max-w-full" }, Yh = {
  name: "HstWrapper"
}, $t = /* @__PURE__ */ et({
  ...Yh,
  props: {
  ...
  setup(n) {
    return (t, e) => (P(), Y($h(t.tag), { class: "histoire-wrapper htw-p-2 hover:htw-bg-primary-100 dark:hover:htw-bg-primary-800 htw-flex htw-gap-2 htw-flex-wrap" }, {
      default: K(() => [
        Vt((P(), q("span", Gh, [
          le(Bt(t.title), 1)
        ])), [
...
}), Xh = { class: "htw-flex htw-gap-px htw-border htw-border-solid htw-border-black/25 dark:htw-border-white/25 htw-rounded-sm htw-p-px" }, Jh = {
  name: "HstButtonGroup"
}, Zh = /* @__PURE__ */ et({
  ...Jh,
  props: {
  ...
  setup(n, { emit: t }) {
    ...
    return (o, l) => (P(), Y($t, {
      ...
      default: K(() => [
        E("div", Xh, [
          (P(!0), q(we, null, $e(i.value, ({ label: a, value: h }) => (P(), Y(bl, {
            key: h,
            class: "htw-px-1 htw-h-[22px] htw-flex-1 !htw-rounded-[3px]",
            color: h === o.modelValue ? "primary" : "flat",
            rounded: !1,
            onClick: (f) => r(h)
          }, {
            default: K(() => [
...
}, ef = ["stroke-dasharray", "stroke-dashoffset"], sf = {
  ...
  setup(n, { emit: t }) {
    ...
    const r = at(), o = at(0), l = nt(() => e.modelValue ? 1 : 0), a = nt(() => (1 - l.value) * o.value), h = at(!1);
    return bs(r, () => {
      var f, c;
      o.value = ((c = (f = r.value).getTotalLength) == null ? void 0 : c.call(f)) ?? 21.21;
    }), (f, c) => (P(), q("div", {
      class: gt(["histoire-simple-checkbox htw-group htw-text-white htw-w-[16px] htw-h-[16px] htw-relative", { "htw-cursor-pointer": f.withToggle }]),
      onClick: s
    }, [
      E("div", {
        class: gt(["htw-border htw-border-solid group-active:htw-bg-gray-500/20 htw-rounded-sm htw-box-border htw-absolute htw-inset-0 htw-transition-border htw-duration-150 htw-ease-out group-hover:htw-border-primary-500 group-hover:dark:htw-border-primary-500", [
          f.modelValue ? "htw-border-primary-500 htw-border-8" : "htw-border-black/25 dark:htw-border-white/25 htw-delay-150"
        ]])
      }, null, 2),
      (P(), q("svg", tf, [
        E("path", {
  ...
  setup(n, { emit: t }) {
    ...
    return (o, l) => (P(), Y($t, {
      ...
      onClick: l[0] || (l[0] = (a) => s()),
      onKeydown: [
        l[1] || (l[1] = Qe(Ye((a) => s(), ["prevent"]), ["enter"])),
        l[2] || (l[2] = Qe(Ye((a) => s(), ["prevent"]), ["space"]))
      ]
    }, {
      actions: K(() => [
        ht(o.$slots, "actions")
      ...
      default: K(() => [
        Fs(kl, { "model-value": r.value }, null, 8, ["model-value"])
      ]),
      _: 3
    }, 8, ["title"]));
  }
}), of = { class: "-htw-my-1" }, lf = ["for", "onKeydown", "onClick"], af = {
  ...
  setup(n, { emit: t }) {
    ...
    return (o, l) => (P(), Y($t, {
      role: "group",
      title: o.title,
      class: gt(["histoire-checkbox-list htw-cursor-text", o.$attrs.class]),
      style: Rt(o.$attrs.style)
    }, {
      actions: K(() => [
        ht(o.$slots, "actions")
      ]),
      default: K(() => [
        E("div", of, [
          (P(!0), q(we, null, $e(i.value, (a, h) => (P(), q("label", {
            key: h,
            tabindex: "0",
            for: `${h}-radio`,
            class: "htw-cursor-pointer htw-flex htw-items-center htw-relative htw-py-1 htw-group",
            onKeydown: [
              Qe(Ye((f) => r(h), ["prevent"]), ["enter"]),
              Qe(Ye((f) => r(h), ["prevent"]), ["space"])
            ],
            onClick: (f) => r(h)
          }, [
            Fs(kl, {
              "model-value": o.modelValue.includes(h),
              class: "htw-mr-2"
            }, null, 8, ["model-value"]),
            le(" " + Bt(a), 1)
          ], 40, lf))), 128))
...
}), ff = { class: "htw-flex htw-flex-row htw-gap-1" }, cf = ["value"], uf = {
  name: "HstColorSelect",
  inheritAttrs: !1
}, df = /* @__PURE__ */ et({
  ...uf,
  ...
  setup(n, { emit: t }) {
    ...
    function r(a, h = 15) {
      let f = !1, c;
      const u = () => {
        c == null ? f = !1 : (a(...c), c = null, setTimeout(u, h));
      };
      return (...d) => {
        if (f) {
          c = d;
    ...
    return (a, h) => (P(), Y($t, {
      title: a.title,
      class: gt(["histoire-select htw-cursor-text htw-items-center", a.$attrs.class]),
      style: Rt(a.$attrs.style)
    }, {
      actions: K(() => [
        ht(a.$slots, "actions")
      ]),
      default: K(() => [
        E("div", ff, [
          Vt(E("input", ze({ ...a.$attrs, class: null, style: null }, {
          ...
          E("input", {
            type: "color",
            value: a.modelValue,
            onInput: h[1] || (h[1] = (f) => l(f.target.value))
          }, null, 40, cf)
        ])
      ]),
      _: 3
...
}, mf = ["onMouseenter"], wf = { class: "htw-flex htw-gap-1" }, yf = { class: "htw-my-0 htw-truncate htw-shrink" }, bf = { class: "htw-flex htw-gap-1" }, kf = { class: "htw-my-0 htw-opacity-50 htw-truncate htw-shrink" }, xf = {
  name: "HstColorShades"
}, vf = /* @__PURE__ */ et({
  ...xf,
  props: {
  ...
  setup(n) {
    const t = n;
    function e(o, l = "") {
      return Object.entries(o).reduce((a, [h, f]) => {
        const c = l ? h === "DEFAULT" ? l : `${l}-${h}` : h, u = typeof f == "object" ? e(f, c) : { [c]: f };
        return { ...a, ...u };
      }, {});
    }
    const i = nt(() => {
      const o = t.shades, l = t.getName, a = e(o);
      return Object.entries(a).map(([h, f]) => {
        const c = l ? l(h, f) : h;
        return {
          key: h,
          color: f,
      ...
      if (t.search) {
        ...
        o = o.filter(({ name: a }) => l.test(a));
      }
      return o;
    }), r = at(null);
    return (o, l) => s.value.length ? (P(), q("div", gf, [
      (P(!0), q(we, null, $e(s.value, (a) => (P(), q("div", {
        key: a.key,
        ...
        E("div", null, [
          E("div", wf, [
            Vt((P(), q("pre", yf, [
              ...
              [Ct(ye), a.name.length > 23 ? a.name : ""]
            ]),
            r.value === a.key ? (P(), Y(Ne, {
              key: 0,
              content: a.name,
              class: "htw-flex-none"
            }, null, 8, ["content"])) : ne("", !0)
          ...
          E("div", bf, [
            Vt((P(), q("pre", kf, [
              ...
              [Ct(ye), a.color.length > 23 ? a.color : ""]
            ]),
            r.value === a.key ? (P(), Y(Ne, {
              key: 0,
              content: a.color,
...
}), Sf = ["onMouseenter"], Cf = { class: "htw-flex htw-gap-1" }, Af = { class: "htw-my-0 htw-truncate htw-shrink" }, Mf = { class: "htw-flex htw-gap-1" }, Of = { class: "htw-my-0 htw-opacity-50 htw-truncate htw-shrink" }, Tf = {
  name: "HstTokenGrid"
}, Df = /* @__PURE__ */ et({
  ...Tf,
  props: {
  ...
  setup(n) {
    const t = n, e = nt(() => {
      ...
      return Object.entries(r).map(([l, a]) => {
        const h = o ? o(l, a) : l;
        return {
          key: l,
          name: h,
          value: typeof a == "number" ? a.toString() : a
        };
      });
    }), i = nt(() => `${t.colSize}px`), s = at(null);
    return (r, o) => (P(), q("div", {
      ...
      (P(!0), q(we, null, $e(e.value, (l) => (P(), q("div", {
        key: l.key,
        class: "htw-flex htw-flex-col htw-gap-2",
        ...
        E("div", null, [
          E("div", Cf, [
            Vt((P(), q("pre", Af, [
              ...
              [Ct(ye), l.name.length > r.colSize / 8 ? l.name : ""]
            ]),
            s.value === l.key ? (P(), Y(Ne, {
              key: 0,
              content: l.name,
              class: "htw-flex-none"
            }, null, 8, ["content"])) : ne("", !0)
          ...
          E("div", Mf, [
            Vt((P(), q("pre", Of, [
              ...
              [Ct(ye), l.value.length > r.colSize / 8 ? l.value : ""]
            ]),
            s.value === l.key ? (P(), Y(Ne, {
              key: 0,
...
}), Pf = ["onMouseenter"], Bf = { class: "htw-mx-4" }, Rf = { class: "htw-flex htw-gap-1" }, Ef = { class: "htw-my-0 htw-truncate htw-shrink" }, Lf = { class: "htw-flex htw-gap-1" }, Nf = { class: "htw-my-0 htw-opacity-50 htw-truncate htw-shrink" }, If = {
  name: "HstTokenList"
}, Vf = /* @__PURE__ */ et({
  ...If,
  props: {
  ...
  setup(n) {
    ...
    return (s, r) => (P(!0), q(we, null, $e(e.value, (o) => (P(), q("div", {
      key: o.key,
      ...
      E("div", Bf, [
        E("div", Rf, [
          E("pre", Ef, Bt(o.name), 1),
          i.value === o.key ? (P(), Y(Ne, {
            key: 0,
            content: o.name,
            class: "htw-flex-none"
          }, null, 8, ["content"])) : ne("", !0)
...
(() => {
  ...
  for (let t = 0, e = 0; t < n.length; t++)
    (t % 2 ? xl : wn).push(e = e + n[t]);
})();
function Hf(n) {
  if (n < 768) return !1;
  for (let t = 0, e = wn.length; ; ) {
    let i = t + e >> 1;
    if (n < wn[i]) e = i;
    else if (n >= xl[i]) t = i + 1;
    else return !0;
    if (t == e) return !1;
  }
}
...
const Ir = 8205;
function Ff(n, t, e = !0, i = !0) {
  return (e ? vl : $f)(n, t, i);
}
function vl(n, t, e) {
  if (t == n.length) return t;
  t && Sl(n.charCodeAt(t)) && Cl(n.charCodeAt(t - 1)) && t--;
  let i = Ys(n, t);
  for (t += Vr(i); t < n.length; ) {
    let s = Ys(n, t);
    if (i == Ir || s == Ir || e && Hf(s))
      t += Vr(s), i = s;
    else if (Nr(s)) {
...
function Ys(n, t) {
  ...
  if (!Cl(e) || t + 1 == n.length) return e;
  let i = n.charCodeAt(t + 1);
  return Sl(i) ? (e - 55296 << 10) + (i - 56320) + 65536 : e;
}
function Sl(n) {
...
class I {
  ...
  */
  static of(t) {
    ...
    return t.length == 1 && !t[0] ? I.empty : t.length <= 32 ? new X(t) : Ut.from(X.split(t, []));
  }
}
class X extends I {
  constructor(t, e = zf(t)) {
  ...
  lineInner(t, e, i, s) {
    for (let r = 0; ; r++) {
      ...
      if ((e ? i : l) >= t)
        return new _f(s, l, i, o);
      s = l + 1, i++;
    }
  }
  decompose(t, e, i, s) {
    let r = t <= 0 && e >= this.length ? this : new X(Hr(this.text, t, e), Math.min(e, this.length) - Math.max(0, t));
    if (s & 1) {
      let o = i.pop(), l = ls(r.text, o.text.slice(), 0, r.length);
      if (l.length <= 32)
  ...
  replace(t, e, i) {
    ...
    [t, e] = Xe(this, t, e);
    let s = ls(this.text, ls(i.text, Hr(this.text, 0, t)), e), r = this.length + i.length - (e - t);
...
class Ut extends I {
  ...
  replace(t, e, i) {
    if ([t, e] = Xe(this, t, e), i.lines < this.lines)
      for (let s = 0, r = 0; s < this.children.length; s++) {
        ...
        if (t >= r && e <= l) {
          ...
          if (a.lines < h >> 4 && a.lines > h >> 6) {
            ...
            return f[s] = a, new Ut(f, this.length - (e - t) + i.length);
          }
    ...
    function c(d) {
      ...
      if (d.lines > r && d instanceof Ut)
        for (let m of d.children)
          c(m);
      else d.lines > o && (a > o || !a) ? (u(), l.push(d)) : d instanceof X && a && (p = f[f.length - 1]) instanceof X && d.lines + p.lines <= 32 ? (a += d.lines, h += d.length + 1, f[f.length - 1] = new X(p.text.concat(d.text), p.length + 1 + d.length)) : (a + d.lines > s && u(), a += d.lines, h += d.length + 1, f.push(d));
    }
    function u() {
      a != 0 && (l.push(f.length == 1 ? f[0] : Ut.from(f, h)), h = -1, a = f.length = 0);
    }
    for (let d of t)
      c(d);
...
typeof Symbol < "u" && (I.prototype[Symbol.iterator] = function() {
  return this.iter();
}, wi.prototype[Symbol.iterator] = Al.prototype[Symbol.iterator] = Ml.prototype[Symbol.iterator] = function() {
  return this;
});
class _f {
  /**
...
function Ol(n, t) {
  let e = n.charCodeAt(t);
  if (!jf(e) || t + 1 == n.length)
    return e;
  let i = n.charCodeAt(t + 1);
  return Wf(i) ? (e - 55296 << 10) + (i - 56320) + 65536 : e;
}
function qf(n) {
  return n < 65536 ? 1 : 2;
}
...
class re {
  ...
  */
  mapDesc(t, e = !1) {
    return t.empty ? this : kn(this, t, e);
  }
...
class it extends re {
  ...
  */
  apply(t) {
    ...
    return bn(this, (e, i, s, r, o) => t = t.replace(s, s + (i - e), o), !1), t;
  }
  mapDesc(t, e = !1) {
    return kn(this, t, e, !0);
  }
  /**
  ...
  */
  map(t, e = !1) {
    return t.empty ? this : kn(this, t, e, !0);
  }
  /**
  ...
  filter(t) {
    ...
    t: for (let o = 0, l = 0; ; ) {
      ...
      for (; l < a || l == a && r.len == 0; ) {
        ...
        ft(e, f, c), c > 0 && de(i, e, r.text), r.forward(f), l += f;
      }
      let h = t[o++];
      for (; l < h; ) {
        if (r.done)
        ...
        ft(e, f, -1), ft(s, f, r.ins == -1 ? -1 : r.off == 0 ? r.ins : 0), r.forward(f), l += f;
      }
    }
    return {
      changes: new it(e, i),
      filtered: re.create(s)
    };
  }
  /**
  ...
  static of(t, e, i) {
    ...
    function h(f) {
      if (Array.isArray(f))
        ...
        let p = d ? typeof d == "string" ? I.of(d.split(i || yn)) : d : I.empty, m = p.length;
        if (c == u && m == 0)
          return;
        c < o && a(), c > o && ft(s, c - o, -1), ft(s, u - c, m), de(r, s, p), o = u;
      }
    }
    return h(t), a(!l), l;
  }
...
function kn(n, t, e, i = !1) {
  let s = [], r = i ? [] : null, o = new xi(n), l = new xi(t);
  for (let a = -1; ; ) {
    ...
    if (o.ins == -1 && l.ins == -1) {
      ...
      for (ft(s, l.ins, -1); h; ) {
        ...
        o.ins >= 0 && a < o.i && o.len <= f && (ft(s, 0, o.ins), r && de(r, s, o.text), a = o.i), o.forward(f), h -= f;
      }
      l.next();
    } else if (o.ins >= 0) {
      let h = 0, f = o.len;
      for (; f; )
        if (l.ins == -1) {
          ...
          break;
      ft(s, h, a < o.i ? o.ins : 0), r && a < o.i && de(r, s, o.text), a = o.i, o.forward(o.len - f);
    } else {
      if (o.done && l.done)
        return r ? it.createSet(s, r) : re.create(s);
      throw new Error("Mismatched change set lengths");
    }
  }
}
function Tl(n, t, e = !1) {
  let i = [], s = e ? [] : null, r = new xi(n), o = new xi(t);
  for (let l = !1; ; ) {
    if (r.done && o.done)
      return s ? it.createSet(i, s) : re.create(i);
    if (r.ins == 0)
      ft(i, r.len, 0, l), r.next();
    else if (o.len == 0 && !o.done)
      ft(i, 0, o.ins, l), s && de(s, i, o.text), o.next();
    else {
      if (r.done || o.done)
        throw new Error("Mismatched change set lengths");
      {
        ...
        if (r.ins == -1) {
          ...
          ft(i, a, f, l), s && f && de(s, i, o.text);
        } else o.ins == -1 ? (ft(i, r.off ? 0 : r.len, a, l), s && de(s, i, r.textBit(a))) : (ft(i, r.off ? 0 : r.len, o.off ? 0 : o.ins, l), s && !o.off && de(s, i, o.text));
...
class M {
  ...
  */
  static define(t = {}) {
    return new M(t.combine || ((e) => e), t.compareInput || ((e, i) => e === i), t.compare || (t.combine ? (e, i) => e === i : hr), !!t.static, t.enables);
  }
  /**
  Returns an extension that adds the given value to this facet.
  */
  of(t) {
    return new as([], this, 0, t);
  }
  /**
...
class as {
  ...
  dynamicSlot(t) {
    ...
    return {
      ...
      update(c, u) {
        if (a && u.docChanged || h && (u.docChanged || u.selection) || xn(c, f)) {
          let d = i(c);
          if (l ? !Fr(d, c.values[o], s) : !s(d, c.values[o]))
      ...
      reconfigure: (c, u) => {
        ...
        if (p != null) {
          let m = xs(u, p);
          if (this.dependencies.every((g) => g instanceof M ? u.facet(g) === c.facet(g) : g instanceof zt ? u.field(g, !1) == c.field(g, !1) : !0) || (l ? Fr(d = i(c), m, s) : s(d = i(c), m)))
...
function Kf(n, t, e) {
  ...
  return {
    ...
    reconfigure(a, h) {
      let f = xn(a, i), c = h.config.facets[t.id], u = h.facet(t);
      if (c && !f && hr(e, c))
...
const $i = /* @__PURE__ */ M.define({ static: !0 });
class zt {
  constructor(t, e, i, s, r) {
  ...
  */
  static define(t) {
    let e = new zt(ar++, t.create, t.update, t.compare || ((i, s) => i === s), t);
    return t.provide && (e.provides = t.provide(e)), e;
  }
  create(t) {
    let e = t.facet($i).find((i) => i.field == this);
...
const fr = {
  ...
  */
  highest: /* @__PURE__ */ li(Be.highest),
  /**
  A higher-than-default precedence, for extensions that should
  come before those with default precedence.
  */
  high: /* @__PURE__ */ li(Be.high),
  /**
  The default precedence, which is also used for extensions
  without an explicit precedence.
  */
  default: /* @__PURE__ */ li(Be.default),
  /**
  A lower-than-default precedence.
  */
  low: /* @__PURE__ */ li(Be.low),
  /**
  The lowest precedence level. Meant for things that should end up
  near the end of the extension order.
  */
  lowest: /* @__PURE__ */ li(Be.lowest)
};
class Pl {
  constructor(t, e) {
...
class Bi {
  ...
  */
  reconfigure(t) {
    return Bi.reconfigure.of({ compartment: this, extension: t });
  }
  /**
...
class ks {
  ...
  static resolve(t, e, i) {
    ...
    for (let u of Gf(t, e, o))
      u instanceof zt ? s.push(u) : (r[u.facet.id] || (r[u.facet.id] = [])).push(u);
    ...
    for (let u in r) {
      ...
      if (d.every(
        ...
        l[p.id] = h.length << 1, h.push((g) => Kf(g, p, d));
      }
    }
    let c = h.map((u) => u(l));
    return new ks(t, o, c, l, a, r);
  }
}
function Gf(n, t, e) {
...
const Bl = /* @__PURE__ */ M.define(), Sn = /* @__PURE__ */ M.define({
  combine: (n) => n.some((t) => t),
  static: !0
}), Rl = /* @__PURE__ */ M.define({
  combine: (n) => n.length ? n[0] : void 0,
  static: !0
}), El = /* @__PURE__ */ M.define(), Ll = /* @__PURE__ */ M.define(), Nl = /* @__PURE__ */ M.define(), Il = /* @__PURE__ */ M.define({
...
class $ {
  ...
  */
  map(t) {
    ...
    return e === void 0 ? void 0 : e == this.value ? this : new $(this.type, e);
  }
  /**
...
$.reconfigure = /* @__PURE__ */ $.define();
$.appendConfig = /* @__PURE__ */ $.define();
class ut {
  constructor(t, e, i, s, r, o) {
    this.startState = t, this.changes = e, this.selection = i, this.effects = s, this.annotations = r, this.scrollIntoView = o, this._doc = null, this._state = null, i && Dl(i, e.newLength), r.some((l) => l.type == ut.time) || (this.annotations = r.concat(ut.time.of(Date.now())));
  }
  /**
  @internal
  */
  static create(t, e, i, s, r, o) {
    return new ut(t, e, i, s, r, o);
  }
  /**
...
ut.time = /* @__PURE__ */ ni.define();
ut.userEvent = /* @__PURE__ */ ni.define();
ut.addToHistory = /* @__PURE__ */ ni.define();
ut.remote = /* @__PURE__ */ ni.define();
function Yf(n, t) {
  let e = [];
  for (let i = 0, s = 0; ; ) {
    let r, o;
...
function Vl(n, t, e) {
  ...
  return e ? (s = t.changes, r = it.empty(t.changes.length), o = n.changes.compose(t.changes)) : (s = t.changes.map(n.changes), r = n.changes.mapDesc(t.changes, !0), o = n.changes.compose(s)), {
    ...
    effects: $.mapEffects(n.effects, s).concat($.mapEffects(t.effects, r)),
...
function Cn(n, t, e) {
  let i = t.selection, s = qe(t.annotations);
  return t.userEvent && (s = s.concat(ut.userEvent.of(t.userEvent))), {
    changes: t.changes instanceof it ? t.changes : it.of(t.changes || [], e, n.facet(Rl)),
...
function Hl(n, t, e) {
  ...
  for (let r = 1; r < t.length; r++) {
    ...
    i = Vl(i, Cn(n, t[r], o ? i.changes.newLength : n.doc.length), o);
  }
...
function Xf(n) {
  ...
  for (let s of t.facet(El)) {
    let r = s(n);
    if (r === !1) {
      e = !1;
      break;
    }
    Array.isArray(r) && (e = e === !0 ? r : Yf(e, r));
  }
  if (e !== !0) {
    let s, r;
    if (e === !1)
    ...
    n = ut.create(t, s, n.selection && n.selection.map(r), $.mapEffects(n.effects, r), n.annotations, n.scrollIntoView);
  }
  let i = t.facet(Ll);
  for (let s = i.length - 1; s >= 0; s--) {
    let r = i[s](n);
    r instanceof ut ? n = r : Array.isArray(r) && r.length == 1 && r[0] instanceof ut ? n = r[0] : n = Hl(t, qe(r), !1);
  }
  return n;
}
function Jf(n) {
  let t = n.startState, e = t.facet(Nl), i = n;
  for (let s = e.length - 1; s >= 0; s--) {
    let r = e[s](n);
    r && Object.keys(r).length && (i = Vl(i, Cn(t, r, n.changes.newLength), !0));
  }
  return i == n ? n : ut.create(t, n.changes, n.selection, i.effects, i.annotations, i.scrollIntoView);
}
const Zf = [];
function qe(n) {
  return n == null ? Zf : Array.isArray(n) ? n : [n];
}
...
let An;
try {
  An = /* @__PURE__ */ new RegExp("[\\p{Alphabetic}\\p{Number}_]", "u");
} catch {
}
function ec(n) {
  if (An)
...
class F {
  ...
  */
  applyTransaction(t) {
    ...
    for (let l of t.effects)
      l.is(Bi.reconfigure) ? (e && (s = /* @__PURE__ */ new Map(), e.compartments.forEach((a, h) => s.set(h, a)), e = null), s.set(l.value.compartment, l.value.extension)) : l.is($.reconfigure) ? (e = null, i = l.value) : l.is($.appendConfig) && (e = null, i = qe(i).concat(l.value));
    let r;
    e ? r = t.startState.values.slice() : (e = ks.resolve(i, s, this), r = new F(e, this.doc, this.selection, e.dynamicSlots.map(() => null), (a, h) => h.reconfigure(a, this), null).values);
  ...
  */
  changeByRange(t) {
    let e = this.selection, i = t(e.ranges[0]), s = this.changes(i.changes), r = [i.range], o = qe(i.effects);
    for (let l = 1; l < e.ranges.length; l++) {
      let a = t(e.ranges[l]), h = this.changes(a.changes), f = h.map(s);
      for (let u = 0; u < l; u++)
        r[u] = r[u].map(f);
      let c = s.mapDesc(h, !0);
      r.push(a.range.map(c)), s = s.compose(f), o = $.mapEffects(o, f).concat($.mapEffects(qe(a.effects), c));
    }
    return {
      changes: s,
  ...
  */
  changes(t = []) {
    return t instanceof it ? t : it.of(t, this.doc.length, this.facet(F.lineSeparator));
  }
  /**
  ...
  */
  toText(t) {
    return I.of(t.split(this.facet(F.lineSeparator) || yn));
  }
  /**
  ...
  */
  facet(t) {
    ...
    return e == null ? t.default : (yi(this, e), xs(this, e));
  }
  /**
  ...
  */
  toJSON(t) {
    ...
    if (t)
      for (let i in t) {
        let s = t[i];
        s instanceof zt && this.config.address[s.id] != null && (e[i] = s.spec.toJSON(this.field(t[i]), this));
      }
    return e;
  }
  /**
  ...
  */
  static create(t = {}) {
    let e = ks.resolve(t.extensions || [], /* @__PURE__ */ new Map()), i = t.doc instanceof I ? t.doc : I.of((t.doc || "").split(e.staticFacet(F.lineSeparator) || yn)), s = t.selection ? t.selection instanceof b ? t.selection : b.single(t.selection.anchor, t.selection.head) : b.single(0);
    return Dl(s, i.length), e.staticFacet(Sn) || (s = s.asSingle()), new F(e, i, s, e.dynamicSlots.map(() => null), (r, o) => o.create(r), null);
  }
  /**
...
`;
  ...
  */
  wordAt(t) {
    ...
    for (; o > 0; ) {
      let a = pt(e, o, !1);
      if (r(e.slice(a, o)) != se.Word)
        break;
      o = a;
    }
    for (; l < s; ) {
      let a = pt(e, l);
      if (r(e.slice(l, a)) != se.Word)
        break;
      l = a;
    }
...
F.allowMultipleSelections = Sn;
F.tabSize = /* @__PURE__ */ M.define({
  combine: (n) => n.length ? n[0] : 4
});
F.lineSeparator = Rl;
F.readOnly = Il;
F.phrases = /* @__PURE__ */ M.define({
  compare(n, t) {
...
F.languageData = Bl;
F.changeFilter = El;
F.transactionFilter = Ll;
F.transactionExtender = Nl;
Bi.reconfigure = /* @__PURE__ */ $.define();
function $s(n, t, e = {}) {
  let i = {};
  for (let s of n)
...
class cr {
  ...
  map(t, e) {
    ...
    return { mapped: i.length ? new cr(s, r, i, l) : null, pos: o };
  }
}
class V {
  constructor(t, e, i, s) {
  ...
  */
  update(t) {
    ...
    if (e.length == 0 && !o)
      return this;
    if (i && (e = e.slice().sort(On)), this.isEmpty)
      return e.length ? V.of(e) : this;
    let l = new $l(this, null, -1).goto(0), a = 0, h = [], f = new be();
    for (; l.value || a < e.length; )
      ...
      } else l.rangeIndex == 1 && l.chunkIndex < this.chunk.length && (a == e.length || this.chunkEnd(l.chunkIndex) < e[a].from) && (!o || s > this.chunkEnd(l.chunkIndex) || r < this.chunkPos[l.chunkIndex]) && f.addChunk(this.chunkPos[l.chunkIndex], this.chunk[l.chunkIndex]) ? l.nextChunk() : ((!o || s > l.to || r < l.from || o(l.from, l.to, l.value)) && (f.addInner(l.from, l.to, l.value) || h.push(Mn.create(l.from, l.to, l.value))), l.next());
    return f.finishInner(this.nextLayer.isEmpty && !h.length ? V.empty : this.nextLayer.update({ add: h, filter: o, filterFrom: s, filterTo: r }));
  }
  /**
  ...
  */
  map(t) {
    ...
    return e.length == 0 ? r : new V(i, e, r || V.empty, s);
  }
  /**
  ...
  */
  static compare(t, e, i, s, r = -1) {
    let o = t.filter((c) => c.maxPoint > 0 || !c.isEmpty && c.maxPoint >= r), l = e.filter((c) => c.maxPoint > 0 || !c.isEmpty && c.maxPoint >= r), a = $r(o, l, i), h = new ai(o, a, r), f = new ai(l, a, r);
    i.iterGaps((c, u, d) => zr(h, c, f, u, d, s)), i.empty && i.length == 0 && zr(h, 0, f, 0, 0, s);
  }
  /**
  ...
  */
  static eq(t, e, i = 0, s) {
    ...
    if (!r.length)
      return !0;
    let l = $r(r, o), a = new ai(r, l, 0).goto(i), h = new ai(o, l, 0).goto(i);
    for (; ; ) {
      if (a.to != h.to || !Tn(a.active, h.active) || a.point && (!h.point || !a.point.eq(h.point)))
        return !1;
      if (a.to > s)
        return !0;
      a.next(), h.next();
  ...
  */
  static of(t, e = !1) {
    let i = new be();
    for (let s of t instanceof Mn ? [t] : e ? sc(t) : t)
  ...
  */
  static join(t) {
    ...
    for (let i = t.length - 2; i >= 0; i--)
      for (let s = t[i]; s != V.empty; s = s.nextLayer)
        e = new V(s.chunkPos, s.chunk, e, Math.max(s.maxPoint, e.maxPoint));
    return e;
  }
}
...
class be {
  finishChunk(t) {
    this.chunks.push(new cr(this.from, this.to, this.value, this.maxPoint)), this.chunkPos.push(this.chunkStart), this.chunkStart = -1, this.setMaxPoint = Math.max(this.setMaxPoint, this.maxPoint), this.maxPoint = -1, t && (this.from = [], this.to = [], this.value = []);
  }
  /**
...
class vi {
  ...
  static from(t, e = null, i = -1) {
    ...
    for (let r = 0; r < t.length; r++)
      for (let o = t[r]; !o.isEmpty; o = o.nextLayer)
        o.maxPoint >= i && s.push(new $l(o, e, i, r));
    return s.length == 1 ? s[0] : new vi(s);
  }
  get startSide() {
    return this.value ? this.value.startSide : 0;
  }
  ...
  next() {
    if (this.heap.length == 0)
      ...
      let t = this.heap[0];
      this.from = t.from, this.to = t.to, this.value = t.value, this.rank = t.rank, t.value && t.next(), Xs(this.heap, 0);
    }
  }
}
function Xs(n, t) {
...
class ai {
  constructor(t, e, i) {
    this.minPoint = i, this.active = [], this.activeTo = [], this.activeRank = [], this.minActive = -1, this.point = null, this.pointFrom = 0, this.pointRank = 0, this.to = -1e9, this.endSide = 0, this.openStart = -1, this.cursor = vi.from(t, e, i);
  }
  goto(t, e = -1e9) {
  ...
  removeActive(t) {
    zi(this.active, t), zi(this.activeTo, t), zi(this.activeRank, t), this.minActive = _r(this.active, this.activeTo);
  }
  addActive(t) {
    let e = 0, { value: i, to: s, rank: r } = this.cursor;
    for (; e < this.activeRank.length && (r - this.activeRank[e] || s - this.activeTo[e]) > 0; )
      e++;
    _i(this.active, e, i), _i(this.activeTo, e, s), _i(this.activeRank, e, r), t && _i(t, e, this.cursor.from), this.minActive = _r(this.active, this.activeTo);
  }
...
function zr(n, t, e, i, s, r) {
  ...
  let o = i + s, l = i, a = i - t;
  for (; ; ) {
    let h = n.to + a - e.to, f = h || n.endSide - e.endSide, c = f < 0 ? n.to + a : e.to, u = Math.min(c, o);
    if (n.point || e.point ? n.point && e.point && (n.point == e.point || n.point.eq(e.point)) && Tn(n.activeForPoint(n.to), e.activeForPoint(e.to)) || r.comparePoint(l, u, n.point, e.point) : u > l && !Tn(n.active, e.active) && r.compareRange(l, u, n.active, e.active), c > o)
      break;
    (h || n.openEnd != e.openEnd) && r.boundChange && r.boundChange(c), l = c, f <= 0 && n.next(), f >= 0 && e.next();
  }
}
function Tn(n, t) {
  if (n.length != t.length)
...
function Ri(n, t, e = n.length) {
  let i = 0;
  for (let s = 0; s < e && s < n.length; )
    n.charCodeAt(s) == 9 ? (i += t - i % t, s++) : (i++, s = pt(n, s));
  return i;
}
function nc(n, t, e, i) {
  for (let s = 0, r = 0; ; ) {
    ...
    if (s == n.length)
      break;
    r += n.charCodeAt(s) == 9 ? e - r % e : 1, s = pt(n, s);
  }
  return n.length;
}
const Dn = "ͼ", Wr = typeof Symbol > "u" ? "__" + Dn : Symbol.for(Dn), Pn = typeof Symbol > "u" ? "__styleSet" + Math.floor(Math.random() * 1e8) : Symbol("styleSet"), jr = typeof globalThis < "u" ? globalThis : typeof window < "u" ? window : {};
class ke {
...
`);
  ...
  static newName() {
    let t = jr[Wr] || 1;
    return jr[Wr] = t + 1, Dn + t.toString(36);
  }
  ...
  static mount(t, e, i) {
    let s = t[Pn], r = i && i.nonce;
    s ? r && s.setNonce(r) : s = new rc(t, r), s.mount(Array.isArray(e) ? e : [e], t);
  }
}
...
var xe = {
  ...
  221: "}",
  222: '"'
}, oc = typeof navigator < "u" && /Mac/.test(navigator.platform), lc = typeof navigator < "u" && /MSIE \d|Trident\/(?:[7-9]|\d{2,})\..*rv:(\d+)/.exec(navigator.userAgent);
for (var lt = 0; lt < 10; lt++) xe[48 + lt] = xe[96 + lt] = String(lt);
for (var lt = 1; lt <= 24; lt++) xe[lt + 111] = "F" + lt;
for (var lt = 65; lt <= 90; lt++)
  xe[lt] = String.fromCharCode(lt + 32), Si[lt] = String.fromCharCode(lt);
for (var Js in xe) Si.hasOwnProperty(Js) || (Si[Js] = xe[Js]);
function ac(n) {
  var t = oc && n.metaKey && n.shiftKey && !n.ctrlKey && !n.altKey || lc && n.shiftKey && n.key && n.key.length == 1 || n.key == "Unidentified", e = !t && n.key || (n.shiftKey ? Si : xe)[n.keyCode] || n.key || "Unidentified";
...
function bi(n, t, e, i) {
  return e ? Kr(n, t, e, i, -1) || Kr(n, t, e, i, 1) : !1;
}
function Ie(n) {
  for (var t = 0; ; t++)
...
function fc(n, t, e, i, s, r, o, l) {
  ...
  for (let f = n, c = !1; f && !c; )
    if (f.nodeType == 1) {
      ...
      let g = 0, w = 0;
      if (s == "nearest")
        t.top < u.top ? (w = -(u.top - t.top + o), e > 0 && t.bottom > u.bottom + w && (w = t.bottom - u.bottom + w + o)) : t.bottom > u.bottom && (w = t.bottom - u.bottom + o, e < 0 && t.top - w < u.top && (w = -(u.top + w - t.top + o)));
      else {
        let x = t.bottom - t.top, v = u.bottom - u.top;
        w = (s == "center" && x <= v ? t.top + x / 2 - v / 2 : s == "start" || s == "center" && e < 0 ? t.top - o : t.bottom - v + o) - u.top;
      }
      if (i == "nearest" ? t.left < u.left ? (g = -(u.left - t.left + r), e > 0 && t.right > u.right + g && (g = t.right - u.right + g + r)) : t.right > u.right && (g = t.right - u.right + r, e < 0 && t.left < u.left + g && (g = -(u.left + g - t.left + r))) : g = (i == "center" ? t.left + (t.right - t.left) / 2 - (u.right - u.left) / 2 : i == "start" == l ? t.left - r : t.right - (u.right - u.left) + r) - u.left, g || w)
        if (d)
          h.scrollBy(g, w);
        else {
          let x = 0, v = 0;
          if (w) {
            let C = f.scrollTop;
            f.scrollTop += w / m, v = (f.scrollTop - C) * m;
          }
          if (g) {
            let C = f.scrollLeft;
          ...
          t = {
            ...
            right: t.right - x,
            bottom: t.bottom - v
          }, x && Math.abs(x - g) < 1 && (i = "nearest"), v && Math.abs(v - w) < 1 && (s = "nearest");
        }
      if (d)
        break;
      f = f.assignedSlot || f.parentNode;
...
class uc {
  ...
  setRange(t) {
    ...
    this.set(e, Math.min(t.anchorOffset, e ? Jt(e) : 0), i, Math.min(t.focusOffset, i ? Jt(i) : 0));
  }
  set(t, e, i, s) {
...
let Gr;
function Ve(n, t, e = t) {
  let i = Gr || (Gr = document.createRange());
...
function pc(n, t) {
  ...
  if (!e || t.anchorNode != e || t.anchorOffset != i)
    return !1;
  for (i = Math.min(i, Jt(e)); ; )
    if (i) {
      if (e.nodeType != 1)
        return !1;
      let s = e.childNodes[i - 1];
      s.contentEditable == "false" ? i-- : (e = s, i = Jt(e));
    } else {
      if (e == n)
        return !0;
      i = Ie(e), e = e.parentNode;
    }
}
function jl(n) {
  ...
  for (let e = n, i = t; ; ) {
    ...
    if (e.nodeType == 1 && i > 0) {
      if (e.contentEditable == "false")
        return null;
      e = e.childNodes[i - 1], i = Jt(e);
    } else if (e.parentNode && !vs(e))
      i = Ie(e), e = e.parentNode;
    else
      return null;
  }
...
class ct {
  ...
  static before(t, e) {
    return new ct(t.parentNode, Ie(t), e);
  }
  static after(t, e) {
    return new ct(t.parentNode, Ie(t) + 1, e);
  }
}
const ur = [];
class _ {
  ...
  domBoundsAround(t, e, i = 0) {
    ...
    for (let a = 0, h = i, f = i; a < this.children.length; a++) {
      ...
      if (u >= t && s == -1 && (s = a, r = h), h > e && c.dom.parentNode == this.dom) {
        o = a, l = f;
        break;
      }
  ...
  childCursor(t = this.length) {
    return new Gl(this.children, t, this.children.length);
  }
  childPos(t, e = 1) {
...
function Ul(n, t, e, i, s, r, o, l, a) {
  let { children: h } = n, f = h.length ? h[t] : null, c = r.length ? r[r.length - 1] : null, u = c ? c.breakAfter : o;
  if (!(t == i && f && !o && !u && r.length < 2 && f.merge(e, s, r.length ? c : null, e == 0, l, a))) {
    if (i < h.length) {
      let d = h[i];
      d && (s < d.length || d.breakAfter && (c != null && c.breakAfter)) ? (t == i && (d = d.split(s), s = 0), !u && c && d.merge(0, s, c, !0, 0, a) ? r[r.length - 1] = d : ((s || d.children.length && !d.children[0].length) && d.merge(0, s, null, !1, 0, a), r.push(d))) : d != null && d.breakAfter && (c ? c.breakAfter = 1 : o = 1), i++;
    }
...
function Ql(n, t, e, i, s, r) {
  let o = n.childCursor(), { i: l, off: a } = o.findPos(e, 1), { i: h, off: f } = o.findPos(t, -1), c = t - e;
  for (let u of i)
    c += u.length;
  n.length += c, Ul(n, h, f, l, a, i, 0, s, r);
}
let wt = typeof navigator < "u" ? navigator : { userAgent: "", vendor: "", platform: "" }, Rn = typeof document < "u" ? document : { documentElement: { style: {} } };
const En = /* @__PURE__ */ /Edge\/(\d+)/.exec(wt.userAgent), Yl = /* @__PURE__ */ /MSIE \d/.test(wt.userAgent), Ln = /* @__PURE__ */ /Trident\/(?:[7-9]|\d{2,})\..*rv:(\d+)/.exec(wt.userAgent), _s = !!(Yl || Ln || En), Qr = !_s && /* @__PURE__ */ /gecko\/(\d+)/i.test(wt.userAgent), Zs = !_s && /* @__PURE__ */ /Chrome\/(\d+)/.exec(wt.userAgent), Yr = "webkitFontSmoothing" in Rn.documentElement.style, Xl = !_s && /* @__PURE__ */ /Apple Computer/.test(wt.vendor), Xr = Xl && (/* @__PURE__ */ /Mobile\/\w+/.test(wt.userAgent) || wt.maxTouchPoints > 2);
var S = {
  mac: Xr || /* @__PURE__ */ /Mac/.test(wt.platform),
  windows: /* @__PURE__ */ /Win/.test(wt.platform),
  linux: /* @__PURE__ */ /Linux|X11/.test(wt.platform),
  ie: _s,
  ie_version: Yl ? Rn.documentMode || 6 : Ln ? +Ln[1] : En ? +En[1] : 0,
  gecko: Qr,
  gecko_version: Qr ? +(/* @__PURE__ */ /Firefox\/(\d+)/.exec(wt.userAgent) || [0, 0])[1] : 0,
  chrome: !!Zs,
  chrome_version: Zs ? +Zs[1] : 0,
  ios: Xr,
  android: /* @__PURE__ */ /Android\b/.test(wt.userAgent),
  webkit: Yr,
  safari: Xl,
  webkit_version: Yr ? +(/* @__PURE__ */ /\bAppleWebKit\/(\d+)/.exec(wt.userAgent) || [0, 0])[1] : 0,
  tabSize: Rn.documentElement.style.tabSize != null ? "tab-size" : "-moz-tab-size"
};
const gc = 256;
class Ht extends _ {
  constructor(t) {
  ...
  merge(t, e, i) {
    return this.flags & 8 || i && (!(i instanceof Ht) || this.length - (e - t) + i.length > gc || i.flags & 8) ? !1 : (this.text = this.text.slice(0, t) + (i ? i.text : "") + this.text.slice(e), this.markDirty(), !0);
  }
  split(t) {
    let e = new Ht(this.text.slice(t));
...
class ae extends _ {
  ...
  merge(t, e, i, s, r, o) {
    return i && (!(i instanceof ae && i.mark.eq(this.mark)) || t && r <= 0 || e < this.length && o <= 0) ? !1 : (Ql(this, t, e, i ? i.children.slice() : [], r - 1, o - 1), this.markDirty(), !0);
  }
  split(t) {
    let e = [], i = 0, s = -1, r = 0;
    ...
    let o = this.length - t;
    return this.length = t, s > -1 && (this.children.length = s, this.markDirty()), new ae(this.mark, e, o);
  }
  domAtPos(t) {
    return Jl(this, t);
  }
...
function mc(n, t, e) {
  ...
  return S.safari && !o && a.width == 0 && (a = Array.prototype.find.call(l, (h) => h.width) || a), o ? zs(a, o < 0) : a || null;
}
class pe extends _ {
  static create(t, e, i) {
    return new pe(t, e, i);
  ...
  split(t) {
    let e = pe.create(this.widget, this.length - t, this.side);
  ...
  become(t) {
    return t instanceof pe && t.side == this.side && this.widget.constructor == t.widget.constructor ? (this.widget.compare(t.widget) || this.markDirty(!0), this.dom && !this.prevWidget && (this.prevWidget = this.widget), this.widget = t.widget, this.length = t.length, !0) : !1;
  }
  ignoreMutation() {
    return !0;
  }
...
class Ze extends _ {
  ...
  become(t) {
    return t instanceof Ze && t.side == this.side;
  }
  split() {
    return new Ze(this.side);
  }
  sync() {
    if (!this.dom) {
...
Ht.prototype.children = pe.prototype.children = Ze.prototype.children = ur;
function Jl(n, t) {
...
function Zl(n, t, e) {
  let i, { children: s } = n;
  e > 0 && t instanceof ae && s.length && (i = s[s.length - 1]) instanceof ae && i.mark.eq(t.mark) ? Zl(i, t.children[0], e - 1) : (s.push(t), t.setParent(n)), n.length += t.length;
}
function ta(n, t, e) {
  ...
  function l(h, f) {
    for (let c = 0, u = 0; c < h.children.length && u <= f; c++) {
      ...
      p >= f && (d.children.length ? l(d, f - u) : (!r || r.isHidden && e > 0) && (p > f || u == p && d.getSide() > 0) ? (r = d, o = f - u) : (u < f || u == p && d.getSide() < 0 && !d.isHidden) && (i = d, s = f - u)), u = p;
    }
  }
  l(n, t);
  let a = (e < 0 ? i : r) || i || r;
  return a ? a.coordsAt(Math.max(0, a == i ? s : o), e) : wc(n);
}
function wc(n) {
...
class L extends Je {
  ...
  */
  static widget(t) {
    ...
    return e += i && !t.inlineOrder ? e > 0 ? 3e8 : -4e8 : e > 0 ? 1e8 : -1e8, new ve(t, e, e, i, t.widget || null, !1);
  }
  /**
  ...
  */
  static replace(t) {
    ...
    if (t.isBlockGap)
      ...
      let { start: r, end: o } = ea(t, e);
      i = (r ? e ? -3e8 : -1 : 5e8) - 1, s = (o ? e ? 2e8 : 1 : -6e8) + 1;
    }
    return new ve(t, i, s, e, t.widget || null, !0);
  }
  /**
...
class Ei extends L {
  constructor(t) {
    let { start: e, end: i } = ea(t);
    super(e ? -1 : 5e8, i ? 1 : -6e8, null, t), this.tagName = t.tagName || "span", this.class = t.class || "", this.attrs = t.attributes || null;
  }
  eq(t) {
    var e, i;
    return this == t || t instanceof Ei && this.tagName == t.tagName && (this.class || ((e = this.attrs) === null || e === void 0 ? void 0 : e.class)) == (t.class || ((i = t.attrs) === null || i === void 0 ? void 0 : i.class)) && Ss(this.attrs, t.attrs, "class");
  }
  range(t, e = t) {
    if (t >= e)
...
class Li extends L {
  ...
  eq(t) {
    return t instanceof Li && this.spec.class == t.spec.class && Ss(this.spec.attributes, t.spec.attributes);
  }
  range(t, e = t) {
    if (e != t)
...
Li.prototype.mapMode = yt.TrackBefore;
...
class ve extends L {
  ...
  eq(t) {
    return t instanceof ve && bc(this.widget, t.widget) && this.block == t.block && this.startSide == t.startSide && this.endSide == t.endSide;
  }
  range(t, e = t) {
...
class Z extends _ {
  ...
  merge(t, e, i, s, r, o) {
    ...
    return s && this.setDeco(i ? i.attrs : null), Ql(this, t, e, i ? i.children.slice() : [], r, o), !0;
  }
  split(t) {
    let e = new Z();
  ...
  setDeco(t) {
    Ss(this.attrs, t) || (this.dom && (this.prevAttrs = this.attrs, this.markDirty()), this.attrs = t);
  }
  append(t, e) {
    Zl(this, t, e);
  }
  ...
  addLineDeco(t) {
    ...
    e && (this.attrs = Nn(e, this.attrs || {})), i && (this.attrs = Nn({ class: i }, this.attrs || {}));
  }
  domAtPos(t) {
    return Jl(this, t);
  }
  ...
  sync(t, e) {
    var i;
    this.dom ? this.flags & 4 && (Wl(this.dom), this.dom.className = "cm-line", this.prevAttrs = this.attrs ? null : void 0) : (this.setDOM(document.createElement("div")), this.dom.className = "cm-line", this.prevAttrs = this.attrs ? null : void 0), this.prevAttrs !== void 0 && (In(this.dom, this.prevAttrs, this.attrs), this.dom.classList.add("cm-line"), this.prevAttrs = void 0), super.sync(t, e);
    let s = this.dom.lastChild;
    for (; s && _.get(s) instanceof ae; )
      s = s.lastChild;
    if (!s || !this.length || s.nodeName != "BR" && ((i = _.get(s)) === null || i === void 0 ? void 0 : i.isEditable) == !1 && (!S.ios || !this.children.some((r) => r instanceof Ht))) {
  ...
  become(t) {
    return t instanceof Z && this.children.length == 0 && t.children.length == 0 && Ss(this.attrs, t.attrs) && this.breakAfter == t.breakAfter;
  }
  covers() {
    return !0;
  }
...
class oe extends _ {
  ...
  merge(t, e, i, s, r, o) {
    return i && (!(i instanceof oe) || !this.widget.compare(i.widget) || t > 0 && r <= 0 || e < this.length && o <= 0) ? !1 : (this.length = t + (i ? i.length : 0) + (this.length - e), !0);
  }
  domAtPos(t) {
  ...
  split(t) {
    let e = this.length - t;
    this.length = t;
    let i = new oe(this.widget, e, this.deco);
  ...
  become(t) {
    return t instanceof oe && t.widget.constructor == this.widget.constructor ? (t.widget.compare(this.widget) || this.markDirty(!0), this.dom && !this.prevWidget && (this.prevWidget = this.widget), this.widget = t.widget, this.length = t.length, this.deco = t.deco, this.breakAfter = t.breakAfter, !0) : !1;
  }
  ignoreMutation() {
    return !0;
  }
  ...
  coordsAt(t, e) {
    let i = this.widget.coordsAt(this.dom, t, e);
    return i || (this.widget instanceof Vn ? null : zs(this.dom.getBoundingClientRect(), this.length ? t == 0 : e <= 0));
  }
  destroy() {
    super.destroy(), this.dom && this.widget.destroy(this.dom);
  }
...
class ki {
  ...
  posCovered() {
    ...
    return !(t.breakAfter || t instanceof oe && t.deco.endSide < 0);
  }
  getLine() {
    return this.curLine || (this.content.push(this.curLine = new Z()), this.atCursorPos = !0), this.curLine;
  }
  flushBuffer(t = this.bufferMarks) {
    this.pendingBuffer && (this.curLine.append(Wi(new Ze(-1), t), t.length), this.pendingBuffer = 0);
  }
  addBlockWidget(t) {
    this.flushBuffer(), this.curLine = null, this.content.push(t);
  }
  finish(t) {
    this.pendingBuffer && t <= this.bufferMarks.length ? this.flushBuffer() : this.pendingBuffer = 0, !this.posCovered() && !(t && this.content.length && this.content[this.content.length - 1] instanceof oe) && this.getLine();
  }
  buildText(t, e, i) {
    for (; t > 0; ) {
      ...
      this.flushBuffer(e.slice(e.length - i)), this.getLine().append(Wi(new Ht(this.text.slice(this.textOff, this.textOff + s)), e), i), this.atCursorPos = !0, this.textOff += s, t -= s, i = 0;
    }
  }
  span(t, e, i, s) {
  ...
  point(t, e, i, s, r, o) {
    if (this.disallowBlockEffectsFor[o] && i instanceof ve) {
      if (i.block)
    ...
    if (i instanceof ve)
      if (i.block)
        i.startSide > 0 && !this.posCovered() && this.getLine(), this.addBlockWidget(new oe(i.widget || ti.block, l, i));
      else {
        let a = pe.create(i.widget || ti.inline, l, l ? 0 : i.startSide), h = this.atCursorPos && !a.isEditable && r <= s.length && (t < e || i.startSide > 0), f = !a.isEditable && (t < e || r > s.length || i.startSide <= 0), c = this.getLine();
        this.pendingBuffer == 2 && !h && !a.isEditable && (this.pendingBuffer = 0), this.flushBuffer(s), h && (c.append(Wi(new Ze(1), s), r), r = s.length + Math.max(0, r - s.length)), c.append(Wi(a, s), r), this.atCursorPos = f, this.pendingBuffer = f ? t < e || r > s.length ? 1 : 2 : 0, this.pendingBuffer && (this.bufferMarks = s.slice());
      }
  ...
  static build(t, e, i, s, r) {
    ...
    return o.openEnd = V.spans(s, e, i, o), o.openStart < 0 && (o.openStart = o.openEnd), o.finish(o.openEnd), o;
  }
}
function Wi(n, t) {
  for (let e of t)
    n = new ae(e, [n], n.length);
  return n;
}
class ti extends Me {
  constructor(t) {
...
ti.inline = /* @__PURE__ */ new ti("span");
ti.block = /* @__PURE__ */ new ti("div");
var J = /* @__PURE__ */ function(n) {
  return n[n.LTR = 0] = "LTR", n[n.RTL = 1] = "RTL", n;
}(J || (J = {}));
const He = J.LTR, dr = J.RTL;
function ia(n) {
  let t = [];
  for (let e = 0; e < n.length; e++)
    t.push(1 << +n[e]);
...
const kc = /* @__PURE__ */ ia("88888888888888888888888888888888888666888888787833333333337888888000000000000000000000000008888880000000000000000000000000088888888888888888888888888888888888887866668888088888663380888308888800000000000000000000000800000000000000000000000000000008"), xc = /* @__PURE__ */ ia("4444448826627288999999999992222222222222222222222222222222222222222222222229999999999999999999994444444444644222822222222222222222222222222222222222222222222222222222222222222222222222222222222222222222222222222222999999949999999229989999223333333333"), Hn = /* @__PURE__ */ Object.create(null), jt = [];
for (let n of ["()", "[]", "{}"]) {
  let t = /* @__PURE__ */ n.charCodeAt(0), e = /* @__PURE__ */ n.charCodeAt(1);
  Hn[t] = e, Hn[e] = -t;
}
function sa(n) {
  return n <= 247 ? kc[n] : 1424 <= n && n <= 1524 ? 2 : 1536 <= n && n <= 1785 ? xc[n - 1536] : 1774 <= n && n <= 2220 ? 4 : 8192 <= n && n <= 8204 ? 256 : 64336 <= n && n <= 65023 ? 4 : 1;
}
const vc = /[\u0590-\u05f4\u0600-\u06ff\u0700-\u08ac\ufb50-\ufdff]/;
class ge {
  /**
...
function na(n, t) {
  ...
  for (let e = 0; e < n.length; e++) {
    let i = n[e], s = t[e];
    if (i.from != s.from || i.to != s.to || i.direction != s.direction || !na(i.inner, s.inner))
      return !1;
  }
  return !0;
}
...
function Sc(n, t, e, i, s) {
  for (let r = 0; r <= i.length; r++) {
    ...
    for (let h = o, f = a, c = a; h < l; h++) {
      let u = sa(n.charCodeAt(h));
      u == 512 ? u = f : u == 8 && c == 4 && (u = 16), z[h] = u == 4 ? 2 : u, u & 7 && (c = u), f = u;
    }
    for (let h = o, f = a, c = a; h < l; h++) {
      let u = z[h];
      if (u == 128)
        h < l - 1 && f == z[h + 1] && f & 24 ? u = z[h] = f : z[h] = 256;
      else if (u == 64) {
        let d = h + 1;
        for (; d < l && z[d] == 64; )
          d++;
        let p = h && f == 8 || d < e && z[d] == 8 ? c == 1 ? 1 : 8 : 256;
        for (let m = h; m < d; m++)
          z[m] = p;
        h = d - 1;
      } else u == 8 && c == 1 && (z[h] = 1);
...
function Cc(n, t, e, i, s) {
  ...
  for (let o = 0, l = 0, a = 0; o <= i.length; o++) {
    ...
    for (let c = h, u, d, p; c < f; c++)
      if (d = Hn[u = n.charCodeAt(c)])
        if (d < 0) {
          for (let m = l - 3; m >= 0; m -= 3)
            if (jt[m + 1] == -d) {
              let g = jt[m + 2], w = g & 2 ? s : g & 4 ? g & 1 ? r : s : 0;
              w && (z[c] = z[jt[m]] = w), l = m;
              break;
            }
        } else {
      ...
      if (h == 256) {
        ...
        for (; ; )
          if (f == l) {
            ...
            break;
        let c = r == 1, u = (f < t ? z[f] : i) == 1, d = c == u ? c ? 1 : 2 : i;
        for (let p = f, m = s, g = m ? e[m - 1].to : n; p > a; )
          p == g && (p = e[--m].from, g = m ? e[m - 1].to : n), z[--p] = d;
        a = f;
      } else
        r = h, a++;
    }
      ...
      t: for (; ; )
        if (h < r.length && p == r[h].from) {
          ...
          if (h++, u)
            ...
            m.from > a && o.push(new ge(a, m.from, d));
            let g = m.direction == He != !(d % 2);
            $n(n, g ? i + 1 : i, s, m.inner, m.from, m.to, o), a = m.to;
          }
          p = m.to;
        } else {
          if (p == e || (f ? z[p] != l : z[p] == l))
            break;
          p++;
        }
      u ? Fn(n, a, p, i + 1, s, u, o) : a < p && o.push(new ge(a, p, d)), a = p;
    }
  else
      ...
      t: for (; ; )
        if (h && p == r[h - 1].to) {
          ...
          if (u)
            ...
            m.to < a && o.push(new ge(m.to, a, d));
            let g = m.direction == He != !(d % 2);
            $n(n, g ? i + 1 : i, s, m.inner, m.from, m.to, o), a = m.from;
          }
          p = m.from;
        } else {
          if (p == t || (f ? z[p - 1] != l : z[p - 1] == l))
            break;
          p--;
        }
      u ? Fn(n, p, a, i + 1, s, u, o) : p < a && o.push(new ge(p, a, d)), a = p;
    }
}
function $n(n, t, e, i, s, r, o) {
  let l = t % 2 ? 2 : 1;
  Sc(n, s, r, i, l), Cc(n, s, r, i, l), Ac(s, r, i, l), Fn(n, s, r, t, e, i, o);
}
function Mc(n, t, e) {
  if (!n)
    return [new ge(0, 0, t == dr ? 1 : 0)];
  if (t == He && !e.length && !vc.test(n))
    return ra(n.length);
  if (e.length)
    for (; n.length > z.length; )
      z[z.length] = 256;
  let i = [], s = t == He ? 0 : 1;
  return $n(n, s, s, e, 0, n.length, i), i;
}
function ra(n) {
  return [new ge(0, n, 0)];
}
...
function Oc(n, t, e, i, s) {
  var r;
  let o = i.head - n.from, l = ge.find(t, o, (r = i.bidiLevel) !== null && r !== void 0 ? r : -1, i.assoc), a = t[l], h = a.side(s, e);
  if (o == h) {
    let u = l += s ? 1 : -1;
    if (u < 0 || u >= t.length)
      return null;
  ...
  let f = pt(n.text, o, a.forward(s, e));
  (f < a.from || f > a.to) && (f = h), oa = n.text.slice(Math.min(o, f), Math.max(o, f));
  let c = l == (s ? t.length - 1 : 0) ? null : t[l + (s ? 1 : -1)];
  return c && f == h && c.level + (s ? 0 : 1) < a.level ? b.cursor(c.side(!s, e) + n.from, c.forward(s, e) ? 1 : -1, c.level) : b.cursor(f + n.from, a.forward(s, e) ? -1 : 1, a.level);
}
function Tc(n, t, e) {
  for (let i = t; i < e; i++) {
    let s = sa(n.charCodeAt(i));
    if (s == 1)
      return He;
    if (s == 2 || s == 4)
      return dr;
...
const la = /* @__PURE__ */ M.define(), aa = /* @__PURE__ */ M.define(), ha = /* @__PURE__ */ M.define(), fa = /* @__PURE__ */ M.define(), zn = /* @__PURE__ */ M.define(), ca = /* @__PURE__ */ M.define(), ua = /* @__PURE__ */ M.define(), pr = /* @__PURE__ */ M.define(), gr = /* @__PURE__ */ M.define(), da = /* @__PURE__ */ M.define({
  combine: (n) => n.some((t) => t)
}), Dc = /* @__PURE__ */ M.define({
  combine: (n) => n.some((t) => t)
}), pa = /* @__PURE__ */ M.define();
class Ge {
...
const ji = /* @__PURE__ */ $.define({ map: (n, t) => n.map(t) }), ga = /* @__PURE__ */ $.define();
function Nt(n, t, e) {
  let i = n.facet(fa);
  i.length ? i[0](t) : window.onerror ? window.onerror(String(t), e, void 0, void 0, t) : e ? console.error(e + ":", t) : console.error(t);
}
const ie = /* @__PURE__ */ M.define({ combine: (n) => n.length ? n[0] : !0 });
let Pc = 0;
const di = /* @__PURE__ */ M.define();
class bt {
  constructor(t, e, i, s, r) {
  ...
  update(t) {
    if (this.value) {
      if (this.mustUpdate) {
        ...
        if (this.mustUpdate = null, this.value.update)
          try {
            ...
            if (Nt(e.state, i, "CodeMirror plugin crashed"), this.value.destroy)
              try {
                this.value.destroy();
              } catch {
              }
      ...
      try {
        ...
        Nt(t.state, e, "CodeMirror plugin crashed"), this.deactivate();
      }
    return this;
  }
  destroy(t) {
    ...
    if (!((e = this.value) === null || e === void 0) && e.destroy)
      try {
        ...
        Nt(t.state, i, "CodeMirror plugin crashed");
      }
  }
  deactivate() {
...
const ma = /* @__PURE__ */ M.define(), mr = /* @__PURE__ */ M.define(), Mi = /* @__PURE__ */ M.define(), wa = /* @__PURE__ */ M.define(), wr = /* @__PURE__ */ M.define(), ya = /* @__PURE__ */ M.define();
function Zr(n, t) {
  let e = n.state.facet(ya);
  if (!e.length)
    return e;
  ...
  return V.spans(i, t.from, t.to, {
    ...
    span(r, o, l, a) {
      ...
      for (let u = l.length - 1; u >= 0; u--, a--) {
        ...
        if (d == null && (d = Tc(t.text, h, f)), a > 0 && c.length && (p = c[c.length - 1]).to == h && p.direction == d)
          p.to = f, c = p.inner;
        else {
...
const ba = /* @__PURE__ */ M.define();
function yr(n) {
  let t = 0, e = 0, i = 0, s = 0;
  for (let r of n.state.facet(ba)) {
    let o = r(n);
...
class Dt {
  ...
  static extendWithRanges(t, e) {
    ...
    for (let s = 0, r = 0, o = 0, l = 0; ; s++) {
      let a = s == t.length ? null : t[s], h = o - l, f = a ? a.fromB : 1e9;
      for (; r < e.length && e[r] < f; ) {
        let c = e[r], u = e[r + 1], d = Math.max(l, c), p = Math.min(f, u);
        if (d <= p && new Dt(d + h, p + h, d, p).addToSet(i), u > f)
          break;
        r += 2;
      }
      if (!a)
...
class to extends _ {
  ...
  constructor(t) {
    super(), this.view = t, this.decorations = [], this.dynamicDecorationMap = [!1], this.domChanged = null, this.hasComposition = null, this.markedForComposition = /* @__PURE__ */ new Set(), this.editContextFormatting = L.none, this.lastCompositionAfterCursor = !1, this.minWidth = 0, this.minWidthFrom = 0, this.minWidthTo = 0, this.impreciseAnchor = null, this.impreciseHead = null, this.forceSelection = !1, this.lastUpdate = Date.now(), this.setDOM(t.contentDOM), this.children = [new Z()], this.children[0].setParent(this), this.updateDeco(), this.updateInner([new Dt(0, 0, 0, t.state.doc.length)], 0, null);
  }
  // Update the document view to a given state.
  update(t) {
    var e;
    let i = t.changedRanges;
    this.minWidth > 0 && i.length && (i.every(({ fromA: h, toA: f }) => f < this.minWidthFrom || h > this.minWidthTo) ? (this.minWidthFrom = t.changes.mapPos(this.minWidthFrom, 1), this.minWidthTo = t.changes.mapPos(this.minWidthTo, 1)) : this.minWidth = this.minWidthFrom = this.minWidthTo = 0), this.updateEditContextFormatting(t);
    let s = -1;
    this.view.inputState.composing >= 0 && !this.view.observer.editContext && (!((e = this.domChanged) === null || e === void 0) && e.newSel ? s = this.domChanged.newSel.head : !Vc(t.changes, this.hasComposition) && !t.selectionSet && (s = t.state.selection.main.head));
    let r = s > -1 ? Rc(this.view, t.changes, s) : null;
    if (this.domChanged = null, this.hasComposition) {
      this.markedForComposition.clear();
      let { from: h, to: f } = this.hasComposition;
      i = new Dt(h, f, t.changes.mapPos(h, -1), t.changes.mapPos(f, 1)).addToSet(i.slice());
    }
    ...
    let o = this.decorations, l = this.updateDeco(), a = Nc(o, l, t.changes);
    return i = Dt.extendWithRanges(i, a), !(this.flags & 7) && i.length == 0 ? !1 : (this.updateInner(i, t.startState.doc.length, r), t.transactions.length && (this.lastUpdate = Date.now()), !0);
  }
  ...
  updateInner(t, e, i) {
    ...
    if (this.view.viewport.from || this.view.viewport.to < this.view.state.doc.length)
      for (let o of this.children)
        o instanceof oe && o.widget instanceof Vn && r.push(o.dom);
    s.updateGaps(r);
  }
  updateChildren(t, e, i) {
    ...
    for (let o = s.length - 1; ; o--) {
      ...
      if (i && i.range.fromB < c && i.range.toB > f) {
        let C = ki.build(this.view.state.doc, f, i.range.fromB, this.decorations, this.dynamicDecorationMap), A = ki.build(this.view.state.doc, i.range.toB, c, this.decorations, this.dynamicDecorationMap);
        d = C.breakAtStart, p = C.openStart, m = A.openEnd;
        let T = this.compositionView(i);
        A.breakAtStart ? T.breakAfter = 1 : A.content.length && T.merge(T.length, T.length, A.content[0], !1, A.openStart, 0) && (T.breakAfter = A.content[0].breakAfter, A.content.shift()), C.content.length && T.merge(0, 0, C.content[C.content.length - 1], !0, 0, C.openEnd) && C.content.pop(), u = C.content.concat(T).concat(A.content);
      } else
        ({ content: u, breakAtStart: d, openStart: p, openEnd: m } = ki.build(this.view.state.doc, f, c, this.decorations, this.dynamicDecorationMap));
      let { i: g, off: w } = r.findPos(h, 1), { i: x, off: v } = r.findPos(a, -1);
      Ul(this, x, v, g, w, u, d, p, m);
    }
  ...
  updateEditContextFormatting(t) {
    ...
    for (let e of t.transactions)
      for (let i of e.effects)
        i.is(ga) && (this.editContextFormatting = i.value);
  }
  compositionView(t) {
    let e = new Ht(t.text.nodeValue);
    e.flags |= 8;
    for (let { deco: s } of t.marks)
      e = new ae(s, [e], e.length);
    let i = new Z();
  ...
  updateSelection(t = !1, e = !1) {
    ...
    let i = this.view.root.activeElement, s = i == this.dom, r = !s && !(this.view.state.facet(ie) || this.dom.tabIndex > -1) && hs(this.dom, this.view.observer.selectionRange) && !(i && this.dom.contains(i));
    if (!(s || e || r))
      return;
    ...
    if (S.gecko && l.empty && !this.hasComposition && Bc(a)) {
    ...
    (o || !f.focusNode || (!bi(a.node, a.offset, f.anchorNode, f.anchorOffset) || !bi(h.node, h.offset, f.focusNode, f.focusOffset)) && !this.suppressWidgetCursorChange(f, l)) && (this.view.observer.ignore(() => {
      S.android && S.chrome && this.dom.contains(f.focusNode) && Ic(f.focusNode, this.dom) && (this.dom.blur(), this.dom.focus({ preventScroll: !0 }));
      let c = Ci(this.view.root);
      if (c) if (l.empty) {
        if (S.gecko) {
          let u = Ec(a.node, a.offset);
          if (u && u != 3) {
            let d = (u == 1 ? ql : Kl)(a.node, a.offset);
  ...
  suppressWidgetCursorChange(t, e) {
    return this.hasComposition && e.empty && bi(t.focusNode, t.focusOffset, t.anchorNode, t.anchorOffset) && this.posFromDOM(t.focusNode, t.focusOffset) == e.head;
  }
  enforceCursorAssoc() {
    if (this.hasComposition)
      return;
    let { view: t } = this, e = t.state.selection.main, i = Ci(t.root), { anchorNode: s, anchorOffset: r } = t.observer.selectionRange;
  ...
  coordsAt(t, e) {
    ...
    for (let r = this.length, o = this.children.length - 1; o >= 0; o--) {
      ...
      if (a < t)
        break;
      if (h <= t && (h < t || l.covers(-1)) && (a > t || l.covers(1)) && (!i || l instanceof Z && !(i instanceof Z && e >= 0)))
        i = l, s = h;
      else if (i && h == t && a == t && l instanceof oe && Math.abs(e) < 2) {
  ...
  measureVisibleLineHeights(t) {
    let e = [], { from: i, to: s } = t, r = this.view.contentDOM.clientWidth, o = r > Math.max(this.view.scrollDOM.clientWidth, this.minWidth) + 1, l = -1, a = this.view.textDirection == J.LTR;
    for (let h = 0, f = 0; f < this.children.length; f++) {
      ...
      if (h >= i) {
        ...
        if (e.push(d.height), o) {
          ...
          if (m.length) {
            let g = m[m.length - 1], w = a ? g.right - d.left : d.right - g.left;
            w > l && (l = w, this.minWidth = r, this.minWidthFrom = h, this.minWidthTo = u);
          }
        }
      }
      h = u + c.breakAfter;
  ...
  updateDeco() {
    let t = 1, e = this.view.state.facet(Mi).map((r) => (this.dynamicDecorationMap[t++] = typeof r == "function") ? r(this.view) : r), i = !1, s = this.view.state.facet(wa).map((r, o) => {
  ...
  scrollIntoView(t) {
    ...
    for (let h of this.view.state.facet(pa))
      try {
        if (h(this.view, t.range, t))
          return !0;
      } catch (f) {
        Nt(this.view.state, f, "scroll handler");
      }
    ...
    let r = yr(this.view), o = {
      left: i.left - r.left,
      top: i.top - r.top,
      right: i.right + r.right,
      bottom: i.bottom + r.bottom
    }, { offsetWidth: l, offsetHeight: a } = this.view.scrollDOM;
    fc(this.view.scrollDOM, o, e.head < e.anchor ? -1 : 1, t.x, t.y, Math.max(Math.min(t.xMargin, l), -l), Math.max(Math.min(t.yMargin, a), -a), this.view.textDirection == J.LTR);
  }
}
function Bc(n) {
...
function ka(n, t) {
  ...
  if (!e.focusNode)
    return null;
  let i = ql(e.focusNode, e.focusOffset), s = Kl(e.focusNode, e.focusOffset), r = i || s;
  if (s && i && s.node != i.node) {
    let l = _.get(s.node);
    if (!l || l instanceof Ht && l.text != s.node.nodeValue)
      r = s;
    else if (n.docView.lastCompositionAfterCursor) {
      let a = _.get(i.node);
      !a || a instanceof Ht && a.text != i.node.nodeValue || (r = s);
    }
  }
...
function Rc(n, t, e) {
  ...
  if (/[\n\r]/.test(l) || n.state.doc.sliceString(i.from, i.to) != l)
    return null;
  let a = t.invertedDesc, h = new Dt(a.mapPos(r), a.mapPos(o), r, o), f = [];
  for (let c = s.parentNode; ; c = c.parentNode) {
    let u = _.get(c);
    if (u instanceof ae)
      f.push({ node: c, deco: u.mark });
    else {
      if (u instanceof Z || c.nodeName == "DIV" && c.parentNode == n.contentDOM)
        return { range: h, text: s, marks: f, line: c };
      if (c != n.contentDOM)
        f.push({ node: c, deco: new Ei({
          inclusive: !0,
          attributes: yc(c),
...
function Hc(n, t, e = 1) {
  ...
  let o = r, l = r;
  e < 0 ? o = pt(s.text, r, !1) : l = pt(s.text, r);
...
function _n(n, t, e) {
  ...
  for (let p = n.firstChild; p; p = p.nextSibling) {
    ...
    for (let g = 0; g < m.length; g++) {
      let w = m[g];
      s && en(s, w) && (w = eo(io(w, s.bottom), s.top));
      let x = Fc(t, w), v = $c(e, w);
      if (x == 0 && v == 0)
        return p.nodeType == 3 ? so(p, t, e) : _n(p, t, e);
      if (!i || o > v || o == v && r > x) {
        i = p, s = w, r = x, o = v;
        let C = v ? e < w.top ? -1 : 1 : x ? t < w.left ? -1 : 1 : 0;
        l = !C || (C > 0 ? g < m.length - 1 : g > 0);
      }
      x == 0 ? e > w.bottom && (!f || f.bottom < w.bottom) ? (a = p, f = w) : e < w.top && (!c || c.top > w.top) && (h = p, c = w) : f && en(f, w) ? f = io(f, w.bottom) : c && en(c, w) && (c = eo(c, w.top));
    }
  }
  if (f && f.bottom >= e ? (i = a, s = f) : c && c.top <= e && (i = h, s = c), !i)
  ...
  for (let l = 0; l < i; l++) {
    ...
    for (let h = 0; h < a.length; h++) {
      ...
      if (f.left - 1 <= t && f.right + 1 >= t && c < r) {
        ...
        if ((S.chrome || S.gecko) && Ve(n, l).getBoundingClientRect().left == f.right && (d = !u), c <= 0)
...
function xa(n, t, e, i = -1) {
  var s, r;
  let o = n.contentDOM.getBoundingClientRect(), l = o.top + n.viewState.paddingTop, a, { docHeight: h } = n.viewState, { x: f, y: c } = t, u = c - l;
  if (u < 0)
    return 0;
  if (u > h)
    return n.state.doc.length;
  for (let C = n.viewState.heightOracle.textHeight / 2, A = !1; a = n.elementAtHeight(u), a.type != Tt.Text; )
    for (; u = i > 0 ? a.bottom + C : a.top - C, !(u >= 0 && u <= h); ) {
      if (A)
        return e ? null : 0;
      A = !0, i = -i;
    }
  ...
  if (d < n.viewport.from)
    return n.viewport.from == 0 ? 0 : e ? null : no(n, o, a, f, c);
  if (d > n.viewport.to)
    return n.viewport.to == n.state.doc.length ? n.state.doc.length : e ? null : no(n, o, a, f, c);
  ...
  if (g && ((s = n.docView.nearest(g)) === null || s === void 0 ? void 0 : s.isEditable) != !1) {
    if (p.caretPositionFromPoint) {
      let C = p.caretPositionFromPoint(f, c);
      C && ({ offsetNode: w, offset: x } = C);
    } else if (p.caretRangeFromPoint) {
      let C = p.caretRangeFromPoint(f, c);
      C && ({ startContainer: w, startOffset: x } = C, (!n.contentDOM.contains(w) || S.safari && zc(w, x, f) || S.chrome && _c(w, x, f)) && (w = void 0));
    }
    w && (x = Math.min(Jt(w), x));
  }
  if (!w || !n.docView.dom.contains(w)) {
    let C = Z.find(n.docView, d);
    if (!C)
      return u > a.top + a.height / 2 ? a.to : a.from;
    ({ node: w, offset: x } = _n(C.dom, f, c));
  }
  ...
  if (v.isWidget && ((r = v.dom) === null || r === void 0 ? void 0 : r.nodeType) == 1) {
    ...
    return t.y < C.top || t.y <= C.bottom && t.x <= (C.left + C.right) / 2 ? v.posAtStart : v.posAtEnd;
  } else
    return v.localPosFromDOM(w, x) + v.posAtStart;
}
function no(n, t, e, i, s) {
  ...
  return e.from + nc(o, r, n.state.tabSize);
}
function zc(n, t, e) {
  let i;
...
function Wc(n, t) {
  ...
  if (Array.isArray(e.type)) {
    for (let i of e.type)
      if (i.to > t || i.to == t && (i.to == e.to || i.type == Tt.Text))
        return i;
  }
  return e;
}
function jc(n, t, e, i) {
  let s = Wc(n, t.head), r = !i || s.type != Tt.Text || !(n.lineWrapping || s.widgetLineBreaks) ? null : n.coordsAtPos(t.assoc < 0 && t.head > s.from ? t.head - 1 : t.head);
  if (r) {
...
function Kc(n, t, e, i) {
  ...
  let o = t.goalColumn, l, a = n.contentDOM.getBoundingClientRect(), h = n.coordsAtPos(s, t.assoc || -1), f = n.documentTop;
  if (h)
  ...
  for (let d = 0; ; d += 10) {
    let p = l + (u + d) * r, m = xa(n, { x: c, y: p }, !1, r);
    if (p < a.top || p > a.bottom || (r < 0 ? m < s : m > s)) {
      let g = n.docView.coordsForChar(m), w = !g || p < g.top ? -1 : 1;
      return b.cursor(m, w, void 0, o);
    }
  }
}
function cs(n, t, e) {
...
function sn(n, t, e) {
  let i = cs(n.state.facet(wr).map((s) => s(n)), e.from, t.head > e.from ? -1 : 1);
...
class Gc {
  ...
  readRange(t, e) {
    ...
    for (let s = t; ; ) {
      ...
      (l && a ? l.breakAfter : (l ? l.breakAfter : vs(s)) || vs(o) && (s.nodeName != "BR" || s.cmIgnore) && this.text.length > r) && this.lineBreak(), s = o;
    }
  ...
  readNode(t) {
    if (t.cmIgnore)
      return;
    let e = _.get(t), i = e && e.overrideDOMText;
    if (i != null) {
  ...
  findPointInside(t, e) {
    for (let i of this.points)
      (t.nodeType == 3 ? i.node == t : t.contains(i.node)) && (i.pos = this.text.length + (Uc(t, i.node, i.offset) ? e : 0));
  }
}
function Uc(n, t, e) {
  for (; ; ) {
...
class Qc {
  constructor(t, e, i, s) {
    ...
    if (t.state.readOnly && e > -1)
      ...
      let l = r || o ? [] : Jc(t), a = new Gc(l, t.state);
      a.readRange(this.bounds.startDOM, this.bounds.endDOM), this.text = a.text, this.newSel = Zc(l, this.bounds.from);
    } else {
      let l = t.observer.selectionRange, a = r && r.node == l.focusNode && r.offset == l.focusOffset || !Bn(t.contentDOM, l.focusNode) ? t.state.selection.main.head : t.docView.posFromDOM(l.focusNode, l.focusOffset), h = o && o.node == l.anchorNode && o.offset == l.anchorOffset || !Bn(t.contentDOM, l.anchorNode) ? t.state.selection.main.anchor : t.docView.posFromDOM(l.anchorNode, l.anchorOffset), f = t.viewport;
      if ((S.ios || S.chrome) && t.state.selection.main.empty && a != h && (f.from > 0 || f.to < t.state.doc.length)) {
...
function va(n, t) {
  ...
  if (t.bounds) {
    ...
    (r === 8 || S.android && t.text.length < l - o) && (a = s.to, h = "end");
    let f = Xc(n.state.doc.sliceString(o, l, gi), t.text, a - o, h);
    f && (S.chrome && r == 13 && f.toB == f.from + 2 && t.text.slice(f.from, f.toB) == gi + gi && f.toB--, e = {
      from: o + f.from,
      to: o + f.toA,
      insert: I.of(t.text.slice(f.from, f.toB).split(gi))
    });
  } else i && (!n.hasFocus && n.state.facet(ie) || i.main.eq(s)) && (i = null);
  if (!e && !i)
    return !1;
  if (!e && t.typeOver && !s.empty && i && i.main.empty ? e = { from: s.from, to: s.to, insert: n.state.doc.slice(s.from, s.to) } : (S.mac || S.android) && e && e.from == e.to && e.from == s.head - 1 && /^\. ?$/.test(e.insert.toString()) && n.contentDOM.getAttribute("autocorrect") == "off" ? (i && e.insert.length == 2 && (i = b.single(i.main.anchor - 1, i.main.head - 1)), e = { from: e.from, to: e.to, insert: I.of([e.insert.toString().replace(".", " ")]) }) : e && e.from >= s.from && e.to <= s.to && (e.from != s.from || e.to != s.to) && s.to - s.from - (e.to - e.from) <= 4 ? e = {
    from: s.from,
    to: s.to,
    insert: n.state.doc.slice(s.from, e.from).append(e.insert).append(n.state.doc.slice(e.to, s.to))
  } : S.chrome && e && e.from == e.to && e.from == s.head && e.insert.toString() == `
 ` && n.lineWrapping && (i && (i = b.single(i.main.anchor - 1, i.main.head - 1)), e = { from: s.from, to: s.to, insert: I.of([" "]) }), e)
    return br(n, e, i, r);
  if (i && !i.main.eq(s)) {
    let o = !1, l = "select";
...
function br(n, t, e, i = -1) {
  ...
  let o, l = () => o || (o = Yc(n, t, e));
  return n.state.facet(ca).some((a) => a(n, t.from, t.to, r, l)) || n.dispatch(l()), !0;
}
function Yc(n, t, e) {
  ...
  if (t.from >= r.from && t.to <= r.to && t.to - t.from >= (r.to - r.from) / 3 && (!e || e.main.empty && e.main.from == t.from + t.insert.length) && n.inputState.composing < 0) {
    ...
    if (s.selection.ranges.length > 1 && n.inputState.composing >= 0 && t.to <= r.to && t.to >= r.to - 10) {
      let h = n.state.sliceDoc(t.from, t.to), f, c = e && ka(n, e.main.head);
      if (c) {
      ...
      i = s.changeByRange((p) => {
        ...
        p.to >= f.from && p.from <= f.to)
          return { range: p };
        let w = s.changes({ from: g, to: m, insert: t.insert }), x = p.to - r.to;
        return {
          changes: w,
          range: a ? b.range(Math.max(0, a.anchor + x), Math.max(0, a.head + x)) : p.map(w)
        };
      });
    } else
      i = {
...
class tu {
  ...
  ensureHandlers(t) {
    let e = eu(t), i = this.handlers, s = this.view.contentDOM;
    for (let r in e)
      if (r != "scroll") {
  ...
  keydown(t) {
    if (this.lastKeyCode = t.keyCode, this.lastKeyTime = Date.now(), t.keyCode == 9 && this.tabFocusMode > -1 && (!this.tabFocusMode || Date.now() <= this.tabFocusMode))
      return !0;
    if (this.tabFocusMode > 0 && t.keyCode != 27 && Ca.indexOf(t.keyCode) < 0 && (this.tabFocusMode = -1), S.android && S.chrome && !t.synthetic && (t.keyCode == 13 || t.keyCode == 8))
      return this.view.observer.delayAndroidKey(t.key, t.keyCode), !0;
    let e;
    return S.ios && !t.synthetic && !t.altKey && !t.metaKey && ((e = Sa.find((i) => i.keyCode == t.keyCode)) && !t.ctrlKey || iu.indexOf(t.key) > -1 && t.ctrlKey && !t.shiftKey) ? (this.pendingIOSKey = e || t, setTimeout(() => this.flushIOSKey(), 250), !0) : (t.keyCode != 229 && this.view.observer.forceFlush(), !1);
  }
  flushIOSKey(t) {
  ...
  for (let i of n) {
    ...
    if (s && s.domEventHandlers)
      for (let r in s.domEventHandlers) {
        ...
        o && e(r).handlers.push(lo(i.value, o));
      }
    if (s && s.domEventObservers)
      for (let r in s.domEventObservers) {
        let o = s.domEventObservers[r];
        o && e(r).observers.push(lo(i.value, o));
      }
  }
  for (let i in Ft)
    e(i).handlers.push(Ft[i]);
  for (let i in Et)
...
], iu = "dthko", Ca = [16, 17, 18, 20, 91, 92, 224, 225], qi = 6;
function Ki(n) {
...
class nu {
  constructor(t, e, i, s) {
    this.view = t, this.startEvent = e, this.style = i, this.mustSelect = s, this.scrollSpeed = { x: 0, y: 0 }, this.scrolling = -1, this.lastEvent = e, this.scrollParents = cc(t.contentDOM), this.atoms = t.state.facet(wr).map((o) => o(t));
    let r = t.contentDOM.ownerDocument;
    r.addEventListener("mousemove", this.move = this.move.bind(this)), r.addEventListener("mouseup", this.up = this.up.bind(this)), this.extend = e.shiftKey, this.multiple = t.state.facet(F.allowMultipleSelections) && ru(t, e), this.dragging = lu(t, e) && Oa(e) == 1 ? null : !1;
  }
  start(t) {
  ...
  move(t) {
    if (t.buttons == 0)
      return this.destroy();
    if (this.dragging || this.dragging == null && su(this.startEvent, t) < 10)
      return;
    ...
    let a = yr(this.view);
    t.clientX - a.left <= s + qi ? e = -Ki(s - t.clientX) : t.clientX + a.right >= o - qi && (e = Ki(t.clientX - o)), t.clientY - a.top <= r + qi ? i = -Ki(r - t.clientY) : t.clientY + a.bottom >= l - qi && (i = Ki(t.clientY - l)), this.setScrollSpeed(e, i);
  }
  up(t) {
  ...
  skipAtoms(t) {
    ...
    for (let i = 0; i < t.ranges.length; i++) {
      ...
      if (s.empty) {
        let o = cs(this.atoms, s.from, 0);
        o != s.from && (r = b.cursor(o, -1));
      } else {
        let o = cs(this.atoms, s.from, -1), l = cs(this.atoms, s.to, 1);
...
function au(n, t) {
  ...
  for (let e = t.target, i; e != n.contentDOM; e = e.parentNode)
    if (!e || e.nodeType == 11 || (i = _.get(e)) && i.ignoreEvent(t))
      return !1;
  return !0;
}
const Ft = /* @__PURE__ */ Object.create(null), Et = /* @__PURE__ */ Object.create(null), Aa = S.ie && S.ie_version < 15 || S.ios && S.webkit_version < 604;
function hu(n) {
...
function Ma(n, t) {
  ...
  if (Wn != null && e.selection.ranges.every((a) => a.empty) && Wn == r.toString()) {
    let a = -1;
    i = e.changeByRange((h) => {
...
Ft.keydown = (n, t) => (n.inputState.setSelectionOrigin("select"), t.keyCode == 27 && n.inputState.tabFocusMode != 0 && (n.inputState.tabFocusMode = Date.now() + 2e3), !1);
Et.touchstart = (n, t) => {
...
Ft.mousedown = (n, t) => {
  if (n.observer.flush(), n.inputState.lastTouchTime > Date.now() - 2e3)
    return !1;
  let e = null;
  for (let i of n.state.facet(ha))
    if (e = i(n, t), e)
      break;
  if (!e && t.button == 0 && (e = uu(n, t)), e) {
    let i = !n.hasFocus;
    n.inputState.startMouseSelection(new nu(n, t, e, i)), i && n.observer.ignore(() => {
      _l(n.contentDOM);
...
let ho = (n, t, e) => t >= e.top && t <= e.bottom && n >= e.left && n <= e.right;
function fu(n, t, e, i) {
  ...
  return l && ho(e, i, l) ? 1 : o && o.bottom >= i ? -1 : 1;
}
function fo(n, t) {
  let e = n.posAtCoords({ x: t.clientX, y: t.clientY }, !1);
  return { pos: e, bias: fu(n, e, t.clientX, t.clientY) };
}
const cu = S.ie && S.ie_version <= 11;
let co = null, uo = 0, po = 0;
function Oa(n) {
  if (!cu)
    return n.detail;
  let t = co, e = po;
  return co = n, po = Date.now(), uo = !t || e > Date.now() - 400 && Math.abs(t.clientX - n.clientX) < 2 && Math.abs(t.clientY - n.clientY) < 2 ? (uo + 1) % 3 : 1;
}
function uu(n, t) {
  let e = fo(n, t), i = Oa(t), s = n.state.selection;
  return {
    update(r) {
      r.docChanged && (e.pos = r.changes.mapPos(e.pos), s = s.map(r.changes));
    },
    get(r, o, l) {
      let a = fo(n, r), h, f = ao(n, a.pos, a.bias, i);
      if (e.pos != a.pos && !o) {
        let c = ao(n, e.pos, e.bias, i), u = Math.min(c.from, f.from), d = Math.max(c.to, f.to);
        f = u < f.from ? b.range(u, d) : b.range(d, u);
      }
      return o ? s.replaceRange(s.main.extend(f.from, f.to)) : l && i == 1 && s.ranges.length > 1 && (h = du(s, a.pos)) ? h : l ? s.addRange(f) : b.create([f]);
    }
  };
}
function du(n, t) {
...
Ft.dragstart = (n, t) => {
  ...
  let { inputState: i } = n;
  return i.mouseSelection && (i.mouseSelection.dragging = !0), i.draggedContent = e, t.dataTransfer && (t.dataTransfer.setData("Text", Ws(n.state, gr, n.state.sliceDoc(e.from, e.to))), t.dataTransfer.effectAllowed = "copyMove"), !1;
};
Ft.dragend = (n) => (n.inputState.draggedContent = null, !1);
function go(n, t, e, i) {
  if (e = Ws(n.state, pr, e), !e)
    return;
  let s = n.posAtCoords({ x: t.clientX, y: t.clientY }, !1), { draggedContent: r } = n.inputState, o = i && r && ou(n, t) ? { from: r.from, to: r.to } : null, l = { from: s, insert: e }, a = n.state.changes(o ? [o, l] : l);
  n.focus(), n.dispatch({
    changes: a,
...
Ft.drop = (n, t) => {
  ...
  if (e && e.length) {
    let i = Array(e.length), s = 0, r = () => {
      ++s == e.length && go(n, t, i.filter((o) => o != null).join(n.state.lineBreak), !1);
    };
...
Ft.paste = (n, t) => {
  if (n.state.readOnly)
    return !0;
  n.observer.flush();
  let e = Aa ? null : t.clipboardData;
  return e ? (Ma(n, e.getData("text/plain") || e.getData("text/uri-list")), !0) : (hu(n), !1);
};
function pu(n, t) {
...
function gu(n) {
  ...
  return { text: Ws(n, gr, t.join(n.lineBreak)), ranges: e, linewise: i };
}
let Wn = null;
Ft.copy = Ft.cut = (n, t) => {
  let { text: e, ranges: i, linewise: s } = gu(n.state);
  if (!e && !s)
    return !1;
  Wn = s ? e : null, t.type == "cut" && !n.state.readOnly && n.dispatch({
    changes: i,
    scrollIntoView: !0,
    userEvent: "delete.cut"
  });
  let r = Aa ? null : t.clipboardData;
  return r ? (r.clearData(), r.setData("text/plain", e), !0) : (pu(n, e), !1);
};
const Ta = /* @__PURE__ */ ni.define();
function Da(n, t) {
  let e = [];
  ...
  return e ? n.update({ effects: e, annotations: Ta.of(!0) }) : null;
}
function Pa(n) {
  setTimeout(() => {
    let t = n.hasFocus;
...
Et.focus = (n) => {
  n.inputState.lastFocusTime = Date.now(), !n.scrollDOM.scrollTop && (n.inputState.lastScrollTop || n.inputState.lastScrollLeft) && (n.scrollDOM.scrollTop = n.inputState.lastScrollTop, n.scrollDOM.scrollLeft = n.inputState.lastScrollLeft), Pa(n);
};
Et.blur = (n) => {
  n.observer.clearSelectionRange(), Pa(n);
};
...
Ft.beforeinput = (n, t) => {
  ...
  if (t.inputType == "insertReplacementText" && n.observer.editContext) {
    ...
    if (r && o.length) {
      ...
      return br(n, { from: a, to: h, insert: n.state.toText(r) }, null), !0;
    }
  }
  let s;
  if (S.chrome && S.android && (s = Sa.find((r) => r.inputType == t.inputType)) && (n.observer.delayAndroidKey(s.key, s.keyCode), s.key == "Backspace" || s.key == "Delete")) {
  ...
  return S.ios && t.inputType == "deleteContentForward" && n.observer.flushSoon(), S.safari && t.inputType == "insertText" && n.inputState.composing >= 0 && setTimeout(() => Et.compositionend(n, t), 20), !1;
};
const mo = /* @__PURE__ */ new Set();
function mu(n) {
  mo.has(n) || (mo.add(n), n.addEventListener("copy", () => {
...
class wu {
  ...
  mustRefreshForWrapping(t) {
    return wo.indexOf(t) > -1 != this.lineWrapping;
  }
  ...
  refresh(t, e, i, s, r, o) {
    let l = wo.indexOf(t) > -1, a = Math.round(e) != Math.round(this.lineHeight) || this.lineWrapping != l;
...
class Qt {
  ...
  */
  get widget() {
    return this._content instanceof ve ? this._content.widget : null;
  }
  /**
...
class mt {
  ...
  setHeight(t) {
    this.height != t && (Math.abs(this.height - t) > us && (ei = !0), this.height = t);
  }
  ...
  applyChanges(t, e, i, s) {
    ...
    for (let l = s.length - 1; l >= 0; l--) {
      let { fromA: a, toA: h, fromB: f, toB: c } = s[l], u = r.lineAt(a, j.ByPosNoHeight, i.setDoc(e), 0, 0), d = u.to >= h ? u : r.lineAt(h, j.ByPosNoHeight, i, 0, 0);
      for (c += d.to - h, h = d.to; l > 0 && u.from <= s[l - 1].toA; )
        a = s[l - 1].fromA, f = s[l - 1].fromB, l--, a < u.from && (u = r.lineAt(a, j.ByPosNoHeight, i, 0, 0));
      f += u.from - a, a = u.from;
      let p = kr.build(i.setDoc(o), t, f, c);
      r = As(r, r.replace(a, h, p));
    }
  ...
  static of(t) {
    ...
    let o = 0;
    return t[e - 1] == null ? (o = 1, e--) : t[e] == null && (o = 1, i++), new bu(mt.of(t.slice(0, e)), o, mt.of(t.slice(i)));
  }
}
function As(n, t) {
  return n == t ? n : (n.constructor != t.constructor && (ei = !0), t);
}
mt.prototype.size = 1;
class Ba extends mt {
  constructor(t, e, i) {
...
class vt extends Ba {
  ...
  replace(t, e, i) {
    let s = i[0];
    return i.length == 1 && (s instanceof vt || s instanceof ot && s.flags & 4) && Math.abs(this.length - s.length) < 10 ? (s instanceof ot ? s = new vt(s.length, this.height) : s.height = this.height, this.outdated || (s.outdated = !1), s) : mt.of(i);
  }
  updateHeight(t, e = 0, i = !1, s) {
...
class ot extends mt {
  ...
  lineAt(t, e, i, s, r) {
    ...
    return new Qt(h.from, h.length, Math.max(s, Math.min(u, s + this.height - f)), f, 0);
  }
  forEachLine(t, e, i, s, r, o) {
    ...
    for (let f = t, c = s; f <= e; ) {
      ...
      let d = a + h * u.length;
      o(new Qt(u.from, u.length, c, d, 0)), c += d, f = u.to + 1;
    }
  }
  replace(t, e, i) {
    let s = this.length - e;
  ...
  updateHeight(t, e = 0, i = !1, s) {
    ...
    if (s && s.from <= e + this.length && s.more) {
      ...
      for (s.from > e && o.push(new ot(s.from - e - 1).updateHeight(t, e)); l <= r && s.more; ) {
        ...
        a == -1 ? a = c : Math.abs(c - a) >= us && (a = -2);
        let u = new vt(f, c);
        u.outdated = !1, o.push(u), l += f + 1;
      }
      l <= r && o.push(null, new ot(r - l).updateHeight(t, l));
      let h = mt.of(o);
      return (a < 0 || Math.abs(h.height - this.height) >= us || Math.abs(a - this.heightMetrics(t, e).perLine) >= us) && (ei = !0), As(this, h);
...
class bu extends mt {
  ...
  lineAt(t, e, i, s, r) {
    let o = s + this.left.height, l = r + this.left.length + this.break, a = e == j.ByHeight ? t < o : t < l, h = a ? this.left.lineAt(t, e, i, s, r) : this.right.lineAt(t, e, i, o, l);
    if (this.break || (a ? h.to < l : h.from > l))
      return h;
    let f = e == j.ByPosNoHeight ? j.ByPosNoHeight : j.ByPos;
  ...
  balanced(t, e) {
    return t.size > 2 * e.size || e.size > 2 * t.size ? mt.of(this.break ? [t, null, e] : [t, e]) : (this.left = As(this.left, t), this.right = As(this.right, e), this.setHeight(t.height + e.height), this.outdated = t.outdated || e.outdated, this.size = t.size + e.size, this.length = t.length + this.break + e.length, this);
  }
  updateHeight(t, e = 0, i = !1, s) {
...
class kr {
  ...
  span(t, e) {
    if (this.lineStart > -1) {
      ...
      s instanceof vt ? s.length += i - this.pos : (i > this.pos || !this.isCovered) && this.nodes.push(new vt(i - this.pos, -1)), this.writtenTo = i, e > i && (this.nodes.push(null), this.writtenTo++, this.lineStart = -1);
    }
    this.pos = e;
  }
  point(t, e, i) {
    if (t < e || i.heightRelevant) {
      ...
      let o = e - t;
      i.block ? this.addBlock(new Ba(o, s, i)) : (o || r || s >= ku) && this.addLineDeco(s, r, o);
  ...
  enterLine() {
    ...
    this.lineStart = t, this.lineEnd = e, this.writtenTo < t && ((this.writtenTo < t - 1 || this.nodes[this.nodes.length - 1] == null) && this.nodes.push(this.blankContent(this.writtenTo, t - 1)), this.nodes.push(null)), this.pos > t && this.nodes.push(new vt(this.pos - t, -1)), this.writtenTo = this.pos;
  }
  blankContent(t, e) {
    let i = new ot(e - t);
  ...
  finish(t) {
    ...
    this.lineStart > -1 && !(e instanceof vt) && !this.isCovered ? this.nodes.push(new vt(0, -1)) : (this.writtenTo < this.pos || e == null) && this.nodes.push(this.blankContent(this.writtenTo, this.pos));
    let i = t;
  ...
  static build(t, e, i, s) {
    let r = new kr(i, t);
    return V.spans(e, i, s, r, 0), r.finish(i);
  }
}
function xu(n, t, e) {
  let i = new vu();
...
class vu {
  ...
  comparePoint(t, e, i, s) {
    (t < e || i && i.heightRelevant || s && s.heightRelevant) && fs(t, e, this.changes, 5);
  }
}
function Su(n, t) {
...
class nn {
  ...
  draw(t, e) {
    return L.replace({
      widget: new Mu(this.displaySize * (e ? t.scaleY : t.scaleX), e)
...
class ko {
  constructor(t) {
    this.state = t, this.pixelViewport = { left: 0, right: window.innerWidth, top: 0, bottom: 0 }, this.inView = !0, this.paddingTop = 0, this.paddingBottom = 0, this.contentDOMWidth = 0, this.contentDOMHeight = 0, this.editorHeight = 0, this.editorWidth = 0, this.scrollTop = 0, this.scrolledToBottom = !1, this.scaleX = 1, this.scaleY = 1, this.scrollAnchorPos = 0, this.scrollAnchorHeight = -1, this.scaler = xo, this.scrollTarget = null, this.printing = !1, this.mustMeasureContent = !0, this.defaultTextDirection = J.LTR, this.visibleRanges = [], this.mustEnforceCursorAssoc = !1;
    let e = t.facet(mr).some((i) => typeof i != "function" && i.class == "cm-lineWrapping");
    this.heightOracle = new wu(e), this.stateDeco = t.facet(Mi).filter((i) => typeof i != "function"), this.heightMap = mt.empty().applyChanges(this.stateDeco, I.empty, this.heightOracle.setDoc(t.doc), [new Dt(0, 0, 0, t.doc.length)]);
  ...
  updateScaler() {
    let t = this.scaler;
    return this.scaler = this.heightMap.height <= 7e6 ? xo : new xr(this.heightOracle, this.heightMap, this.viewports), t.eq(this.scaler) ? 0 : 2;
  }
  updateViewportLines() {
  ...
  update(t, e = null) {
    ...
    this.stateDeco = this.state.facet(Mi).filter((f) => typeof f != "function");
    let s = t.changedRanges, r = Dt.extendWithRanges(s, xu(i, this.stateDeco, t ? t.changes : it.empty(this.state.doc.length))), o = this.heightMap.height, l = this.scrolledToBottom ? null : this.scrollAnchorAt(this.scrollTop);
    yo(), this.heightMap = this.heightMap.applyChanges(this.stateDeco, t.startState.doc, this.heightOracle.setDoc(this.state.doc), r), (this.heightMap.height != o || ei) && (t.flags |= 2), l ? (this.scrollAnchorPos = t.changes.mapPos(l.from, -1), this.scrollAnchorHeight = l.top) : (this.scrollAnchorPos = -1, this.scrollAnchorHeight = this.heightMap.height);
  ...
  measure(t) {
    ...
    let h = 0, f = 0;
    if (l.width && l.height) {
      let { scaleX: C, scaleY: A } = zl(e, l);
      (C > 5e-3 && Math.abs(this.scaleX - C) > 5e-3 || A > 5e-3 && Math.abs(this.scaleY - A) > 5e-3) && (this.scaleX = C, this.scaleY = A, h |= 16, o = a = !0);
    }
    ...
    this.scrollTop != d && (this.scrollAnchorHeight = -1, this.scrollTop = d), this.scrolledToBottom = jl(t.scrollDOM);
    let p = (this.printing ? Au : Su)(e, this.paddingTop), m = p.top - this.pixelViewport.top, g = p.bottom - this.pixelViewport.bottom;
    this.pixelViewport = p;
    let w = this.pixelViewport.bottom > this.pixelViewport.top && this.pixelViewport.right > this.pixelViewport.left;
    if (w != this.inView && (this.inView = w, w && (a = !0)), !this.inView && !this.scrollTarget && !Cu(t.dom))
      return 0;
    let x = l.width;
    if ((this.contentDOMWidth != x || this.editorHeight != t.scrollDOM.clientHeight) && (this.contentDOMWidth = l.width, this.editorHeight = t.scrollDOM.clientHeight, h |= 16), a) {
      ...
      if (s.mustRefreshForHeights(C) && (o = !0), o || s.lineWrapping && Math.abs(x - this.contentDOMWidth) > s.charWidth) {
        let { lineHeight: A, charWidth: T, textHeight: O } = t.docView.measureTextSize();
        o = A > 0 && s.refresh(r, A, T, O, x / T, C), o && (t.docView.minWidth = 0, h |= 16);
      }
      m > 0 && g > 0 ? f = Math.max(m, g) : m < 0 && g < 0 && (f = Math.min(m, g)), yo();
      for (let A of this.viewports) {
        let T = A.from == this.viewport.from ? C : t.docView.measureVisibleLineHeights(A);
        this.heightMap = (o ? mt.empty().applyChanges(this.stateDeco, I.empty, this.heightOracle, [new Dt(0, 0, 0, t.state.doc.length)]) : this.heightMap).updateHeight(s, 0, o, new yu(A.from, T));
      }
      ei && (h |= 2);
    }
    ...
    return v && (h & 2 && (h |= this.updateScaler()), this.viewport = this.getViewport(f, this.scrollTarget), h |= this.updateForViewport()), (h & 2 || v) && this.updateViewportLines(), (this.lineGaps.length || this.viewport.to - this.viewport.from > 4e3) && this.updateLineGaps(this.ensureLineGaps(o ? [] : this.lineGaps, t)), h |= this.computeVisibleRanges(), this.mustEnforceCursorAssoc && (this.mustEnforceCursorAssoc = !1, t.docView.enforceCursorAssoc()), h;
  }
  get visibleTop() {
  ...
  getViewport(t, e) {
    let i = 0.5 - Math.max(-0.5, Math.min(0.5, t / 1e3 / 2)), s = this.heightMap, r = this.heightOracle, { visibleTop: o, visibleBottom: l } = this, a = new Gi(s.lineAt(o - i * 1e3, j.ByHeight, r, 0, 0).from, s.lineAt(l + (1 - i) * 1e3, j.ByHeight, r, 0, 0).to);
    if (e) {
      let { head: h } = e.range;
      if (h < a.from || h > a.to) {
        let f = Math.min(this.editorHeight, this.pixelViewport.bottom - this.pixelViewport.top), c = s.lineAt(h, j.ByPos, r, 0, 0), u;
        e.y == "center" ? u = (c.top + c.bottom) / 2 - f / 2 : e.y == "start" || e.y == "nearest" && h < a.from ? u = c.top : u = c.bottom - f, a = new Gi(s.lineAt(u - 1e3 / 2, j.ByHeight, r, 0, 0).from, s.lineAt(u + f + 1e3 / 2, j.ByHeight, r, 0, 0).to);
      }
    }
    return a;
  }
  mapViewport(t, e) {
    ...
    return new Gi(this.heightMap.lineAt(i, j.ByPos, this.heightOracle, 0, 0).from, this.heightMap.lineAt(s, j.ByPos, this.heightOracle, 0, 0).to);
  }
  ...
  mapLineGaps(t, e) {
    ...
    let i = [];
    for (let s of t)
      e.touchesRange(s.from, s.to) || i.push(new nn(e.mapPos(s.from), e.mapPos(s.to), s.size, s.displaySize));
    return i;
  }
  ...
  ensureLineGaps(t, e) {
    ...
    let l = [], a = (f, c, u, d) => {
      ...
      for (let w of m)
        if (w > f && w < c) {
          a(f, w - 10, u, d), a(w + 10, c, u, d);
          return;
        }
      let g = Tu(t, (w) => w.from >= u.from && w.to <= u.to && Math.abs(w.from - f) < r && Math.abs(w.to - c) < r && !m.some((x) => w.from < x && w.to > x));
      if (!g) {
        if (c < u.to && e && i && e.visibleRanges.some((v) => v.from <= c && v.to >= c)) {
          let v = e.moveToLineBoundary(b.cursor(c), !1, !0).head;
          v > f && (c = v);
        }
        let w = this.gapSize(u, f, c, d), x = i || w < 2e6 ? w : 2e6;
        g = new nn(f, c, w, x);
      }
      l.push(g);
    }, h = (f) => {
      if (f.length < o || f.type != Tt.Text)
        return;
      let c = Ou(f.from, f.to, this.stateDeco);
      if (c.total < o)
        return;
      let u = this.scrollTarget ? this.scrollTarget.range.head : null, d, p;
      if (i) {
        let m = s / this.heightOracle.lineLength * this.heightOracle.lineHeight, g, w;
        if (u != null) {
          let x = Qi(c, u), v = ((this.visibleBottom - this.visibleTop) / 2 + m) / f.height;
          g = x - v, w = x + v;
        } else
          g = (this.visibleTop - f.top - m) / f.height, w = (this.visibleBottom - f.top + m) / f.height;
        d = Ui(c, g), p = Ui(c, w);
      } else {
        let m = c.total * this.heightOracle.charWidth, g = s * this.heightOracle.charWidth, w = 0;
        if (m > 2e6)
          for (let T of t)
            T.from >= f.from && T.from < f.to && T.size != T.displaySize && T.from * this.heightOracle.charWidth + w < this.pixelViewport.left && (w = T.size - T.displaySize);
        let x = this.pixelViewport.left + w, v = this.pixelViewport.right + w, C, A;
        if (u != null) {
          let T = Qi(c, u), O = ((v - x) / 2 + g) / m;
          C = T - O, A = T + O;
        } else
          C = (x - g) / m, A = (v + g) / m;
        d = Ui(c, C), p = Ui(c, A);
  ...
  updateLineGaps(t) {
    nn.same(t, this.lineGaps) || (this.lineGaps = t, this.lineGapDeco = L.set(t.map((e) => e.draw(this, this.heightOracle.lineWrapping))));
  }
  ...
  lineBlockAt(t) {
    return t >= this.viewport.from && t <= this.viewport.to && this.viewportLines.find((e) => e.from <= t && e.to >= t) || mi(this.heightMap.lineAt(t, j.ByPos, this.heightOracle, 0, 0), this.scaler);
  }
  lineBlockAtHeight(t) {
    return t >= this.viewportLines[0].top && t <= this.viewportLines[this.viewportLines.length - 1].bottom && this.viewportLines.find((e) => e.top <= t && e.bottom >= t) || mi(this.heightMap.lineAt(this.scaler.fromDOM(t), j.ByHeight, this.heightOracle, 0, 0), this.scaler);
  }
  scrollAnchorAt(t) {
...
function Ui({ total: n, ranges: t }, e) {
  if (e <= 0)
    return t[0].from;
  if (e >= 1)
...
class xr {
  constructor(t, e, i) {
    ...
    this.viewports = i.map(({ from: l, to: a }) => {
      let h = e.lineAt(l, j.ByPos, t, 0, 0).top, f = e.lineAt(a, j.ByPos, t, 0, 0).bottom;
...
function mi(n, t) {
  ...
  return new Qt(n.from, n.length, e, i - e, Array.isArray(n._content) ? n._content.map((s) => mi(s, t)) : n._content);
}
const Yi = /* @__PURE__ */ M.define({ combine: (n) => n.join(" ") }), jn = /* @__PURE__ */ M.define({ combine: (n) => n.indexOf(!0) > -1 }), qn = /* @__PURE__ */ ke.newName(), Ra = /* @__PURE__ */ ke.newName(), Ea = /* @__PURE__ */ ke.newName(), La = { "&light": "." + Ra, "&dark": "." + Ea };
function Kn(n, t, e) {
  return new ke(t, {
    finish(i) {
...
}, rn = S.ie && S.ie_version <= 11;
class Bu {
  constructor(t) {
    this.view = t, this.active = !1, this.editContext = null, this.selectionRange = new uc(), this.selectionChanged = !1, this.delayedFlush = -1, this.resizeTimeout = -1, this.queue = [], this.delayedAndroidKey = null, this.flushingAndroidKey = -1, this.lastChange = 0, this.scrollTargets = [], this.intersection = null, this.resizeScroll = null, this.intersecting = !1, this.gapIntersection = null, this.gaps = [], this.printQuery = null, this.parentCheck = -1, this.dom = t.contentDOM, this.observer = new MutationObserver((e) => {
      for (let i of e)
        this.queue.push(i);
    ...
    !(S.chrome && S.chrome_version < 126) && (this.editContext = new Eu(t), t.state.facet(ie) && (t.contentDOM.editContext = this.editContext.editContext)), rn && (this.onCharData = (e) => {
      this.queue.push({
        target: e.target,
        type: "characterData",
  ...
  onSelectionChange(t) {
    ...
    if (i.state.facet(ie) ? i.root.activeElement != this.dom : !hs(this.dom, s))
      return;
  ...
  readSelectionRange() {
    let { view: t } = this, e = Ci(t.root);
    if (!e)
      return !1;
    let i = S.safari && t.root.nodeType == 11 && t.root.activeElement == this.dom && Ru(this.view, e) || e;
    if (!i || this.selectionRange.eq(i))
      return !1;
    let s = hs(this.dom, i);
    return s && !this.selectionChanged && t.inputState.lastFocusTime > Date.now() - 200 && t.inputState.lastTouchTime < Date.now() - 300 && pc(this.dom, i) ? (this.view.inputState.lastFocusTime = 0, t.docView.updateSelection(), !1) : (this.selectionRange.setRange(i), s && (this.selectionChanged = !0), !0);
  }
  ...
  start() {
    this.active || (this.observer.observe(this.dom, Pu), rn && this.dom.addEventListener("DOMCharacterDataModified", this.onCharData), this.active = !0);
  }
  stop() {
  ...
  readChange() {
    let { from: t, to: e, typeOver: i } = this.processRecords(), s = this.selectionChanged && hs(this.dom, this.selectionRange);
    if (t < 0 && !s)
      return null;
    t > -1 && (this.lastChange = Date.now()), this.view.inputState.lastFocusTime = 0, this.selectionChanged = !1;
    let r = new Qc(this.view, t, e, i);
  ...
  flush(t = !0) {
    ...
    let i = this.view.state, s = va(this.view, e);
...
function So(n, t) {
  ...
  return bi(o.node, o.offset, s, r) && ([e, i, s, r] = [s, r, e, i]), { anchorNode: e, anchorOffset: i, focusNode: s, focusOffset: r };
}
function Ru(n, t) {
...
class Eu {
  constructor(t) {
    ...
    this.handlers.textupdate = (i) => {
      ...
      let h = { from: l, to: a, insert: I.of(i.text.split(`
`)) };
      if (h.from == this.from && r < this.from ? h.from = r : h.to == this.to && r > this.to && (h.to = r), h.from == h.to && !h.insert.length) {
        ...
        f.main.eq(s) || t.dispatch({ selection: f, userEvent: "select" });
        return;
      }
      if ((S.mac || S.android) && h.from == o - 1 && /^\. ?$/.test(i.text) && t.contentDOM.getAttribute("autocorrect") == "off" && (h = { from: l, to: a, insert: I.of([i.text.replace(".", " ")]) }), this.pendingContextChange = h, !t.state.readOnly) {
        let f = this.to - this.from + (h.to - h.from + h.insert.length);
        br(t, h, b.single(this.toEditorPos(i.selectionStart, f), this.toEditorPos(i.selectionEnd, f)));
      }
      ...
      for (let r of i.getTextFormats()) {
        ...
        if (o != "None" && l != "None") {
          ...
          if (a < h) {
            ...
            s.push(L.mark({ attributes: { style: f } }).range(a, h));
          }
        }
      }
      t.dispatch({ effects: ga.of(L.set(s)) });
...
class D {
  ...
  */
  constructor(t = {}) {
    ...
    let { dispatch: i } = t;
    this.dispatchTransactions = t.dispatchTransactions || i && ((s) => s.forEach((r) => i(r, this))) || ((s) => this.update(s)), this.dispatch = this.dispatch.bind(this), this._root = t.root || dc(t.parent) || document, this.viewState = new ko(t.state || F.create(t)), t.scrollTo && t.scrollTo.is(ji) && (this.viewState.scrollTarget = t.scrollTo.value.clip(this.viewState.state)), this.plugins = this.state.facet(di).map((s) => new tn(s));
    for (let s of this.plugins)
      s.update(this);
    this.observer = new Bu(this), this.inputState = new tu(this), this.inputState.ensureHandlers(this.plugins), this.docView = new to(this), this.mountStyles(), this.updateAttrs(), this.updateState = 0, this.requestMeasure(), !((e = document.fonts) === null || e === void 0) && e.ready && document.fonts.ready.then(() => this.requestMeasure());
  }
  dispatch(...t) {
    let e = t.length == 1 && t[0] instanceof ut ? t : t.length == 1 && Array.isArray(t[0]) ? t[0] : [this.state.update(...t)];
  ...
  */
  update(t) {
    ...
    t.some((u) => u.annotation(Ta)) ? (this.inputState.notifiedFocused = o, l = 1) : o != this.inputState.notifiedFocused && (this.inputState.notifiedFocused = o, a = Da(r, o), a || (l = 1));
    ...
    s = Cs.create(this, r, t), s.flags |= l;
    ...
    try {
      ...
      for (let u of t) {
        if (c && (c = c.map(u.changes)), u.scrollIntoView) {
          ...
          c = new Ge(d.empty ? d : b.cursor(d.head, d.head > d.anchor ? -1 : 1));
        }
        for (let d of u.effects)
          d.is(ji) && (c = d.value.clip(this.state));
      }
      this.viewState.update(s, c), this.bidiCache = Ms.update(this.bidiCache, s.changes), s.empty || (this.updatePlugins(s), this.inputState.update(s)), e = this.docView.update(s), this.state.facet(pi) != this.styleModules && this.mountStyles(), i = this.updateAttrs(), this.showAnnouncements(t), this.docView.updateSelection(e, t.some((u) => u.isUserEvent("select.pointer")));
    } finally {
      this.updateState = 0;
    }
    if (s.startState.facet(Yi) != s.state.facet(Yi) && (this.viewState.mustMeasureContent = !0), (e || i || c || this.viewState.mustEnforceCursorAssoc || this.viewState.mustMeasureContent) && this.requestMeasure(), e && this.docViewUpdate(), !s.empty)
      for (let u of this.state.facet(zn))
        try {
          u(s);
        } catch (d) {
    ...
    (a || f) && Promise.resolve().then(() => {
      a && this.state == a.startState && this.dispatch(a), f && !va(this, f) && h.force && Ke(this.contentDOM, h.key, h.keyCode);
    });
  }
  /**
  ...
  setState(t) {
    ...
    try {
      for (let i of this.plugins)
        i.destroy(this);
      this.viewState = new ko(t), this.plugins = t.facet(di).map((i) => new tn(i)), this.pluginMap.clear();
      for (let i of this.plugins)
        i.update(this);
      this.docView.destroy(), this.docView = new to(this), this.inputState.ensureHandlers(this.plugins), this.mountStyles(), this.updateAttrs(), this.bidiCache = [];
    } finally {
      this.updateState = 0;
    }
  ...
  */
  measure(t = !0) {
      ...
      for (let l = 0; ; l++) {
        ...
        let f = h.map((d) => {
          try {
            ...
            return Nt(this.state, p), Co;
          }
        }), c = Cs.create(this, this.state, []), u = !1;
    ...
    if (e && !e.empty)
      for (let l of this.state.facet(zn))
        l(e);
  }
  /**
  ...
  */
  get themeClasses() {
    return qn + " " + (this.state.facet(jn) ? Ea : Ra) + " " + this.state.facet(Yi);
  }
  updateAttrs() {
    let t = Ao(this, ma, {
    ...
    this.state.readOnly && (e["aria-readonly"] = "true"), Ao(this, mr, e);
    let i = this.observer.ignore(() => {
      let s = In(this.contentDOM, this.contentAttrs, e), r = In(this.dom, this.editorAttrs, t);
      return s || r;
    });
  ...
  mountStyles() {
    ...
    ke.mount(this.root, this.styleModules.concat(Du).reverse(), t ? { nonce: t } : void 0);
  }
  readMeasured() {
  ...
  */
  moveByChar(t, e, i) {
    return sn(this, t, ro(this, t, e, i));
  }
  /**
  ...
  */
  moveByGroup(t, e) {
    return sn(this, t, ro(this, t, e, (i) => qc(this, t.head, i)));
  }
  /**
  ...
  */
  moveVertically(t, e, i) {
    return sn(this, t, Kc(this, t, e, i));
  }
  /**
  ...
  */
  ...
  posAtCoords(t, e = !0) {
    return this.readMeasured(), xa(this, t, e);
  }
  /**
  ...
  */
  coordsAtPos(t, e = 1) {
    ...
    if (!i || i.left == i.right)
      return i;
    let s = this.state.doc.lineAt(t), r = this.bidiSpans(s), o = r[ge.find(r, t - s.from, -1, e)];
    return zs(i, o.dir == J.LTR == e > 0);
  }
  /**
  ...
  */
  textDirectionAt(t) {
    return !this.state.facet(da) || t < this.viewport.from || t > this.viewport.to ? this.textDirection : (this.readMeasured(), this.docView.textDirectionAt(t));
  }
  /**
  ...
  */
  bidiSpans(t) {
    ...
    for (let r of this.bidiCache)
      if (r.from == t.from && r.dir == e && (r.fresh || na(r.isolates, i = Zr(this, t))))
        return r.order;
    i || (i = Zr(this, t));
    let s = Mc(t.text, e, i);
    return this.bidiCache.push(new Ms(t.from, t.to, e, i, !0, s)), s;
  }
  /**
  ...
  */
  focus() {
    this.observer.ignore(() => {
      _l(this.contentDOM), this.docView.updateSelection();
    });
  }
  /**
  ...
  */
  static scrollIntoView(t, e = {}) {
    return ji.of(new Ge(typeof t == "number" ? b.cursor(t) : t, e.y, e.x, e.yMargin, e.xMargin));
  }
  /**
  ...
  */
  scrollSnapshot() {
    ...
    return ji.of(new Ge(b.cursor(i.from), "start", "start", i.top - t, e, !0));
  }
  /**
  ...
  */
  static domEventHandlers(t) {
    return bt.define(() => ({}), { eventHandlers: t });
  }
  /**
  ...
  */
  static domEventObservers(t) {
    return bt.define(() => ({}), { eventObservers: t });
  }
  /**
  ...
  */
  static theme(t, e) {
    let i = ke.newName(), s = [Yi.of(i), pi.of(Kn(`.${i}`, t))];
    return e && e.dark && s.push(jn.of(!0)), s;
  }
  /**
  ...
  */
  static baseTheme(t) {
    return fr.lowest(pi.of(Kn("." + qn, t, La)));
  }
  /**
  ...
  */
  static findFromDOM(t) {
    var e;
    let i = t.querySelector(".cm-content"), s = i && _.get(i) || _.get(t);
    return ((e = s == null ? void 0 : s.rootView) === null || e === void 0 ? void 0 : e.view) || null;
  }
}
D.styleModule = pi;
D.inputHandler = ca;
D.clipboardInputFilter = pr;
D.clipboardOutputFilter = gr;
D.scrollHandler = pa;
D.focusChangeEffect = ua;
D.perLineTextDirection = da;
D.exceptionSink = fa;
D.updateListener = zn;
D.editable = ie;
D.mouseSelectionStyle = ha;
D.dragMovesSelection = aa;
D.clickAddsSelectionRange = la;
D.decorations = Mi;
D.outerDecorations = wa;
D.atomicRanges = wr;
D.bidiIsolatedRanges = ya;
D.scrollMargins = ba;
D.darkTheme = jn;
D.cspNonce = /* @__PURE__ */ M.define({ combine: (n) => n.length ? n[0] : "" });
D.contentAttributes = mr;
D.editorAttributes = ma;
D.lineWrapping = /* @__PURE__ */ D.contentAttributes.of({ class: "cm-lineWrapping" });
D.announce = /* @__PURE__ */ $.define();
const Lu = 4096, Co = {};
class Ms {
  constructor(t, e, i, s, r, o) {
  ...
  static update(t, e) {
    ...
    for (let r = Math.max(0, t.length - 10); r < t.length; r++) {
      let o = t[r];
      o.dir == s && !e.touchesRange(o.from, o.to) && i.push(new Ms(e.mapPos(o.from, 1), e.mapPos(o.to, -1), o.dir, o.isolates, !1, o.order));
    }
    return i;
  }
}
...
const Vu = /* @__PURE__ */ fr.default(/* @__PURE__ */ D.domEventHandlers({
  keydown(n, t) {
    return zu(Hu(t.state), n, t, "editor");
  }
})), Na = /* @__PURE__ */ M.define({ enables: Vu }), Mo = /* @__PURE__ */ new WeakMap();
function Hu(n) {
  let t = n.facet(Na), e = Mo.get(t);
  return e || Mo.set(t, e = $u(t.reduce((i, s) => i.concat(s), []))), e;
}
let ue = null;
const Fu = 4e3;
function $u(n, t = Nu) {
  let e = /* @__PURE__ */ Object.create(null), i = /* @__PURE__ */ Object.create(null), s = (o, l) => {
    ...
    var c, u;
    let d = e[o] || (e[o] = /* @__PURE__ */ Object.create(null)), p = l.split(/ (?!$)/).map((w) => Iu(w, t));
    for (let w = 1; w < p.length; w++) {
      let x = p.slice(0, w).join(" ");
      s(x, !0), d[x] || (d[x] = {
        preventDefault: !0,
        stopPropagation: !1,
        run: [(v) => {
          let C = ue = { view: v, prefix: x, scope: o };
          return setTimeout(() => {
            ue == C && (ue = null);
          }, Fu), !0;
        }]
...
function zu(n, t, e, i) {
  Gn = t;
  let s = ac(t), r = Ol(s, 0), o = qf(r) == s.length && s != " ", l = "", a = !1, h = !1, f = !1;
  ue && ue.view == e && ue.scope == i && (l = ue.prefix + " ", Ca.indexOf(t.keyCode) < 0 && (h = !0, ue = null));
  let c = /* @__PURE__ */ new Set(), u = (g) => {
    if (g) {
      for (let w of g.run)
        if (!c.has(w) && (c.add(w), w(e)))
          return g.stopPropagation && (f = !0), !0;
      g.preventDefault && (g.stopPropagation && (f = !0), h = !0);
    }
    return !1;
  }, d = n[i], p, m;
  return d && (u(d[l + Xi(s, t, !o)]) ? a = !0 : o && (t.altKey || t.metaKey || t.ctrlKey) && // Ctrl-Alt may be used for AltGr on Windows
  !(S.windows && t.ctrlKey && t.altKey) && (p = xe[t.keyCode]) && p != s ? (u(d[l + Xi(p, t, !0)]) || t.shiftKey && (m = Si[t.keyCode]) != s && m != p && u(d[l + Xi(m, t, !1)])) && (a = !0) : o && t.shiftKey && u(d[l + Xi(s, t, !0)]) && (a = !0), !a && u(d._any) && (a = !0)), h && (a = !0), a && f && t.stopPropagation(), Gn = null, a;
}
const _u = !(S.ios && S.webkit && S.webkit_version < 534), Oo = {
  ".cm-line": {},
  ".cm-content": {}
};
_u && (Oo[".cm-line"].caretColor = Oo[".cm-content"].caretColor = "transparent !important");
...
class ju {
  ...
  */
  createDeco(t) {
    let e = new be(), i = e.add.bind(e);
    for (let { from: s, to: r } of Wu(t, this.maxLength))
      To(t.state.doc, this.regexp, s, r, (o, l) => this.addMatch(l, t, o, i));
    return e.finish();
  }
  /**
    ...
    for (let r of t.visibleRanges) {
      ...
      if (l > o) {
        ...
        if (a == h)
          ...
          To(t.state.doc, this.regexp, f, c, (m, g) => this.addMatch(g, t, m, p));
        e = e.update({ filterFrom: f, filterTo: c, filter: (m, g) => m < f || g > c, add: u });
      }
    }
    return e;
  }
}
const Un = /x/.unicode != null ? "gu" : "g", qu = /* @__PURE__ */ new RegExp(`[\0-\b
--­؜​‎‏\u2028\u2029‭‮⁦⁧⁩\uFEFF￹-￼]`, Un), Ku = {
  0: "null",
  7: "bell",
  8: "backspace",
...
function Gu() {
  var n;
  if (on == null && typeof document < "u" && document.body) {
    let t = document.body.style;
    on = ((n = t.tabSize) !== null && n !== void 0 ? n : t.MozTabSize) != null;
  }
  return on || !1;
}
const ds = /* @__PURE__ */ M.define({
  combine(n) {
    let t = $s(n, {
      render: null,
      specialChars: qu,
    ...
    return (t.replaceTabs = !Gu()) && (t.specialChars = new RegExp("	|" + t.specialChars.source, Un)), t.addSpecialChars && (t.specialChars = new RegExp(t.specialChars.source + "|" + t.addSpecialChars.source, Un)), t;
  }
});
function Uu(n = {}) {
  return [ds.of(n), Qu()];
...
let Do = null;
function Qu() {
  return Do || (Do = bt.fromClass(class {
    constructor(n) {
      this.view = n, this.decorations = L.none, this.decorationCache = /* @__PURE__ */ Object.create(null), this.decorator = this.makeDecorator(n.state.facet(ds)), this.decorations = this.decorator.createDeco(n);
    }
    makeDecorator(n) {
      return new ju({
        regexp: n.specialChars,
        decoration: (t, e, i) => {
          let { doc: s } = e.state, r = Ol(t[0], 0);
          if (r == 9) {
            let o = s.lineAt(i), l = e.state.tabSize, a = Ri(o.text, l, i - o.from);
            return L.replace({
              widget: new Zu((l - a % l) * this.view.defaultCharacterWidth / this.view.scaleX)
            });
          }
          return this.decorationCache[r] || (this.decorationCache[r] = L.replace({ widget: new Ju(n, r) }));
        },
        boundary: n.replaceTabs ? void 0 : /[^]/
      });
    }
    update(n) {
      let t = n.state.facet(ds);
      n.startState.facet(ds) != t ? (this.decorator = this.makeDecorator(t), this.decorations = this.decorator.createDeco(n.view)) : this.decorations = this.decorator.updateDeco(n, this.decorations);
    }
  }, {
...
class Ju extends Me {
  ...
  toDOM(t) {
    let e = Xu(this.code), i = t.state.phrase("Control character") + " " + (Ku[this.code] || "0x" + this.code.toString(16)), s = this.options.render && this.options.render(this.code, i, e);
    if (s)
      return s;
...
const ed = /* @__PURE__ */ L.line({ class: "cm-activeLine" }), id = /* @__PURE__ */ bt.fromClass(class {
  constructor(n) {
  ...
  getDeco(n) {
    ...
    for (let i of n.state.selection.ranges) {
      ...
      s.from > t && (e.push(ed.range(s.from)), t = s.from);
    }
    return L.set(e);
  }
}, {
...
const ln = /* @__PURE__ */ M.define({
  combine: (n) => {
    ...
    return {
      ...
      tooltipSpace: ((i = n.find((s) => s.tooltipSpace)) === null || i === void 0 ? void 0 : i.tooltipSpace) || sd
    };
  }
}), Po = /* @__PURE__ */ new WeakMap(), Va = /* @__PURE__ */ bt.fromClass(class {
  constructor(n) {
    this.view = n, this.above = [], this.inView = !0, this.madeAbsolute = !1, this.lastTransaction = 0, this.measureTimeout = -1;
    let t = n.state.facet(ln);
    this.position = t.position, this.parent = t.parent, this.classes = n.themeClasses, this.createContainer(), this.measureReq = { read: this.readMeasure.bind(this), write: this.writeMeasure.bind(this), key: this }, this.resizeObserver = typeof ResizeObserver == "function" ? new ResizeObserver(() => this.measureSoon()) : null, this.manager = new Ia(n, Ha, (e, i) => this.createTooltip(e, i), (e) => {
  ...
  update(n) {
    ...
    let e = t || n.geometryChanged, i = n.state.facet(ln);
  ...
  readMeasure() {
    ...
    let i = this.view.scrollDOM.getBoundingClientRect(), s = yr(this.view);
    return {
      visible: {
        left: i.left + s.left,
        top: i.top + s.top,
  ...
  writeMeasure(n) {
    ...
    for (let l = 0; l < this.manager.tooltips.length; l++) {
      ...
      let d = a.arrow ? h.dom.querySelector(".cm-tooltip-arrow") : null, p = d ? 7 : 0, m = u.right - u.left, g = (t = Po.get(h)) !== null && t !== void 0 ? t : u.bottom - u.top, w = h.offset || rd, x = this.view.textDirection == J.LTR, v = u.width > i.right - i.left ? x ? i.left : i.right - u.width : x ? Math.max(i.left, Math.min(c.left - (d ? 14 : 0) + w.x, i.right - m)) : Math.min(Math.max(i.left, c.left - m + (d ? 14 : 0) - w.x), i.right - m), C = this.above[l];
      !a.strictSide && (C ? c.top - g - p - w.y < i.top : c.bottom + g + p + w.y > i.bottom) && C == i.bottom - c.bottom > c.top - i.top && (C = this.above[l] = !C);
      let A = (C ? c.top - i.top : i.bottom - c.bottom) - p;
      if (A < g && h.resize !== !1) {
        if (A < this.view.defaultLineHeight) {
          f.style.top = hi;
          continue;
        }
        Po.set(h, g), f.style.height = (g = A) / r + "px";
      } else f.style.height && (f.style.height = "");
      let T = C ? c.top - g - p - w.y : c.bottom + p + w.y, O = v + m;
      if (h.overlap !== !0)
        for (let H of o)
          H.left < O && H.right > v && H.top < T + g && H.bottom > T && (T = C ? H.top - g - 2 - p : H.bottom + p + 2);
      if (this.position == "absolute" ? (f.style.top = (T - n.parent.top) / r + "px", Bo(f, (v - n.parent.left) / s)) : (f.style.top = T / r + "px", Bo(f, v / s)), d) {
        let H = c.left + (x ? w.x : -w.x) - (v + 14 - 7);
        d.style.left = H / s + "px";
      }
      h.overlap !== !0 && o.push({ left: v, top: T, right: O, bottom: T + g }), f.classList.toggle("cm-tooltip-above", C), f.classList.toggle("cm-tooltip-below", !C), h.positioned && h.positioned(n.space);
    }
  }
  maybeMeasure() {
...
}), rd = { x: 0, y: 0 }, Ha = /* @__PURE__ */ M.define({
  enables: [Va, nd]
}), Os = /* @__PURE__ */ M.define({
...
class js {
  ...
  constructor(t) {
    this.view = t, this.mounted = !1, this.dom = document.createElement("div"), this.dom.classList.add("cm-tooltip-hover"), this.manager = new Ia(t, Os, (e, i) => this.createHostedView(e, i), (e) => e.dom.remove());
  }
...
const od = /* @__PURE__ */ Ha.compute([Os], (n) => {
  let t = n.facet(Os);
...
class ld {
  ...
  startHover() {
    ...
    if (i instanceof pe)
      ...
      if (!l || e.y < l.top || e.y > l.bottom || e.x < l.left - t.defaultCharacterWidth || e.x > l.right + t.defaultCharacterWidth)
        return;
      let a = t.bidiSpans(t.state.doc.lineAt(s)).find((f) => f.from <= s && f.to >= s), h = a && a.dir == J.RTL ? -1 : 1;
      r = e.x < l.left ? -h : h;
    }
    ...
    if (o != null && o.then) {
      ...
      }, (a) => Nt(t.state, a, "hover tooltip"));
    } else o && !(Array.isArray(o) && !o.length) && t.dispatch({ effects: this.setHover.of(Array.isArray(o) ? o : [o]) });
  }
  get tooltip() {
    let t = this.view.plugin(Va), e = t ? t.manager.tooltips.findIndex((i) => i.create == js.create) : -1;
  ...
  mousemove(t) {
    ...
    if (s.length && r && !ad(r.dom, t) || this.pending) {
      let { pos: o } = s[0] || this.pending, l = (i = (e = s[0]) === null || e === void 0 ? void 0 : e.end) !== null && i !== void 0 ? i : o;
      (o == l ? this.view.posAtCoords(this.lastMove) != o : !hd(this.view, o, l, t.clientX, t.clientY)) && (this.view.dispatch({ effects: this.setHover.of([]) }), this.pending = null);
    }
  }
  mouseleave(t) {
...
function ad(n, t) {
  ...
  return t.clientX >= e - Ji && t.clientX <= i + Ji && t.clientY >= s - Ji && t.clientY <= r + Ji;
}
function hd(n, t, e, i, s, r) {
  ...
  let e = $.define(), i = zt.define({
    ...
    update(s, r) {
      if (s.length && (t.hideOnChange && (r.docChanged || r.selection) ? s = [] : t.hideOn && (s = s.filter((o) => !t.hideOn(r, o))), r.docChanged)) {
        let o = [];
        for (let l of s) {
          let a = r.changes.mapPos(l.pos, -1, yt.TrackDel);
          if (a != null) {
...
const cd = /* @__PURE__ */ $.define(), Ro = /* @__PURE__ */ M.define({
  combine(n) {
    let t, e;
    for (let i of n)
...
const Fa = /* @__PURE__ */ bt.fromClass(class {
  constructor(n) {
    this.input = n.state.facet(Qn), this.specs = this.input.filter((e) => e), this.panels = this.specs.map((e) => e(n));
    let t = n.state.facet(Ro);
    this.top = new Zi(n, !0, t.topContainer), this.bottom = new Zi(n, !1, t.bottomContainer), this.top.sync(this.panels.filter((e) => e.top)), this.bottom.sync(this.panels.filter((e) => !e.top));
    for (let e of this.panels)
      e.dom.classList.add("cm-panel"), e.mount && e.mount();
  }
  update(n) {
    let t = n.state.facet(Ro);
    this.top.container != t.topContainer && (this.top.sync([]), this.top = new Zi(n.view, !0, t.topContainer)), this.bottom.container != t.bottomContainer && (this.bottom.sync([]), this.bottom = new Zi(n.view, !1, t.bottomContainer)), this.top.syncClasses(), this.bottom.syncClasses();
    let e = n.state.facet(Qn);
    if (e != this.input) {
...
const ps = /* @__PURE__ */ M.define(), dd = /* @__PURE__ */ M.define(), pd = {
  class: "",
  ...
  updateSpacer: null,
  domEventHandlers: {}
}, gs = /* @__PURE__ */ M.define();
function gd(n) {
  return [md(), gs.of(Object.assign(Object.assign({}, pd), n))];
}
const Lo = /* @__PURE__ */ M.define({
  combine: (n) => n.some((t) => t)
});
function md(n) {
  return [
...
const wd = /* @__PURE__ */ bt.fromClass(class {
  constructor(n) {
    this.view = n, this.prevViewport = n.viewport, this.dom = document.createElement("div"), this.dom.className = "cm-gutters", this.dom.setAttribute("aria-hidden", "true"), this.dom.style.minHeight = this.view.contentHeight / this.view.scaleY + "px", this.gutters = n.state.facet(gs).map((t) => new Io(n, t));
    for (let t of this.gutters)
      this.dom.appendChild(t.dom);
    this.fixed = !n.state.facet(Lo), this.fixed && (this.dom.style.position = "sticky"), this.syncGutters(!1), n.scrollDOM.insertBefore(this.dom, n.contentDOM);
  }
  update(n) {
    ...
    n.geometryChanged && (this.dom.style.minHeight = this.view.contentHeight / this.view.scaleY + "px"), this.view.state.facet(Lo) != !this.fixed && (this.fixed = !this.fixed, this.dom.style.position = this.fixed ? "sticky" : ""), this.prevViewport = n.view.viewport;
  }
  syncGutters(n) {
    let t = this.dom.nextSibling;
    n && this.dom.remove();
    let e = V.iter(this.view.state.facet(ps), this.view.viewport.from), i = [], s = this.gutters.map((r) => new yd(r, this.view.viewport, -this.view.documentPadding.top));
  ...
  updateGutters(n) {
    let t = n.startState.facet(gs), e = n.state.facet(gs), i = n.docChanged || n.heightChanged || n.viewportChanged || !V.eq(n.startState.facet(ps), n.state.facet(ps), n.view.viewport.from, n.view.viewport.to);
    if (t == e)
      ...
      for (let r of e) {
        let o = t.indexOf(r);
        o < 0 ? s.push(new Io(this.view, r)) : (this.gutters[o].update(n), s.push(this.gutters[o]));
      }
...
class yd {
  ...
  line(t, e, i) {
    let s = [];
    Yn(this.cursor, s, e.from), i.length && (s = s.concat(i));
...
class Io {
  constructor(t, e) {
    ...
    this.markers = No(e.markers(t)), e.initialSpacer && (this.spacer = new $a(t, 0, 0, [e.initialSpacer(t)]), this.dom.appendChild(this.spacer.dom), this.spacer.dom.style.cssText += "visibility: hidden; pointer-events: none");
  }
  update(t) {
    let e = this.markers;
...
class $a {
  ...
  update(t, e, i, s) {
    this.height != e && (this.height = e, this.dom.style.height = e + "px"), this.above != i && (this.dom.style.marginTop = (this.above = i) ? i + "px" : ""), bd(this.markers, s) || this.setMarkers(t, s);
  }
  setMarkers(t, e) {
...
const kd = /* @__PURE__ */ new class extends Se {
  constructor() {
    super(...arguments), this.elementClass = "cm-activeLineGutter";
  }
}(), xd = /* @__PURE__ */ ps.compute(["selection"], (n) => {
  let t = [], e = -1;
  for (let i of n.selection.ranges) {
    let s = n.doc.lineAt(i.head).from;
    s > e && (e = s, t.push(kd.range(s)));
  }
  return V.of(t);
});
function vd() {
...
class R {
  ...
  */
  constructor(t = {}) {
    this.id = Sd++, this.perNode = !!t.perNode, this.deserialize = t.deserialize || (() => {
  ...
  */
  add(t) {
    ...
    return typeof t != "function" && (t = kt.match(t)), (e) => {
      let i = t(e);
...
class kt {
  ...
  */
  static define(t) {
    let e = t.props && t.props.length ? /* @__PURE__ */ Object.create(null) : Cd, i = (t.top ? 1 : 0) | (t.skipped ? 2 : 0) | (t.error ? 4 : 0) | (t.name == null ? 8 : 0), s = new kt(t.name || "", e, t.id, i);
    if (t.props) {
  ...
  */
  extend(...t) {
    ...
    for (let i of this.types) {
      ...
      e.push(s ? new kt(i.name, s, i.id, i.flags) : i);
    }
    return new vr(e);
  }
}
const ts = /* @__PURE__ */ new WeakMap(), Vo = /* @__PURE__ */ new WeakMap();
var st;
(function(n) {
...
class tt {
  ...
  */
  cursorAt(t, e = 0, i = 0) {
    let s = ts.get(this) || this.topNode, r = new Jn(s);
    return r.moveTo(t, e), ts.set(this, r._tree), r;
  }
  /**
  ...
  */
  resolve(t, e = 0) {
    let i = Oi(ts.get(this) || this.topNode, t, e, !1);
  ...
  */
  resolveInner(t, e = 0) {
    let i = Oi(Vo.get(this) || this.topNode, t, e, !0);
  ...
  */
  balance(t = {}) {
    return this.children.length <= 8 ? this : Ar(kt.none, this.children, this.positions, 0, this.children.length, 0, this.length, (e, i, s) => new tt(this.type, e, i, s, this.propValues), t.makeTree || ((e, i, s) => new tt(kt.none, e, i, s)));
  }
  /**
...
class Ce {
  ...
  */
  findChild(t, e, i, s, r) {
    ...
    for (let a = t; a != e && !(_a(r, s, o[a + 1], o[a + 2]) && (l = a, i > 0)); a = o[a + 3])
      ;
    return l;
  }
  /**
...
class Pt extends Wa {
  ...
  nextChild(t, e, i, s, r = 0) {
    for (let o = this; ; ) {
      for (let { children: l, positions: a } = o._tree, h = e > 0 ? l.length : -1; t != h; t += e) {
        ...
        if (_a(s, i, c, c + f.length)) {
          if (f instanceof Ce) {
            if (r & st.ExcludeBuffers)
              continue;
            let u = f.findChild(0, f.buffer.length, e, i - c, s);
            if (u > -1)
              return new me(new Ad(o, f, t, c), null, u);
          } else if (r & st.IncludeAnonymous || !f.type.isAnonymous || Cr(f)) {
            let u;
            if (!(r & st.IgnoreMounts) && (u = Ts.get(f)) && !u.overlay)
              return new Pt(u.tree, c, t, o);
            let d = new Pt(f, c, t, o);
            return r & st.IncludeAnonymous || !d.type.isAnonymous ? d : d.nextChild(e < 0 ? f.children.length - 1 : 0, e, i, s);
          }
        }
      }
  ...
  enter(t, e, i = 0) {
    let s;
    if (!(i & st.IgnoreOverlays) && (s = Ts.get(this._tree)) && s.overlay) {
      let r = t - this.from;
...
class me extends Wa {
  ...
  child(t, e, i) {
    ...
    return r < 0 ? null : new me(this.context, this, r);
  }
  get firstChild() {
    return this.child(
      1,
  ...
  get nextSibling() {
    ...
    return e < (this._parent ? t.buffer[this._parent.index + 3] : t.buffer.length) ? new me(this.context, this._parent, e) : this.externalSibling(1);
  }
  get prevSibling() {
    let { buffer: t } = this.context, e = this._parent ? this._parent.index + 4 : 0;
    return this.index == e ? this.externalSibling(-1) : new me(this.context, this._parent, t.findChild(
      e,
      this.index,
      -1,
      0,
...
function ja(n) {
  ...
  return i ? s[t] = i : s.splice(t, 1), new Md(s, e);
}
class Md {
  constructor(t, e) {
    ...
    for (; i; { index: e, _parent: i } = i)
      if (e > -1)
        for (let r = e + t, o = t < 0 ? -1 : i._tree.children.length; r != o; r += t) {
          ...
          if (this.mode & st.IncludeAnonymous || l instanceof Ce || !l.type.isAnonymous || Cr(l))
            return !1;
        }
    return !0;
  }
  ...
  */
  get node() {
    ...
    for (let s = i; s < this.stack.length; s++)
      e = new me(this.buffer, e, this.stack[s]);
    return this.bufferNode = new me(this.buffer, e, this.index);
  }
  /**
...
function Cr(n) {
  return n.children.some((t) => t instanceof Ce || !t.type.isAnonymous || Cr(t));
}
function Td(n) {
  var t;
  let { buffer: e, nodeSet: i, maxBufferLength: s = za, reused: r = [], minRepeatType: o = i.types.length } = n, l = Array.isArray(e) ? new Sr(e, e.length) : e, a = i.types, h = 0, f = 0;
  function c(A, T, O, H, W, Q) {
    let { id: N, start: B, end: G, size: U } = l, rt = f, he = h;
    for (; U < 0; )
      if (l.next(), U == -1) {
        let te = r[N];
        O.push(te), H.push(B - A);
        return;
      } else if (U == -3) {
        h = N;
        return;
    ...
    let oi = a[N], Hi, Te, Er = B - A;
    if (G - B <= s && (Te = g(l.pos - T, W))) {
      let te = new Uint16Array(Te.size - Te.skip), Mt = l.pos - Te.size, Wt = te.length;
      for (; l.pos > Mt; )
        Wt = w(Te.start, te, Wt);
      Hi = new Ce(te, G - Te.start, i), Er = Te.start - A;
    } else {
      let te = l.pos - U;
      l.next();
      let Mt = [], Wt = [], De = N >= o ? N : -1, _e = 0, Fi = G;
      for (; l.pos > te; )
        De >= 0 && l.id == De && l.size >= 0 ? (l.end <= Fi - s && (p(Mt, Wt, B, _e, l.end, Fi, De, rt, he), _e = Mt.length, Fi = l.end), l.next()) : Q > 2500 ? u(B, te, Mt, Wt) : c(B, te, Mt, Wt, De, Q + 1);
      if (De >= 0 && _e > 0 && _e < Mt.length && p(Mt, Wt, B, _e, B, Fi, De, rt, he), Mt.reverse(), Wt.reverse(), De > -1 && _e > 0) {
        let Lr = d(oi, he);
        Hi = Ar(oi, Mt, Wt, 0, Mt.length, 0, G - B, Lr, Lr);
      } else
        Hi = m(oi, Mt, Wt, G - B, rt - G, he);
    }
    O.push(Hi), H.push(Er);
  }
  function u(A, T, O, H) {
    let W = [], Q = 0, N = -1;
    for (; l.pos > T; ) {
      let { id: B, start: G, end: U, size: rt } = l;
      if (rt > 4)
        l.next();
      else {
        if (N > -1 && G < N)
          break;
        N < 0 && (N = U - s), W.push(B, G, U), Q++, l.next();
      }
    }
    if (Q) {
      let B = new Uint16Array(Q * 4), G = W[W.length - 2];
      for (let U = W.length - 3, rt = 0; U >= 0; U -= 3)
        B[rt++] = W[U], B[rt++] = W[U + 1] - G, B[rt++] = W[U + 2] - G, B[rt++] = rt;
      O.push(new Ce(B, W[2] - G, i)), H.push(G - A);
    }
  }
  function d(A, T) {
    return (O, H, W) => {
      let Q = 0, N = O.length - 1, B, G;
      if (N >= 0 && (B = O[N]) instanceof tt) {
        if (!N && B.type == A && B.length == W)
          return B;
        (G = B.prop(R.lookAhead)) && (Q = H[N] + B.length + G);
      }
      return m(A, O, H, W, Q, T);
    };
  }
  function p(A, T, O, H, W, Q, N, B, G) {
    let U = [], rt = [];
    for (; A.length > H; )
      U.push(A.pop()), rt.push(T.pop() + O - W);
    A.push(m(i.types[N], U, rt, Q - W, B - Q, G)), T.push(W - O);
  }
  function m(A, T, O, H, W, Q, N) {
    if (Q) {
      let B = [R.contextHash, Q];
      N = N ? [B].concat(N) : [B];
    }
    if (W > 25) {
      let B = [R.lookAhead, W];
    ...
    return new tt(A, T, O, H, N);
  }
  function g(A, T) {
    let O = l.fork(), H = 0, W = 0, Q = 0, N = O.end - s, B = { size: 0, start: 0, skip: 0 };
    t: for (let G = O.pos - A; O.pos > G; ) {
      let U = O.size;
      if (O.id == T && U >= 0) {
        B.size = H, B.start = W, B.skip = Q, Q += 4, H += 4, O.next();
        continue;
      }
      let rt = O.pos - U;
      if (U < 0 || rt < G || O.start < N)
        break;
      let he = O.id >= o ? 4 : 0, oi = O.start;
      for (O.next(); O.pos > rt; ) {
        if (O.size < 0)
          if (O.size == -3)
            he += 4;
    ...
    return (T < 0 || H == A) && (B.size = H, B.start = W, B.skip = Q), B.size > 4 ? B : void 0;
  }
  function w(A, T, O) {
    let { id: H, start: W, end: Q, size: N } = l;
    if (l.next(), N >= 0 && H < o) {
      let B = O;
      if (N > 4) {
        let G = l.pos - (N - 4);
      ...
      T[--O] = B, T[--O] = Q - A, T[--O] = W - A, T[--O] = H;
    } else N == -3 ? h = H : N == -4 && (f = H);
    return O;
  }
  let x = [], v = [];
  for (; l.pos > 0; )
    c(n.start || 0, n.bufferStart || 0, x, v, -1, 0);
  let C = (t = n.length) !== null && t !== void 0 ? t : x.length ? v[0] + x[0].length : 0;
  return new tt(a[n.topID], x.reverse(), v.reverse(), C);
}
const Fo = /* @__PURE__ */ new WeakMap();
function ms(n, t) {
  if (!n.isAnonymous || t instanceof Ce || t.type != n)
    return 1;
  let e = Fo.get(t);
  if (e == null) {
    e = 1;
...
function Ar(n, t, e, i, s, r, o, l, a) {
  ...
  function d(p, m, g, w, x) {
    for (let v = g; v < w; ) {
      let C = v, A = m[v], T = ms(n, p[v]);
      for (v++; v < w; v++) {
        let O = ms(n, p[v]);
        if (T + O >= f)
          break;
      ...
      if (v == C + 1) {
        if (T > f) {
          let O = p[C];
          d(O.children, O.positions, 0, O.children.length, m[C] + x);
          continue;
        }
        c.push(p[C]);
      } else {
        let O = m[v - 1] + p[v - 1].length - A;
        c.push(Ar(n, p, m, C, v, A, O, null, a));
      }
      u.push(A + x - r);
    }
  }
...
class Le {
  ...
  */
  static addTree(t, e = [], i = !1) {
    let s = [new Le(0, t.length, t, 0, !1, i)];
    for (let r of e)
      ...
      if (c - a >= i)
        for (; o && o.from < c; ) {
          ...
          if (a >= u.from || c <= u.to || h) {
            ...
            u = d >= p ? null : new Le(d, p, u.tree, u.offset + h, l > 0, !!f);
          }
...
class qa {
  ...
  */
  startParse(t, e, i) {
    return typeof t == "string" && (t = new Dd(t)), i = i ? i.length ? i.map((s) => new an(s.from, s.to)) : [new an(0, 0)] : [new an(0, t.length)], this.createParse(t, e || [], i);
  }
  /**
...
class Ot {
  ...
  */
  constructor(t, e, i, s) {
    this.name = t, this.set = e, this.base = i, this.modified = s, this.id = Pd++;
  }
  toString() {
    let { name: t } = this;
  ...
  static define(t, e) {
    ...
    if (t instanceof Ot && (e = t), e != null && e.base)
  ...
  */
  static defineModifier(t) {
    let e = new Ds(t);
    return (i) => i.modified.indexOf(e) > -1 ? i : Ds.get(i.base || i, i.modified.concat(e).sort((s, r) => s.id - r.id));
  }
}
let Bd = 0;
class Ds {
  constructor(t) {
    this.name = t, this.instances = [], this.id = Bd++;
  }
  static get(t, e) {
    if (!e.length)
      return t;
  ...
  for (let e in n) {
    ...
    for (let s of e.split(" "))
      if (s) {
        ...
        if (!h)
          throw new RangeError("Invalid path: " + s);
        let f = new Ps(i, o, a > 0 ? r.slice(0, a) : null);
        t[h] = f.sort(t[h]);
      }
  }
  return Ga.add(t);
...
function Nd(n, t, e, i = 0, s = n.length) {
...
class Id {
  ...
  highlightRange(t, e, i, s, r) {
    ...
    let h = s, f = Vd(t) || Ps.empty, c = Ld(r, f.tags);
    ...
    if (u && u.overlay) {
      ...
      for (let g = 0, w = l; ; g++) {
        let x = g < u.overlay.length ? u.overlay[g] : null, v = x ? x.from + l : a, C = Math.max(e, w), A = Math.min(i, v);
        if (C < A && m)
          for (; t.from < A && (this.highlightRange(t, C, A, s, r), this.startSpan(Math.min(A, t.to), h), !(t.to >= v || !t.nextSibling())); )
            ;
        if (!x || v > i)
          break;
        w = x.to + l, w > e && (this.highlightRange(d.cursor(), Math.max(e, x.from + l), Math.min(i, w), "", p), this.startSpan(Math.min(i, w), h));
      }
      m && t.parent();
...
function Vd(n) {
  let t = n.type.prop(Ga);
  for (; t && t.context && !n.matchContext(t.context); )
    t = t.next;
  return t || null;
}
const k = Ot.define, es = k(), fe = k(), $o = k(fe), zo = k(fe), ce = k(), is = k(ce), hn = k(ce), Gt = k(), Pe = k(Gt), qt = k(), Kt = k(), Zn = k(), fi = k(Zn), ss = k(), y = {
  /**
  A comment.
  */
  comment: es,
  ...
  */
  bitwiseOperator: k(Kt),
  /**
  Comparison [operator](#highlight.tags.operator).
  */
  compareOperator: k(Kt),
  /**
...
var fn;
const je = /* @__PURE__ */ new R();
function Hd(n) {
  return M.define({
    combine: n ? (t) => t.concat(n) : void 0
  });
}
const Fd = /* @__PURE__ */ new R();
class It {
  /**
  ...
  constructor(t, e, i = [], s = "") {
    this.data = t, this.name = s, F.prototype.hasOwnProperty("tree") || Object.defineProperty(F.prototype, "tree", { get() {
      ...
      F.languageData.of((r, o, l) => {
        let a = _o(r, o, l), h = a.type.prop(je);
        if (!h)
          return [];
        let f = r.facet(h), c = a.type.prop(Fd);
        if (c) {
  ...
  */
  isActiveAt(t, e, i = -1) {
    return _o(t, e, i).type.prop(je) == this.data;
  }
  /**
  ...
  */
  findRegions(t) {
    ...
    if (!e || !e.allowsNesting)
      return [];
    let i = [], s = (r, o) => {
      if (r.prop(je) == this.data) {
        i.push({ from: o, to: o + r.length });
        return;
      }
      let l = r.prop(R.mounted);
      if (l) {
        if (l.tree.prop(je) == this.data) {
          if (l.overlay)
      ...
      for (let a = 0; a < r.children.length; a++) {
        let h = r.children[a];
        h instanceof tt && s(h, r.positions[a] + o);
      }
    };
    return s(At(t), 0), i;
  }
...
It.setState = /* @__PURE__ */ $.define();
function _o(n, t, e) {
  let i = n.facet(Ae), s = At(n).topNode;
...
class Bs extends It {
  ...
  */
  static define(t) {
    let e = Hd(t.languageData);
    return new Bs(e, t.parser.configure({
      props: [je.add((i) => i.isTop ? e : void 0)]
    }), t.name);
  }
  /**
  ...
  */
  configure(t, e) {
    return new Bs(this.data, this.parser.configure(t), e || this.name);
  }
  get allowsNesting() {
...
class Rs {
  ...
  */
  static create(t, e, i) {
    return new Rs(t, e, [], tt.empty, 0, i, [], null);
  }
  startParse() {
  ...
  work(t, e) {
    return e != null && e >= this.state.doc.length && (e = void 0), this.tree != tt.empty && this.isDone(e ?? this.state.doc.length) ? (this.takeTree(), !0) : this.withContext(() => {
      ...
      for (this.parse || (this.parse = this.startParse()), e != null && (this.parse.stoppedAt == null || this.parse.stoppedAt > e) && e < this.state.doc.length && this.parse.stopAt(e); ; ) {
        ...
        if (s)
          if (this.fragments = this.withoutTempSkipped(Le.addTree(s, this.fragments, this.parse.stoppedAt != null)), this.treeLen = (i = this.parse.stoppedAt) !== null && i !== void 0 ? i : this.state.doc.length, this.tree = s, this.parse = null, this.treeLen < (e ?? this.state.doc.length))
  ...
  takeTree() {
    ...
    this.parse && (t = this.parse.parsedPos) >= this.treeLen && ((this.parse.stoppedAt == null || this.parse.stoppedAt > t) && this.parse.stopAt(t), this.withContext(() => {
      for (; !(e = this.parse.advance()); )
        ;
    }), this.treeLen = t, this.tree = e, this.fragments = this.withoutTempSkipped(Le.addTree(this.tree, this.fragments, !0)), this.parse = null);
  }
  withContext(t) {
    let e = ci;
    ci = this;
  ...
  */
  changes(t, e) {
    ...
    if (this.takeTree(), !t.empty) {
      let a = [];
      if (t.iterChangedRanges((h, f, c, u) => a.push({ fromA: h, toA: f, fromB: c, toB: u })), i = Le.applyChanges(i, a), s = tt.empty, r = 0, o = { from: t.mapPos(o.from, -1), to: t.mapPos(o.to, 1) }, this.skipped.length) {
        l = [];
    ...
    return new Rs(this.parser, e, i, s, r, o, l, this.scheduleOn);
  }
  /**
  @internal
  */
  updateViewport(t) {
    ...
    for (let i = 0; i < this.skipped.length; i++) {
      ...
      s < t.to && r > t.from && (this.fragments = Wo(this.fragments, s, r), this.skipped.splice(i--, 1));
    }
      ...
      createParse(e, i, s) {
        ...
        return {
          ...
          advance() {
            ...
            return this.parsedPos = o, new tt(kt.none, [], [], o - r);
          },
          stoppedAt: null,
          stopAt() {
          }
...
function Wo(n, t, e) {
  return Le.applyChanges(n, [{ fromA: t, toA: e, fromB: t, toB: e }]);
}
class ii {
  constructor(t) {
  ...
  static init(t) {
    let e = Math.min(3e3, t.doc.length), i = Rs.create(t.facet(Ae).parser, t, { from: 0, to: e });
    return i.work(20, e) || i.takeTree(), new ii(i);
  }
}
It.state = /* @__PURE__ */ zt.define({
  create: ii.init,
  update(n, t) {
    for (let e of t.effects)
      if (e.is(It.setState))
        return e.value;
    return t.startState.facet(Ae) != t.state.facet(Ae) ? ii.init(t.state) : n.apply(t);
  }
});
let Qa = (n) => {
  let t = setTimeout(
...
const cn = typeof navigator < "u" && (!((fn = navigator.scheduling) === null || fn === void 0) && fn.isInputPending) ? () => navigator.scheduling.isInputPending() : null, zd = /* @__PURE__ */ bt.fromClass(class {
  constructor(t) {
  ...
  work(t) {
    ...
    if (r.tree == r.context.tree && r.context.isDone(
      ...
      return;
    let o = Date.now() + Math.min(this.chunkBudget, 100, t && !cn ? Math.max(25, t.timeRemaining() - 5) : 1e9), l = r.context.treeLen < s && i.doc.length > s + 1e3, a = r.context.work(() => cn && cn() || Date.now() > o, s + (l ? 0 : 1e5));
  ...
  checkAsyncSchedule(t) {
    t.scheduleOn && (this.workScheduled++, t.scheduleOn.then(() => this.scheduleWork()).catch((e) => Nt(this.view.state, e)).then(() => this.workScheduled--), t.scheduleOn = null);
  }
  destroy() {
...
const Wd = /* @__PURE__ */ M.define(), Mr = /* @__PURE__ */ M.define({
  combine: (n) => {
    if (!n.length)
      return "  ";
    let t = n[0];
...
function Ti(n, t) {
  let e = "", i = n.tabSize, s = n.facet(Mr)[0];
  if (s == "	") {
    for (; t >= i; )
      e += "	", t -= i;
    s = " ";
...
function Or(n, t) {
  n instanceof F && (n = new qs(n));
  for (let i of n.state.facet(Wd)) {
    let s = i(n, t);
    if (s !== void 0)
      return s;
  }
  let e = At(n.state);
  return e.length >= t ? jd(n, e, t) : null;
}
class qs {
  /**
  ...
  */
  constructor(t, e = {}) {
    this.state = t, this.options = e, this.unit = Es(t);
  }
  /**
  ...
  */
  countColumn(t, e = t.length) {
    return Ri(t, this.state.tabSize, e);
  }
  /**
...
class Tr extends qs {
  ...
  */
  continue() {
    return Xa(this.context.next, this.base, this.pos);
  }
}
function Ud(n, t) {
...
function Yd(n, t, e, i, s) {
  let r = n.textAfter, o = r.match(/^\s*/)[0].length, l = i && r.slice(o, o + i.length) == i || s == n.pos + o, a = Qd(n);
  return a ? l ? n.column(a.from) : n.column(a.to) : n.baseIndent + (l ? 0 : n.unit * e);
}
function jo({ except: n, units: t = 1 } = {}) {
  return (e) => {
...
function Jd() {
  return F.transactionFilter.of((n) => {
    ...
    for (let { head: h } of o.selection.ranges) {
      ...
      if (c == null)
        continue;
      let u = /^\s*/.exec(f.text)[0], d = Ti(o, c);
      u != d && a.push({ from: f.from, to: f.from + u.length, insert: d });
    }
    return a.length ? [n, { changes: a, sequential: !0 }] : n;
  });
}
const Zd = /* @__PURE__ */ M.define(), Ja = /* @__PURE__ */ new R();
function tp(n) {
...
function ep(n, t, e) {
  ...
  for (let o = s; o; o = o.next) {
    ...
    if (r && l.from < t)
      break;
    let a = l.type.prop(Ja);
    if (a && (l.to < i.length - 50 || i.length == n.doc.length || !ip(l))) {
      let h = a(l, n);
...
const Ks = /* @__PURE__ */ $.define({ map: Za }), Ni = /* @__PURE__ */ $.define({ map: Za });
function th(n) {
  let t = [];
...
const Fe = /* @__PURE__ */ zt.define({
  ...
  update(n, t) {
    n = n.map(t.changes);
    for (let e of t.effects)
      if (e.is(Ks) && !sp(n, e.value.from, e.value.to)) {
        let { preparePlaceholder: i } = t.state.facet(sh), s = i ? L.replace({ widget: new fp(i(t.state, e.value)) }) : qo;
        n = n.update({ add: [s.range(e.value.from, e.value.to)] });
      } else e.is(Ni) && (n = n.update({
...
function eh(n, t) {
  return n.field(Fe, !1) ? t : t.concat($.appendConfig.of(nh()));
}
const np = (n) => {
  for (let t of th(n)) {
    let e = Ls(n.state, t.from, t.to);
    if (e)
      return n.dispatch({ effects: eh(n.state, [Ks.of(e), ih(n, e)]) }), !0;
  }
  return !1;
}, rp = (n) => {
  ...
  let t = [];
  for (let e of th(n)) {
    let i = Ns(n.state, e.from, e.to);
    i && t.push(Ni.of(i), ih(n, i, !1));
  }
...
const op = (n) => {
  ...
  for (let i = 0; i < t.doc.length; ) {
    let s = n.lineBlockAt(i), r = Ls(t, s.from, s.to);
    r && e.push(Ks.of(r)), i = (r ? n.lineBlockAt(r.to) : s).to + 1;
  }
  ...
  return t.between(0, n.state.doc.length, (i, s) => {
    e.push(Ni.of({ from: i, to: s }));
  }), n.dispatch({ effects: e }), !0;
}, ap = [
  { key: "Ctrl-Shift-[", mac: "Cmd-Alt-[", run: np },
...
function rh(n, t) {
  let { state: e } = n, i = e.facet(sh), s = (o) => {
    let l = n.lineBlockAt(n.posAtDOM(o.target)), a = Ns(n.state, l.from, l.to);
...
const qo = /* @__PURE__ */ L.replace({ widget: /* @__PURE__ */ new class extends Me {
  toDOM(n) {
    return rh(n, null);
  }
}() });
...
function up(n = {}) {
  let t = Object.assign(Object.assign({}, cp), n), e = new un(t, !0), i = new un(t, !1), s = bt.fromClass(class {
    constructor(o) {
      this.from = o.viewport.from, this.markers = this.buildMarkers(o);
    }
    update(o) {
      (o.docChanged || o.viewportChanged || o.startState.facet(Ae) != o.state.facet(Ae) || o.startState.field(Fe, !1) != o.state.field(Fe, !1) || At(o.startState) != At(o.state) || t.foldingChanged(o)) && (this.markers = this.buildMarkers(o.view));
    }
    buildMarkers(o) {
      let l = new be();
      for (let a of o.viewportLineBlocks) {
        let h = Ns(o.state, a.from, a.to) ? i : Ls(o.state, a.from, a.to) ? e : null;
    ...
    gd({
      ...
      domEventHandlers: Object.assign(Object.assign({}, r), { click: (o, l, a) => {
        if (r.click && r.click(o, l, a))
          return !0;
        let h = Ns(o.state, l.from, l.to);
        if (h)
          return o.dispatch({ effects: Ni.of(h) }), !0;
        let f = Ls(o.state, l.from, l.to);
        return f ? (o.dispatch({ effects: Ks.of(f) }), !0) : !1;
      } })
    }),
    nh()
  ];
}
const dp = /* @__PURE__ */ D.baseTheme({
  ".cm-foldPlaceholder": {
    backgroundColor: "#eee",
...
class Ii {
  constructor(t, e) {
    ...
    this.scope = o instanceof It ? (l) => l.prop(je) == o.data : o ? (l) => l == o : void 0, this.style = Ua(t.map((l) => ({
      tag: l.tag,
      class: l.class || s(Object.assign({}, l, { tag: null }))
    })), {
      all: r
    }).style, this.module = i ? new ke(i) : null, this.themeType = e.themeType;
  }
  /**
...
const tr = /* @__PURE__ */ M.define(), pp = /* @__PURE__ */ M.define({
  combine(n) {
    return n.length ? [n[0]] : null;
  }
});
function dn(n) {
  let t = n.facet(tr);
  return t.length ? t : n.facet(pp);
}
function Ko(n, t) {
  let e = [mp], i;
  return n instanceof Ii && (n.module && e.push(D.styleModule.of(n.module)), i = n.themeType), i ? e.push(tr.computeN([D.darkTheme], (s) => s.facet(D.darkTheme) == (i == "dark") ? [n] : [])) : e.push(tr.of(n)), e;
}
class gp {
  constructor(t) {
    this.markCache = /* @__PURE__ */ Object.create(null), this.tree = At(t.state), this.decorations = this.buildDeco(t, dn(t.state)), this.decoratedTo = t.viewport.to;
  }
  update(t) {
    let e = At(t.state), i = dn(t.state), s = i != dn(t.startState), { viewport: r } = t.view, o = t.changes.mapPos(this.decoratedTo, 1);
  ...
  buildDeco(t, e) {
    ...
    for (let { from: s, to: r } of t.visibleRanges)
      Nd(this.tree, e, (o, l, a) => {
        i.add(o, l, this.markCache[a] || (this.markCache[a] = L.mark({ class: a })));
      }, s, r);
    return i.finish();
  }
}
const mp = /* @__PURE__ */ fr.high(/* @__PURE__ */ bt.fromClass(gp, {
  decorations: (n) => n.decorations
})), wp = /* @__PURE__ */ Ii.define([
  {
    tag: y.meta,
    color: "#404740"
  },
...
]), yp = /* @__PURE__ */ D.baseTheme({
  "&.cm-focused .cm-matchingBracket": { backgroundColor: "#328c8252" },
  "&.cm-focused .cm-nonmatchingBracket": { backgroundColor: "#bb555544" }
}), oh = 1e4, lh = "()[]{}", ah = /* @__PURE__ */ M.define({
  combine(n) {
    return $s(n, {
      afterCursor: !0,
      brackets: lh,
...
}), bp = /* @__PURE__ */ L.mark({ class: "cm-matchingBracket" }), kp = /* @__PURE__ */ L.mark({ class: "cm-nonmatchingBracket" });
function xp(n) {
  let t = [], e = n.matched ? bp : kp;
  return t.push(e.range(n.start.from, n.start.to)), n.end && t.push(e.range(n.end.from, n.end.to)), t;
}
const vp = /* @__PURE__ */ zt.define({
  create() {
    return L.none;
  },
  update(n, t) {
    ...
    for (let s of t.state.selection.ranges) {
      if (!s.empty)
        continue;
      let r = Xt(t.state, s.head, -1, i) || s.head > 0 && Xt(t.state, s.head - 1, 1, i) || i.afterCursor && (Xt(t.state, s.head, 1, i) || s.head < t.state.doc.length && Xt(t.state, s.head + 1, -1, i));
...
function ir(n) {
  let t = n.type.prop(Ap);
  return t ? t(n.node) : n;
}
function Xt(n, t, e, i = {}) {
  let s = i.maxScanDistance || oh, r = i.brackets || lh, o = At(n), l = o.resolveInner(t, e);
  for (let a = l; a; a = a.parent) {
    let h = er(a.type, e, r);
    if (h && a.from < a.to) {
      let f = ir(a);
      if (f && (e > 0 ? t >= f.from && t < f.to : t > f.from && t <= f.to))
        return Mp(n, t, e, a, f, h, r);
    }
  }
  return Op(n, t, e, o, l.type, s, r);
}
...
function Op(n, t, e, i, s, r, o) {
  ...
  for (let u = 0; !f.next().done && u <= r; ) {
    ...
    for (let m = e > 0 ? 0 : d.length - 1, g = e > 0 ? d.length : -1; m != g; m += e) {
      let w = o.indexOf(d[m]);
      if (!(w < 0 || i.resolveInner(p + m, 1).type != s))
        if (w % 2 == 0 == e > 0)
          c++;
        else {
          if (c == 1)
...
const Tp = /* @__PURE__ */ Object.create(null), Go = [kt.none], Uo = [], Qo = /* @__PURE__ */ Object.create(null), Dp = /* @__PURE__ */ Object.create(null);
for (let [n, t] of [
  ...
  Dp[n] = /* @__PURE__ */ Pp(Tp, t);
function pn(n, t) {
  Uo.indexOf(n) > -1 || (Uo.push(n), console.warn(t));
}
function Pp(n, t) {
  let e = [];
  for (let l of t.split(" ")) {
    ...
    for (let h of l.split(".")) {
      let f = n[h] || y[h];
      f ? typeof f == "function" ? a.length ? a = a.map(f) : pn(h, `Modifier ${h} used at start of tag`) : a.length ? pn(h, `Tag ${h} used as modifier`) : a = Array.isArray(f) ? f : [f] : pn(h, `Unknown highlighting tag ${h}`);
    }
    for (let h of a)
      e.push(h);
  }
  if (!e.length)
    return 0;
  let i = t.replace(/ /g, "_"), s = i + " " + e.map((l) => l.id), r = Qo[s];
  if (r)
    return r.id;
  let o = Qo[s] = kt.define({
    id: Go.length,
    name: i,
    props: [Ka({ [i]: e })]
  });
  return Go.push(o), o.id;
}
J.RTL, J.LTR;
const Bp = (n) => {
  let { state: t } = n, e = t.doc.lineAt(t.selection.main.from), i = Pr(n.state, e.from);
  return i.line ? Rp(n) : i.block ? Lp(n) : !1;
};
function Dr(n, t) {
...
const ui = 50;
function Np(n, { open: t, close: e }, i, s) {
  ...
  let f, c;
  s - i <= 2 * ui ? f = c = n.sliceDoc(i, s) : (f = n.sliceDoc(i, i + ui), c = n.sliceDoc(s - ui, s));
...
function hh(n, t, e = t.selection.ranges) {
  ...
  if (!i.every((r) => r))
    return null;
  let s = e.map((r, o) => Np(t, i[o], r.from, r.to));
  if (n != 2 && !s.every((r) => r))
...
function Vp(n, t, e = t.selection.ranges) {
  let i = [], s = -1;
  for (let { from: r, to: o } of e) {
    let l = i.length, a = 1e9, h = Pr(t, r).line;
    if (h) {
      for (let f = r; f <= o; ) {
...
function _t({ state: n, dispatch: t }, e) {
  let i = ri(n.selection, e);
  return i.eq(n.selection, !0) ? !1 : (t(Zt(n, i)), !0);
}
function Gs(n, t) {
  return b.cursor(t ? n.to : n.from);
}
function fh(n, t) {
  return _t(n, (e) => e.empty ? n.moveByChar(e, t) : Gs(e, t));
}
function dt(n) {
  return n.textDirectionAt(n.state.selection.main.head) == J.LTR;
}
const ch = (n) => fh(n, !dt(n)), uh = (n) => fh(n, dt(n));
function dh(n, t) {
  return _t(n, (e) => e.empty ? n.moveByGroup(e, t) : Gs(e, t));
}
const Hp = (n) => dh(n, !dt(n)), Fp = (n) => dh(n, dt(n));
function $p(n, t, e) {
  if (t.type.prop(e))
    return !0;
  let i = t.to - t.from;
...
function Us(n, t, e) {
  ...
  for (let a = t.head; ; ) {
    ...
    if (!h)
      break;
    $p(n, h, s) ? i = h : a = e ? h.to : h.from;
  }
  let r = i.type.prop(s), o, l;
  return r && (o = e ? Xt(n, i.from, 1) : Xt(n, i.to, -1)) && o.matched ? l = e ? o.end.to : o.end.from : l = e ? i.to : i.from, b.cursor(l, e ? -1 : 1);
}
const zp = (n) => _t(n, (t) => Us(n.state, t, !dt(n))), _p = (n) => _t(n, (t) => Us(n.state, t, dt(n)));
function ph(n, t) {
  return _t(n, (e) => {
    if (!e.empty)
      return Gs(e, t);
...
function yh(n, t) {
  let e = wh(n), { state: i } = n, s = ri(i.selection, (o) => o.empty ? n.moveVertically(o, t, e.height) : Gs(o, t));
  if (s.eq(i.selection))
    return !1;
  let r;
  if (e.selfScroll) {
  ...
  return n.dispatch(Zt(i, s), { effects: r }), !0;
}
const Yo = (n) => yh(n, !1), sr = (n) => yh(n, !0);
function Oe(n, t, e) {
...
const Wp = (n) => _t(n, (t) => Oe(n, t, !0)), jp = (n) => _t(n, (t) => Oe(n, t, !1)), qp = (n) => _t(n, (t) => Oe(n, t, !dt(n))), Kp = (n) => _t(n, (t) => Oe(n, t, dt(n))), Gp = (n) => _t(n, (t) => b.cursor(n.lineBlockAt(t.head).from, 1)), Up = (n) => _t(n, (t) => b.cursor(n.lineBlockAt(t.head).to, -1));
function Qp(n, t, e) {
  ...
  return i ? (t(Zt(n, s)), !0) : !1;
}
const Yp = ({ state: n, dispatch: t }) => Qp(n, t);
function Lt(n, t) {
  let e = ri(n.state.selection, (i) => {
    let s = t(i);
    return b.range(i.anchor, s.head, s.goalColumn, s.bidiLevel || void 0);
  });
  return e.eq(n.state.selection) ? !1 : (n.dispatch(Zt(n.state, e)), !0);
}
function bh(n, t) {
  return Lt(n, (e) => n.moveByChar(e, t));
}
const kh = (n) => bh(n, !dt(n)), xh = (n) => bh(n, dt(n));
function vh(n, t) {
  return Lt(n, (e) => n.moveByGroup(e, t));
}
const Xp = (n) => vh(n, !dt(n)), Jp = (n) => vh(n, dt(n)), Zp = (n) => Lt(n, (t) => Us(n.state, t, !dt(n))), tg = (n) => Lt(n, (t) => Us(n.state, t, dt(n)));
function Sh(n, t) {
  return Lt(n, (e) => n.moveVertically(e, t));
}
const Ch = (n) => Sh(n, !1), Ah = (n) => Sh(n, !0);
function Mh(n, t) {
  return Lt(n, (e) => n.moveVertically(e, t, wh(n).height));
}
const Xo = (n) => Mh(n, !1), Jo = (n) => Mh(n, !0), eg = (n) => Lt(n, (t) => Oe(n, t, !0)), ig = (n) => Lt(n, (t) => Oe(n, t, !1)), sg = (n) => Lt(n, (t) => Oe(n, t, !dt(n))), ng = (n) => Lt(n, (t) => Oe(n, t, dt(n))), rg = (n) => Lt(n, (t) => b.cursor(n.lineBlockAt(t.head).from)), og = (n) => Lt(n, (t) => b.cursor(n.lineBlockAt(t.head).to)), Zo = ({ state: n, dispatch: t }) => (t(Zt(n, { anchor: 0 })), !0), tl = ({ state: n, dispatch: t }) => (t(Zt(n, { anchor: n.doc.length })), !0), el = ({ state: n, dispatch: t }) => (t(Zt(n, { anchor: n.selection.main.anchor, head: 0 })), !0), il = ({ state: n, dispatch: t }) => (t(Zt(n, { anchor: n.selection.main.anchor, head: n.doc.length })), !0), lg = ({ state: n, dispatch: t }) => (t(n.update({ selection: { anchor: 0, head: n.doc.length }, userEvent: "select" })), !0), ag = ({ state: n, dispatch: t }) => {
  let e = Qs(n).map(({ from: i, to: s }) => b.range(i, Math.min(s + 1, n.doc.length)));
  return t(n.update({ selection: b.create(e), userEvent: "select" })), !0;
}, hg = ({ state: n, dispatch: t }) => {
  let e = ri(n.selection, (i) => {
    let s = At(n), r = s.resolveStack(i.from, 1);
    if (i.empty) {
  ...
  return e.eq(n.selection) ? !1 : (t(Zt(n, e)), !0);
}, fg = ({ state: n, dispatch: t }) => {
  let e = n.selection, i = null;
  return e.ranges.length > 1 ? i = b.create([e.main]) : e.main.empty || (i = b.create([b.cursor(e.main.head)])), i ? (t(Zt(n, i)), !0) : !1;
};
function Vi(n, t) {
  if (n.state.readOnly)
    return !1;
  let e = "delete.selection", { state: i } = n, s = i.changeByRange((r) => {
    ...
    if (o == l) {
      let a = t(r);
      a < o ? (e = "delete.backward", a = ns(n, a, !1)) : a > o && (e = "delete.forward", a = ns(n, a, !0)), o = Math.min(o, a), l = Math.max(l, a);
    } else
      o = ns(n, o, !1), l = ns(n, l, !0);
...
const Oh = (n, t, e) => Vi(n, (i) => {
  let s = i.from, { state: r } = n, o = r.doc.lineAt(s), l, a;
  if (e && !t && s > o.from && s < o.from + 200 && !/[^ \t]/.test(l = o.text.slice(0, s - o.from))) {
    if (l[l.length - 1] == "	")
      return s - 1;
    let h = Ri(l, r.tabSize), f = h % Es(r) || Es(r);
    for (let c = 0; c < f && l[l.length - 1 - c] == " "; c++)
      s--;
    a = s;
  } else
    a = pt(o.text, s - o.from, t, t) + o.from, a == s && o.number != (t ? r.doc.lines : 1) ? a += t ? 1 : -1 : !t && /[\ufe00-\ufe0f]/.test(o.text.slice(a - o.from, s - o.from)) && (a = pt(o.text, a - o.from, !1, !1) + o.from);
  return a;
}), nr = (n) => Oh(n, !1, !0), Th = (n) => Oh(n, !0, !1), Dh = (n, t) => Vi(n, (e) => {
  ...
  for (let l = null; ; ) {
    ...
    let a = pt(r.text, i - r.from, t) + r.from, h = r.text.slice(Math.min(i, a) - r.from, Math.max(i, a) - r.from), f = o(h);
    if (l != null && f != l)
      break;
    (h != " " || i != e.head) && (l = f), i = a;
  }
  return i;
}), Ph = (n) => Dh(n, !1), cg = (n) => Dh(n, !0), ug = (n) => Vi(n, (t) => {
...
const wg = ({ state: n, dispatch: t }) => Bh(n, t, !1), yg = ({ state: n, dispatch: t }) => Bh(n, t, !0);
function Rh(n, t, e) {
  if (n.readOnly)
    return !1;
  let i = [];
...
const bg = ({ state: n, dispatch: t }) => Rh(n, t, !1), kg = ({ state: n, dispatch: t }) => Rh(n, t, !0), xg = (n) => {
  if (n.state.readOnly)
    return !1;
  let { state: t } = n, e = t.changes(Qs(t).map(({ from: s, to: r }) => (s > 0 ? s-- : r < t.doc.length && r++, { from: s, to: r }))), i = ri(t.selection, (s) => {
    let r;
    if (n.lineWrapping) {
...
const sl = /* @__PURE__ */ Eh(!1), Sg = /* @__PURE__ */ Eh(!0);
function Eh(n) {
  return ({ state: t, dispatch: e }) => {
    if (t.readOnly)
      return !1;
    let i = t.changeByRange((s) => {
      let { from: r, to: o } = s, l = t.doc.lineAt(r), a = !n && r == o && vg(t, r);
      n && (r = o = (o <= l.to ? l : t.doc.lineAt(o)).to);
      let h = new qs(t, { simulateBreak: r, simulateDoubleBreak: !!a }), f = Or(h, r);
      for (f == null && (f = Ri(/^\s*/.exec(t.doc.lineAt(r).text)[0], t.tabSize)); o < l.to && /\s/.test(l.text[o - l.from]); )
        o++;
      a ? { from: r, to: o } = a : r > l.from && r < l.from + 100 && !/\S/.test(l.text.slice(0, r)) && (r = l.from);
      let c = ["", Ti(t, f)];
      return a && c.push(Ti(t, h.lineIndent(l.from, -1))), {
...
const Cg = ({ state: n, dispatch: t }) => {
  if (n.readOnly)
    return !1;
  let e = /* @__PURE__ */ Object.create(null), i = new qs(n, { overrideIndentation: (r) => {
    let o = e[r];
    return o ?? -1;
  } }), s = Br(n, (r, o, l) => {
    let a = Or(i, r.from);
    if (a == null)
      return;
    /\S/.test(r.text) || (a = 0);
    let h = /^\s*/.exec(r.text)[0], f = Ti(n, a);
...
}, Ag = ({ state: n, dispatch: t }) => n.readOnly ? !1 : (t(n.update(Br(n, (e, i) => {
  i.push({ from: e.from, insert: n.facet(Mr) });
}), { userEvent: "input.indent" })), !0), Mg = ({ state: n, dispatch: t }) => n.readOnly ? !1 : (t(n.update(Br(n, (e, i) => {
  let s = /^\s*/.exec(e.text)[0];
  if (!s)
    return;
  let r = Ri(s, n.tabSize), o = 0, l = Ti(n, Math.max(0, r - Es(n)));
  for (; o < s.length && o < l.length && s.charCodeAt(o) == l.charCodeAt(o); )
    o++;
  i.push({ from: e.from + o, to: e.from + s.length, insert: l.slice(o) });
}), { userEvent: "delete.dedent" })), !0), Og = (n) => (n.setTabFocusMode(), !0), Tg = [
  { key: "Ctrl-b", run: ch, shift: kh, preventDefault: !0 },
  { key: "Ctrl-f", run: uh, shift: xh },
  { key: "Ctrl-p", run: gh, shift: Ch },
  { key: "Ctrl-n", run: mh, shift: Ah },
  { key: "Ctrl-a", run: Gp, shift: rg },
  { key: "Ctrl-e", run: Up, shift: og },
  { key: "Ctrl-d", run: Th },
  { key: "Ctrl-h", run: nr },
  { key: "Ctrl-k", run: ug },
  { key: "Ctrl-Alt-h", run: Ph },
  { key: "Ctrl-o", run: gg },
  { key: "Ctrl-t", run: mg },
  { key: "Ctrl-v", run: sr }
], Dg = /* @__PURE__ */ [
  { key: "ArrowLeft", run: ch, shift: kh, preventDefault: !0 },
  { key: "Mod-ArrowLeft", mac: "Alt-ArrowLeft", run: Hp, shift: Xp, preventDefault: !0 },
  { mac: "Cmd-ArrowLeft", run: qp, shift: sg, preventDefault: !0 },
  { key: "ArrowRight", run: uh, shift: xh, preventDefault: !0 },
  { key: "Mod-ArrowRight", mac: "Alt-ArrowRight", run: Fp, shift: Jp, preventDefault: !0 },
  { mac: "Cmd-ArrowRight", run: Kp, shift: ng, preventDefault: !0 },
  { key: "ArrowUp", run: gh, shift: Ch, preventDefault: !0 },
  { mac: "Cmd-ArrowUp", run: Zo, shift: el },
  { mac: "Ctrl-ArrowUp", run: Yo, shift: Xo },
  { key: "ArrowDown", run: mh, shift: Ah, preventDefault: !0 },
  { mac: "Cmd-ArrowDown", run: tl, shift: il },
  { mac: "Ctrl-ArrowDown", run: sr, shift: Jo },
  { key: "PageUp", run: Yo, shift: Xo },
  { key: "PageDown", run: sr, shift: Jo },
  { key: "Home", run: jp, shift: ig, preventDefault: !0 },
  { key: "Mod-Home", run: Zo, shift: el },
  { key: "End", run: Wp, shift: eg, preventDefault: !0 },
  { key: "Mod-End", run: tl, shift: il },
  { key: "Enter", run: sl, shift: sl },
  { key: "Mod-a", run: lg },
  { key: "Backspace", run: nr, shift: nr },
  { key: "Delete", run: Th },
  { key: "Mod-Backspace", mac: "Alt-Backspace", run: Ph },
  { key: "Mod-Delete", mac: "Alt-Delete", run: cg },
  { mac: "Mod-Backspace", run: dg },
  { mac: "Mod-Delete", run: pg }
].concat(/* @__PURE__ */ Tg.map((n) => ({ mac: n.key, run: n.run, shift: n.shift }))), Pg = /* @__PURE__ */ [
  { key: "Alt-ArrowLeft", mac: "Ctrl-ArrowLeft", run: zp, shift: Zp },
  { key: "Alt-ArrowRight", mac: "Ctrl-ArrowRight", run: _p, shift: tg },
  { key: "Alt-ArrowUp", run: wg },
  { key: "Shift-Alt-ArrowUp", run: bg },
  { key: "Alt-ArrowDown", run: yg },
  { key: "Shift-Alt-ArrowDown", run: kg },
  { key: "Escape", run: fg },
  { key: "Mod-Enter", run: Sg },
  { key: "Alt-l", mac: "Ctrl-l", run: ag },
  { key: "Mod-i", run: hg, preventDefault: !0 },
  { key: "Mod-[", run: Mg },
  { key: "Mod-]", run: Ag },
  { key: "Mod-Alt-\\", run: Cg },
  { key: "Shift-Mod-k", run: xg },
  { key: "Shift-Mod-\\", run: Yp },
  { key: "Mod-/", run: Bp },
  { key: "Alt-A", run: Ep },
...
class Is {
  ...
  */
  static start(t, e, i = 0) {
    ...
    return new Is(t, [], e, i, i, 0, [], 0, s ? new nl(s, s.start) : null, 0, null);
  }
  /**
  ...
  */
  reduce(t) {
    var e;
    let i = t >> 19, s = t & 65535, { parser: r } = this.p, o = this.reducePos < this.pos - 25;
  ...
  */
  split() {
    ...
    for (; t && s == t.bufferBase; )
      t = t.parent;
    return new Is(this.p, this.stack.slice(), this.state, this.reducePos, this.pos, this.score, i, s, this.curContext, this.lookAhead, t);
  }
  ...
  */
  ...
  updateContext(t) {
    if (t != this.curContext.context) {
      let e = new nl(this.curContext.tracker, t);
...
class Vs {
  ...
  static create(t, e = t.bufferBase + t.buffer.length) {
    return new Vs(t, e, e - t.bufferBase);
  }
  maybeNext() {
  ...
  fork() {
    return new Vs(this.stack, this.pos, this.index);
  }
}
function rs(n, t = Uint16Array) {
  if (typeof n != "string")
    return n;
  let e = null;
...
class Rg {
  ...
  */
  constructor(t, e) {
    this.input = t, this.ranges = e, this.chunk = "", this.chunkOff = 0, this.chunk2 = "", this.chunk2Pos = 0, this.next = -1, this.token = rl, this.rangeIndex = 0, this.pos = this.chunkPos = e[0].from, this.range = e[0], this.end = e[e.length - 1].to, this.readNext();
  }
  /**
  @internal
  */
  ...
  */
  reset(t, e) {
    if (e ? (this.token = e, e.start = t, e.lookAhead = t + 1, e.value = e.extended = -1) : this.token = rl, this.pos != t) {
...
Ue.prototype.contextual = Ue.prototype.fallback = Ue.prototype.extend = !1;
Ue.prototype.fallback = Ue.prototype.extend = !1;
function Eg(n, t, e, i, s, r) {
  ...
  t: for (; l & n[o]; ) {
    ...
    for (let d = o + 3; d < h; d += 2)
      if ((n[d + 1] & l) > 0) {
        let p = n[d];
        if (a.allows(p) && (t.token.value == -1 || t.token.value == p || Lg(p, t.token.value, s, r))) {
          t.acceptToken(p);
          break;
        }
      }
    ...
    for (; c < u; ) {
      let d = c + u >> 1, p = h + d + (d << 1), m = n[p], g = n[p + 1] || 65536;
      if (f < m)
        u = d;
      else if (f >= g)
        c = d + 1;
...
function Lg(n, t, e, i) {
  let s = ol(e, i, t);
  return s < 0 || ol(e, i, n) < s;
}
const xt = typeof process < "u" && process.env && /\bparse\b/.test(process.env.LOG);
let gn = null;
function ll(n, t, e) {
...
class Ng {
  ...
  nextFragment() {
    ...
    if (t) {
      for (this.safeFrom = t.openStart ? ll(t.tree, t.from + t.offset, 1) - t.offset : t.from, this.safeTo = t.openEnd ? ll(t.tree, t.to + t.offset, -1) - t.offset : t.to; this.trees.length; )
...
class Ig {
  constructor(t, e) {
    this.stream = e, this.tokens = [], this.mainToken = null, this.actions = [], this.tokens = t.tokenizers.map((i) => new ws());
  }
  getActions(t) {
    ...
    for (; this.actions.length > e; )
      this.actions.pop();
    return a && t.setLookAhead(a), !i && t.pos == this.stream.end && (i = new ws(), i.value = t.p.parser.eofTerm, i.start = i.end = t.pos, e = this.addActions(t, i.value, i.end, e)), this.mainToken = i, this.actions;
  }
  getMainToken(t) {
    if (this.mainToken)
      return this.mainToken;
    let e = new ws(), { pos: i, p: s } = t;
      ...
      for (let h = o.stateSlot(
        ...
        if (l[h] == 65535)
          if (l[h + 1] == 1)
            ...
            s == 0 && l[h + 1] == 2 && (s = this.putAction(ee(l, h + 2), e, i, s));
            break;
          }
        l[h] == e && (s = this.putAction(ee(l, h + 1), e, i, s));
      }
    return s;
  }
}
class Vg {
  constructor(t, e, i, s) {
    this.parser = t, this.input = e, this.ranges = s, this.recovering = 0, this.nextStackID = 9812, this.minStackPos = 0, this.reused = [], this.stoppedAt = null, this.lastBigReductionStart = -1, this.lastBigReductionSize = 0, this.bigReductionCount = 0, this.stream = new Rg(e, s), this.tokens = new Ig(t, this.stream), this.topTerm = t.top[1];
    let { from: r } = s[0];
    this.stacks = [Is.start(this, t.top[0], r)], this.fragments = i.length && this.stream.end - r > t.bufferLength * 4 ? new Ng(i, t.nodeSet) : null;
  }
  get parsedPos() {
  ...
  advance() {
    ...
    if (!i.length) {
      let o = s && Fg(s);
      if (o)
        return xt && console.log("Finish with " + this.stackID(o)), this.stackToTree(o);
      if (this.parser.strict)
        throw xt && s && console.log("Stuck with token " + (this.tokens.mainToken ? this.parser.getName(this.tokens.mainToken.value) : "none")), new SyntaxError("No parse at " + e);
      this.recovering || (this.recovering = 5);
    }
    if (this.recovering && s) {
      let o = this.stoppedAt != null && s[0].pos > this.stoppedAt ? s[0] : this.runRecovery(s, r, i);
      if (o)
        return xt && console.log("Force-finish " + this.stackID(o)), this.stackToTree(o.forceAll());
    }
    if (this.recovering) {
  ...
  advanceStack(t, e, i) {
    let s = t.pos, { parser: r } = this, o = xt ? this.stackID(t) + " -> " : "";
    ...
    if (this.fragments) {
      ...
      for (let c = this.fragments.nodeAt(s); c; ) {
        ...
        if (u > -1 && c.length && (!h || (c.prop(R.contextHash) || 0) == f))
          return t.useNode(c, u), xt && console.log(o + this.stackID(t) + ` (via reuse of ${r.getName(c.type.id)})`), !0;
        if (!(c instanceof tt) || c.children.length == 0 || c.positions[0] > 0)
          break;
        let d = c.children[0];
        if (d instanceof tt && c.positions[0] == 0)
          c = d;
        else
          break;
      }
    ...
    if (l > 0)
      return t.reduce(l), xt && console.log(o + this.stackID(t) + ` (via always-reduce ${r.getName(
        l & 65535
        /* Action.ValueMask */
      )})`), !0;
    ...
    for (let h = 0; h < a.length; ) {
      let f = a[h++], c = a[h++], u = a[h++], d = h == a.length || !i, p = d ? t : t.split(), m = this.tokens.mainToken;
      if (p.apply(f, c, m ? m.start : p.pos, u), xt && console.log(o + this.stackID(p) + ` (via ${f & 65536 ? `reduce of ${r.getName(
        f & 65535
        /* Action.ValueMask */
      )}` : "shift"} for ${r.getName(c)} @ ${s}${p == t ? "" : ", split"})`), d)
        return !0;
  ...
  runRecovery(t, e, i) {
    let s = null, r = !1;
    for (let o = 0; o < t.length; o++) {
      let l = t[o], a = e[o << 1], h = e[(o << 1) + 1], f = xt ? this.stackID(l) + " -> " : "";
      if (l.deadEnd && (r || (r = !0, l.restart(), xt && console.log(f + this.stackID(l) + " (restarted)"), this.advanceFully(l, i))))
        continue;
      let c = l.split(), u = f;
      for (let d = 0; c.forceReduce() && d < 10 && (xt && console.log(u + this.stackID(c) + " (via force-reduce)"), !this.advanceFully(c, i)); d++)
        xt && (u = this.stackID(c) + " -> ");
      for (let d of l.recoverByInsert(a))
        xt && console.log(f + this.stackID(d) + " (via recover-insert)"), this.advanceFully(d, i);
      this.stream.end > l.pos ? (h == l.pos && (h++, a = 0), l.recoverByDelete(a, h), xt && console.log(f + this.stackID(l) + ` (via recover-delete ${this.parser.getName(a)})`), al(l, i)) : (!s || s.score < l.score) && (s = l);
    }
    return s;
  }
  ...
  stackID(t) {
    let e = (gn || (gn = /* @__PURE__ */ new WeakMap())).get(t);
    return e || gn.set(t, e = String.fromCodePoint(this.nextStackID++)), e + t;
  }
}
function al(n, t) {
  for (let e = 0; e < t.length; e++) {
...
class Hs extends qa {
  ...
  */
  constructor(t) {
    ...
    this.nodeSet = new vr(e.map((l, a) => kt.define({
    ...
    }))), t.propSources && (this.nodeSet = this.nodeSet.extend(...t.propSources)), this.strict = !1, this.bufferLength = za;
    let o = rs(t.tokenData);
  ...
  */
  configure(t) {
    let e = Object.assign(Object.create(Hs.prototype), this);
    ...
    return t.tokenizers && (e.tokenizers = this.tokenizers.map((i) => {
      ...
      return e.specializers[s] = hl(o), o;
...
const $g = Ka({
  ...
  tokenPrec: 0
}), _g = /* @__PURE__ */ Bs.define({
  name: "json",
  parser: /* @__PURE__ */ zg.configure({
    props: [
      /* @__PURE__ */ Ya.add({
        Object: /* @__PURE__ */ jo({ except: /^\s*\}/ }),
        Array: /* @__PURE__ */ jo({ except: /^\s*\]/ })
      }),
      /* @__PURE__ */ Ja.add({
        "Object Array": tp
      })
...
function Yt() {
  ...
  for (; t < arguments.length; t++) Lh(n, arguments[t]);
  return n;
}
function Lh(n, t) {
  if (typeof t == "string")
    ...
    for (var e = 0; e < t.length; e++) Lh(n, t[e]);
  else
...
class Re {
  ...
  static init(t, e, i) {
    ...
    r && (s = r(s, i));
    let o = t.slice().sort((c, u) => c.from - u.from || c.to - u.to), l = new be(), a = [], h = 0;
    for (let c = 0; ; ) {
      let u = c == o.length ? null : o[c];
      if (!u && !a.length)
        break;
      let d, p;
      for (a.length ? (d = h, p = a.reduce((g, w) => Math.min(g, w.to), u && u.from > d ? u.from : 1e8)) : (d = u.from, p = u.to, a.push(u), c++); c < o.length; ) {
        let g = o[c];
        if (g.from == d && (g.to > g.from || g.to == d))
          a.push(g), c++, p = Math.min(g.to, p);
        else {
          p = Math.min(g.from, p);
          break;
        }
      ...
      let m = im(a);
      if (a.some((g) => g.from == g.to || g.from == g.to - 1 && i.doc.lineAt(g.from).to == g.from))
        l.add(d, d, L.widget({
          widget: new Jg(m),
          diagnostics: a.slice()
        }));
      else {
        let g = a.reduce((w, x) => x.markClass ? w + " " + x.markClass : w, "");
        l.add(d, p, L.mark({
          class: "cm-lintRange cm-lintRange-" + m + g,
          diagnostics: a.slice(),
          inclusiveEnd: a.some((w) => w.to > p)
        }));
      }
      h = p;
    ...
    let f = l.finish();
    return new Re(f, e, si(f));
  }
}
function si(n, t = null, e = 0) {
  let i = null;
  return n.between(e, 1e9, (s, r, { spec: o }) => {
    if (!(t && o.diagnostics.indexOf(t) < 0))
      if (!i)
        i = new fl(s, r, t || o.diagnostics[0]);
      else {
        if (o.diagnostics.indexOf(i.diagnostic) < 0)
          return !1;
        i = new fl(i.from, r, i.diagnostic);
      }
  }), i;
}
function jg(n, t) {
  ...
  return !!(n.effects.some((o) => o.is(Nh)) || n.changes.touchesRange(r.from, Math.max(r.to, i)));
}
function qg(n, t) {
  return n.field(St, !1) ? t : t.concat($.appendConfig.of(sm));
}
const Nh = /* @__PURE__ */ $.define(), Rr = /* @__PURE__ */ $.define(), Ih = /* @__PURE__ */ $.define(), St = /* @__PURE__ */ zt.define({
  create() {
    return new Re(L.none, null, null);
  },
  update(n, t) {
    if (t.docChanged && n.diagnostics.size) {
      ...
      if (n.selected) {
        ...
        i = si(e, n.selected.diagnostic, r) || si(e, null, r);
      }
      !e.size && s && t.state.facet(Di).autoPanel && (s = null), n = new Re(e, s, i);
    }
    for (let e of t.effects)
      if (e.is(Nh)) {
        let i = t.state.facet(Di).autoPanel ? e.value.length ? Pi.open : null : n.panel;
        n = Re.init(e.value, i, t.state);
      } else e.is(Rr) ? n = new Re(n.diagnostics, e.value ? Pi.open : null, n.selected) : e.is(Ih) && (n = new Re(n.diagnostics, n.panel, e.value));
    return n;
  },
  provide: (n) => [
    Qn.from(n, (t) => t.panel),
...
}), Kg = /* @__PURE__ */ L.mark({ class: "cm-lintRange cm-lintRange-active" });
function Gg(n, t, e) {
  let { diagnostics: i } = n.state.field(St), s, r = -1, o = -1;
...
function Ug(n, t) {
  return Yt("ul", { class: "cm-tooltip-lint" }, t.map((e) => Hh(n, e, !1)));
}
const Qg = (n) => {
  let t = n.state.field(St, !1);
  (!t || !t.panel) && n.dispatch({ effects: qg(n.state, [Rr.of(!0)]) });
  let e = ud(n, Pi.open);
  return e && e.dom.querySelector(".cm-panel-lint ul").focus(), !0;
}, cl = (n) => {
  let t = n.state.field(St, !1);
  return !t || !t.panel ? !1 : (n.dispatch({ effects: Rr.of(!1) }), !0);
}, Yg = (n) => {
  let t = n.state.field(St, !1);
  if (!t)
    return !1;
  ...
  { key: "Mod-Shift-m", run: Qg, preventDefault: !0 },
  { key: "F8", run: Yg }
], Di = /* @__PURE__ */ M.define({
  combine(n) {
    return Object.assign({ sources: n.map((t) => t.source).filter((t) => t != null) }, $s(n.map((t) => t.config), {
      delay: 750,
      markerFilter: null,
      tooltipFilter: null,
      needsRefresh: null,
...
function Hh(n, t, e) {
  var i;
  let s = e ? Vh(t.actions) : [];
  return Yt("li", { class: "cm-diagnostic cm-diagnostic-" + t.severity }, Yt("span", { class: "cm-diagnosticText" }, t.renderMessage ? t.renderMessage(n) : t.message), (i = t.actions) === null || i === void 0 ? void 0 : i.map((r, o) => {
    let l = !1, a = (u) => {
      if (u.preventDefault(), l)
        return;
      l = !0;
      let d = si(n.state.field(St).diagnostics, t);
  ...
  }), t.source && Yt("div", { class: "cm-diagnosticSource" }, t.source));
}
class Jg extends Me {
  constructor(t) {
    super(), this.sev = t;
  ...
  toDOM() {
    return Yt("span", { class: "cm-lintPoint cm-lintPoint-" + this.sev });
  }
}
class ul {
  constructor(t, e) {
    this.diagnostic = e, this.id = "item_" + Math.floor(Math.random() * 4294967295).toString(16), this.dom = Hh(t, e, !0), this.dom.id = this.id, this.dom.setAttribute("role", "option");
  }
}
class Pi {
  constructor(t) {
    ...
    let e = (s) => {
      if (s.keyCode == 27)
        ...
        let { diagnostic: r } = this.items[this.selectedIndex], o = Vh(r.actions);
        for (let l = 0; l < o.length; l++)
          if (o[l].toUpperCase().charCodeAt(0) == s.keyCode) {
            let a = si(this.view.state.field(St).diagnostics, r);
    ...
    this.list = Yt("ul", {
      ...
      onkeydown: e,
      onclick: i
    }), this.dom = Yt("div", { class: "cm-panel-lint" }, this.list, Yt("button", {
      type: "button",
      name: "close",
      "aria-label": this.view.state.phrase("close"),
      onclick: () => cl(this.view)
    }, "×")), this.update();
  }
  get selectedIndex() {
  ...
  update() {
    let { diagnostics: t, selected: e } = this.view.state.field(St), i = 0, s = !1, r = null, o = /* @__PURE__ */ new Set();
    for (t.between(0, this.view.state.doc.length, (l, a, { spec: h }) => {
      for (let f of h.diagnostics) {
        ...
        c < 0 ? (u = new ul(this.view, f), this.items.splice(i, 0, u), s = !0) : (u = this.items[c], c > i && (this.items.splice(i, c - i), s = !0)), e && u.diagnostic == e.diagnostic ? u.dom.hasAttribute("aria-selected") || (u.dom.setAttribute("aria-selected", "true"), r = u) : u.dom.hasAttribute("aria-selected") && u.dom.removeAttribute("aria-selected"), i++;
      }
    }); i < this.items.length && !(this.items.length == 1 && this.items[0].diagnostic.from < 0); )
      s = !0, this.items.pop();
    this.items.length == 0 && (this.items.push(new ul(this.view, {
      from: -1,
      to: -1,
      severity: "info",
  ...
  moveSelection(t) {
    if (this.selectedIndex < 0)
      return;
    let e = this.view.state.field(St), i = si(e.diagnostics, this.items[t].diagnostic);
...
function Zg(n, t = 'viewBox="0 0 40 40"') {
  return `url('data:image/svg+xml,<svg xmlns="http://www.w3.org/2000/svg" ${t}>${encodeURIComponent(n)}</svg>')`;
}
function os(n) {
  return Zg(`<path d="m0 2.5 l2 -1.5 l1 0 l2 1.5 l1 0" stroke="${n}" fill="none" stroke-width=".7"/>`, 'width="6" height="3"');
}
const tm = /* @__PURE__ */ D.baseTheme({
  ".cm-diagnostic": {
  ...
  ".cm-lintRange-error": { backgroundImage: /* @__PURE__ */ os("#d11") },
...
const sm = [
  St,
  /* @__PURE__ */ D.decorations.compute([St], (n) => {
    let { selected: t, panel: e } = n.field(St);
    return !t || !e || t.from == t.to ? L.none : L.set([
      Kg.range(t.from, t.to)
    ]);
  }),
  /* @__PURE__ */ fd(Gg, { hideOn: jg }),
  tm
], nm = "#e5c07b", dl = "#e06c75", rm = "#56b6c2", om = "#ffffff", ys = "#abb2bf", rr = "#7d8799", lm = "#61afef", am = "#98c379", pl = "#d19a66", hm = "#c678dd", fm = "#21252b", gl = "#2c313a", ml = "#282c34", mn = "#353a42", cm = "#3E4451", wl = "#528bff", um = /* @__PURE__ */ D.theme({
  "&": {
    color: ys,
    backgroundColor: ml
  },
  ...
  "&.cm-focused > .cm-scroller > .cm-selectionLayer .cm-selectionBackground, .cm-selectionBackground, .cm-content ::selection": { backgroundColor: cm },
  ".cm-panels": { backgroundColor: fm, color: ys },
...
window.__hst_controls_dark.push(Fh);
var yl;
(yl = window.__hst_controls_dark_ready) == null || yl.call(window);
const pm = {
  name: "HstJson",
  inheritAttrs: !1
}, gm = /* @__PURE__ */ et({
  ...
  setup(n, { emit: t }) {
    const e = n, i = t;
    let s;
    const r = at(""), o = at(!1), l = at(), a = {
      light: [D.baseTheme({}), Ko(wp)],
      dark: [um, Ko(dm)]
    }, h = new Bi(), f = [
      vd(),
      td(),
      ...
      D.updateListener.of((c) => {
        r.value = c.view.state.doc.toString();
      }),
      h.of(a.light)
    ];
    return zh(() => {
      s = new D({
        ...
        s.dispatch({
          effects: [
            h.reconfigure(a[Fh.value ? "dark" : "light"])
          ]
        });
      });
    }), bs(() => e.modelValue, () => {
      let c;
      try {
        c = JSON.stringify(JSON.parse(r.value)) === JSON.stringify(e.modelValue);
      } catch {
        c = !1;
      }
      c || s.dispatch({ changes: [{ from: 0, to: s.state.doc.length, insert: JSON.stringify(e.modelValue, null, 2) }] });
    }, { deep: !0 }), bs(() => r.value, () => {
      o.value = !1;
      try {
      ...
      style: Rt(c.$attrs.style)
    }, {
      actions: K(() => [
        o.value ? Vt((P(), Y(Ct(lr), {
          key: 0,
  ...
  for (const [i, s] of t)
    e[i] = s;
  return e;
}, wm = /* @__PURE__ */ mm(gm, [["__scopeId", "data-v-d4369e5a"]]), ym = {
  name: "HstNumber",
  inheritAttrs: !1
}, bm = /* @__PURE__ */ et({
  ...ym,
  ...
  setup(n, { emit: t }) {
    ...
    let a, h;
    function f(d) {
      l.value = !0, a = d.clientX, h = s.value, window.addEventListener("mousemove", c), window.addEventListener("mouseup", u);
    }
    function c(d) {
      let p = Number.parseFloat(r.value.step);
      Number.isNaN(p) && (p = 1), s.value = h + Math.round((d.clientX - a) / 10 / p) * p;
    }
    function u() {
      l.value = !1, window.removeEventListener("mousemove", c), window.removeEventListener("mouseup", u);
    }
    return Wh(() => {
      u();
    }), (d, p) => (P(), Y($t, {
...
}), km = { class: "-htw-my-1" }, xm = ["id", "name", "value", "checked", "onChange"], vm = ["for", "onKeydown"], Sm = {
  name: "HstRadio"
}, Cm = /* @__PURE__ */ et({
  ...Sm,
  props: {
  ...
  setup(n, { emit: t }) {
    ...
    return (l, a) => (P(), Y($t, {
      role: "group",
      title: l.title,
      class: gt(["histoire-radio htw-cursor-text", l.$attrs.class]),
      style: Rt(l.$attrs.style)
    }, {
      actions: K(() => [
        ht(l.$slots, "actions")
      ]),
      default: K(() => [
        E("div", km, [
          (P(!0), q(we, null, $e(i.value, (h, f) => (P(), q(we, { key: f }, [
            E("input", {
              id: `${f}-radio_${l.title}`,
              type: "radio",
              name: `${f}-radio_${l.title}`,
              value: f,
              checked: f === l.modelValue,
              class: "!htw-hidden",
              onChange: (c) => r(f)
            }, null, 40, xm),
            E("label", {
              tabindex: "0",
              for: `${f}-radio_${l.title}`,
              class: "htw-cursor-pointer htw-flex htw-items-center htw-relative htw-py-1 htw-group",
              onKeydown: [
                Qe(Ye((c) => r(f), ["prevent"]), ["enter"]),
                Qe(Ye((c) => r(f), ["prevent"]), ["space"])
              ]
            }, [
              (P(), q("svg", {
                width: "16",
                ...
                class: gt(["htw-relative htw-z-10 htw-border htw-border-solid htw-text-inherit htw-rounded-full htw-box-border htw-inset-0 htw-transition-border htw-duration-150 htw-ease-out htw-mr-2 group-hover:htw-border-primary-500", [
                  l.modelValue === f ? "htw-border-primary-500" : "htw-border-black/25 dark:htw-border-white/25"
                ]])
              }, [
                E("circle", {
                  r: "7",
                  class: gt(["htw-will-change-transform", [
                    ...
                    {
                      "htw-delay-150": l.modelValue === f
                    },
                    l.modelValue === f ? "htw-fill-primary-500" : "htw-fill-transparent htw-scale-0"
                  ]])
                }, null, 2)
              ], 2)),
              le(" " + Bt(h), 1)
...
}), Am = { class: "htw-cursor-pointer htw-w-full htw-outline-none htw-px-2 htw-h-[27px] -htw-my-1 htw-border htw-border-solid htw-border-black/25 dark:htw-border-white/25 hover:htw-border-primary-500 dark:hover:htw-border-primary-500 htw-rounded-sm htw-flex htw-gap-2 htw-items-center htw-leading-normal" }, Mm = { class: "htw-flex-1 htw-truncate" }, Om = { class: "htw-flex htw-flex-col htw-bg-gray-50 dark:htw-bg-gray-700" }, Tm = ["onClick"], Dm = {
  name: "CustomSelect"
}, Pm = /* @__PURE__ */ et({
  ...Dm,
  props: {
  ...
  setup(n, { emit: t }) {
    const e = n, i = t, s = nt(() => Array.isArray(e.options) ? e.options.map((l) => typeof l == "string" || typeof l == "number" ? [l, String(l)] : [l.value, l.label]) : Object.entries(e.options)), r = nt(() => {
      var l;
      return (l = s.value.find(([a]) => a === e.modelValue)) == null ? void 0 : l[1];
    });
    function o(l, a) {
      i("update:modelValue", l), a();
    }
    return (l, a) => (P(), Y(Ct(jh), {
      "auto-size": "",
      "auto-boundary-max-size": ""
    }, {
      popper: K(({ hide: h }) => [
        E("div", Om, [
          (P(!0), q(we, null, $e(s.value, ([f, c]) => (P(), q("div", ze({ ref_for: !0 }, { ...l.$attrs, class: null, style: null }, {
            key: c,
            class: ["htw-px-2 htw-py-1 htw-cursor-pointer hover:htw-bg-primary-100 dark:hover:htw-bg-primary-700", {
              "htw-bg-primary-200 dark:htw-bg-primary-800": e.modelValue === f
            }],
            onClick: (u) => o(f, h)
          }), Bt(c), 17, Tm))), 128))
        ])
  ...
  setup(n, { emit: t }) {
    ...
    return (i, s) => (P(), Y($t, {
      title: i.title,
      class: gt(["histoire-select htw-cursor-text htw-items-center", i.$attrs.class]),
      style: Rt(i.$attrs.style)
    }, {
      actions: K(() => [
        ht(i.$slots, "actions")
      ]),
...
}), Em = { class: "htw-relative htw-w-full htw-flex htw-items-center" }, Lm = {
  name: "HstSlider",
  inheritAttrs: !1
}, Nm = /* @__PURE__ */ et({
  ...Lm,
  ...
  setup(n, { emit: t }) {
    const e = n, i = t, s = at(!1), r = at(null), o = nt({
      get: () => e.modelValue,
      set: (h) => {
        i("update:modelValue", h);
      }
    }), l = nt(() => (e.modelValue - e.min) / (e.max - e.min)), a = nt(() => r.value ? {
      left: `${8 + (r.value.clientWidth - 16) * l.value}px`
    } : {});
    return (h, f) => (P(), Y($t, {
      class: gt(["histoire-slider htw-items-center", h.$attrs.class]),
      title: h.title,
      style: Rt(h.$attrs.style)
    }, {
      default: K(() => [
        E("div", Em, [
          f[3] || (f[3] = E("div", { class: "htw-absolute htw-inset-0 htw-flex htw-items-center" }, [
            E("div", { class: "htw-border htw-border-black/25 dark:htw-border-white/25 htw-h-1 htw-w-full htw-rounded-full" })
          ], -1)),
          Vt(E("input", ze({
            ref_key: "input",
            ref: r,
            ...
            type: "range"
          }, { ...h.$attrs, class: null, style: null, min: h.min, max: h.max }, {
            onMouseover: f[1] || (f[1] = (c) => s.value = !0),
            onMouseleave: f[2] || (f[2] = (c) => s.value = !1)
          }), null, 16), [
            [
              or,
              o.value,
          ...
          s.value ? Vt((P(), q("div", {
            ...
            [Ct(ye), { content: h.modelValue.toString(), shown: !0, distance: 16, delay: 0 }]
          ]) : ne("", !0)
        ])
      ]),
      _: 1
  ...
  setup(n, { emit: t }) {
    ...
    return (s, r) => (P(), Y($t, {
      title: s.title,
      class: gt(["histoire-text htw-cursor-text htw-items-center", s.$attrs.class]),
      style: Rt(s.$attrs.style),
  ...
  setup(n, { emit: t }) {
    ...
    return (s, r) => (P(), Y($t, {
      title: s.title,
      class: gt(["histoire-textarea htw-cursor-text", s.$attrs.class]),
      style: Rt(s.$attrs.style),
      onClick: r[1] || (r[1] = (o) => i.value.focus())
    }, {
      actions: K(() => [
...
}), _m = bl, Wm = Zh, jm = rf, qm = hf, Km = Hm, Gm = bm, Um = Nm, Qm = zm, Ym = Rm, Xm = vf, Jm = Vf, Zm = Df, t0 = Ne, e0 = Cm, i0 = wm, s0 = df, f0 = {
  HstButton: _m,
  HstButtonGroup: Wm,
  HstCheckbox: jm,
  HstCheckboxList: qm,
...
export {
  _m as HstButton,
  Wm as HstButtonGroup,
  jm as HstCheckbox,
  qm as HstCheckboxList,
  s0 as HstColorSelect,
  Xm as HstColorShades,
  t0 as HstCopyIcon,
  i0 as HstJson,
  Gm as HstNumber,
  e0 as HstRadio,
